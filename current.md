...
* [Note sulla versione della raccolta dei dati in Experience Platform](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=it) (già Experience Platform Launch) - Aggiornato il **22 aprile 2021**
...
| Aggiornamenti per l’area geografica ISO 2021 | 13 maggio 2021 | Adobe eseguirà gli aggiornamenti dell’area ISO 2021 il 21 maggio 2021. Ci si aspetta di vedere aggiornamenti minori dopo questa versione. |
...
| Maggio 2021 | [Modulo adattivo con Adobe Sign](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-and-sign/create-adaptive-form.html?lang=it) | Video | Scopri come creare un modulo adattivo per utilizzare la configurazione cloud di Adobe Sign. |
| Maggio 2021 | [Configurazione di un modulo adattivo per lo scenario di compilazione e firma](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-and-sign/configure-form-fill-and-sign.html?lang=it) | Video | Scopri come configurare il modulo in cui la stessa persona compila e firma. |
| Maggio 2021 | [Creazione di un’applicazione API Adobe Sign](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-and-sign/create-sign-api-application.html?lang=it#forms) | Video | Scopri come creare un’applicazione API nel tuo Adobe Sign da integrare con la tua piattaforma Adobe Sign. |
...
Consulta le [!DNL Marketo Engage] [note sulla versione](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/documentautomation.html#integrations) per informazioni aggiornate sulla pianificazione.
