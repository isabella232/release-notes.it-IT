...
|----|----|----|
| [Predictive Audiences](https://docs.adobe.com/content/help/it-IT/audience-manager/user-guide/features/algorithmic-models/predictive-audiences/predictive-audiences.html) | 21 ottobre 2020 | <ul><li>**Clonazione del modello delle audience predittive**: ora puoi clonare modelli esistenti e modificarne la configurazione in base alle tue esigenze. Leggi [Clonazione e modifica dei modelli delle audience predittive](https://docs.adobe.com/content/help/it-IT/audience-manager/user-guide/features/algorithmic-models/predictive-audiences/predictive-audiences-start.html#clone-predictive-audiences) per ulteriori informazioni.</li><li>**Classificazione in batch delle audience predittive**: oltre a classificare i visitatori in persone distinte in tempo reale, le audience predittive ora supportano la classificazione in batch, che consente di classificare gli utenti integrati e ad attivarli in destinazioni in batch.</li></ul> |
...
| 10 ottobre 2020 | [Audience predittive](https://docs.adobe.com/content/help/it-IT/audience-manager-learn/tutorials/build-and-manage-audiences/algorithmic-models/understanding-predictive-audiences.html) | Video | Questo video illustra cosa sono le audience predittive di Audience Manager, presenta i dettagli sul loro funzionamento e illustra casi d’uso. |
