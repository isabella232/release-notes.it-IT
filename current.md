...
* [!DNL Analytics](#analytics) (**aggiornato il 26 novembre 2019**)
...
Cerchi la pagina iniziale della guida? Vai a [Formazione e supporto Experience Cloud](https://helpx.adobe.com/it/support/experience-cloud.html).
...
* [Avvisi importanti per gli amministratori di Analytics](#aa-notices) (**aggiornato il 26 novembre 2019**)
* [AppMeasurement](#appm)
...
| -----------| ---------- | ---------- |
| Aggiornamento delle etichette delle dimensioni “Mese” e “Trimestre” | 26 novembre 2019 | Il 16 gennaio 2020, le etichette delle dimensioni Mese e Trimestre saranno aggiornate in modo da riflettere l'anno solare standard. Le impostazioni di calendario personalizzate (definite in **[!UICONTROL Admin &gt; Suite di reportistica &gt; Modifica impostazioni &gt; Generale)** continueranno a determinare quali mesi vengono restituiti in un report.<br>Ad esempio, se il calendario personalizzato per il 2020 è definito come ottobre 2019-settembre 2020, mesi e trimestri saranno visualizzati come segue nei rapporti:<ul><li>Trimestri: ott 2019-dic 2019, gen 2020-mar 2020, Apr 2020-giu 2020, lug 2020-set 2020</li><li>Mesi: ott 2019, nov 2019, dic 2019, gen 2020, feb 2020, ecc.</li><li>Precedentemente, tutti gli elementi di cui sopra avrebbero riportato l'anno 2019, che ha causato confusione per gli utenti finali.</li></ul>Se hai filtri o segmenti di report che cercano questi valori, non è necessario intervenire. Vengono aggiornati per riflettere la nuova convenzione di denominazione. |
| Fine del ciclo di vita dell’opzione **[!UICONTROL Enforce IP Login Restrictions]** | 21 novembre 2019 | Annuncio della data di fine del ciclo di vita, a *ottobre 2020*, per la funzionalità di whitelisting degli accessi IP (**[!UICONTROL Enforce IP Login Restrictions]**), nel menu **[!UICONTROL Amministrazione &gt; Impostazioni società &gt; Sicurezza]**. (Originariamente previsto per gennaio 2020.) |
...
* **Guida alle best practice per i progetti AEM Screens**
   ...
   Consulta la [Guida alle best practice per i progetti AEM Screens](https://docs.adobe.com/content/help/it-IT/experience-manager-screens/using/about-guide.html).
