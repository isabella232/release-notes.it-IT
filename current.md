...
Utilizzando l&#39;Adobe ID, potete iscrivervi alle notifiche relative agli eventi di stato, in base ai prodotti, all&#39;area geografica e alle preferenze dell&#39;evento.

| Funzione | Descrizione |
| -----------| ---------- |
| Iscriviti alle notifiche e-mail in tempo reale | <ul><li>Supporto per Experience Cloud, Creative Cloud, Document Cloud, AEP e Adobe Services</li><li>Supporto delle preferenze per l&#39;area e il tipo di evento</li><li>Supporto UX per le superfici Web, mobili e tablet</li></ul> |
| Gestione delle preferenze delle notifiche | <ul><li>Modifica e salva le preferenze di notifica in qualsiasi momento</li><li>Annullamento dell&#39;iscrizione alle notifiche in qualsiasi momento</li><li>Elemento</li></ul> |
| Distribuzione e-mail personalizzata e più veloce | <ul><li>Le notifiche degli eventi vengono inviate non appena gli oggetti con più stati e i contenuti CMR vengono aperti, aggiornati o chiusi</li><li>Ricevere solo le notifiche relative all’evento corrispondenti alle preferenze configurate</li><li>Ricevute notifiche localizzate in base alla lingua configurata nelle preferenze dell&#39;account</li></ul> |
| Notifiche interne al prodotto personalizzate | Gli eventi che corrispondono alle preferenze di notifica e alle adesioni dei prodotti vengono visualizzati nel pannello Annuncio. |
...
| -----------| ---------- | ---------- |
| Nuovo dominio Adobe Analytics | 18 dicembre 2019 | Il 16 gennaio 2020, Adobe Analytics passerà al nuovo dominio: https://experience.adobe.com/analytics. Questa modifica può causare problemi di cookie durante il caricamento di Analytics in Safari. Se l&#39;opzione &quot;Impedisci il tracciamento intersito&quot; nelle preferenze sulla privacy di Safari, i cookie verranno abilitati per tutti i domini (e tutte le esperienze intersito) e Analytics potrà funzionare su questo nuovo dominio Adobe Experience Cloud. Gli utenti possono utilizzare altri browser senza problemi, poiché questo interessa solo gli utenti di Safari. |
