...
Consulta [AppMeasurement per le note sulla versione di JavaScript](https://docs.adobe.com/content/help/it-IT/analytics/implementation/appmeasurement-updates.html). La versione 2.19.0 è stata rilasciata il 21 febbraio 2020.
...
| [DIL 9.4](https://docs.adobe.com/content/help/it-IT/audience-manager/user-guide/dil-api/dil-release-notes.html) | Abbiamo aggiornato [!DNL Data Integration Library] ([!DNL DIL]) alla versione 9.4. Questo aggiornamento favorisce la compatibilità con i cookie [!DNL Google Chrome] [!DNL SameSite]. |
...
Fai riferimento alle [note sulla versione Adobe Campaign Classic](https://docs.adobe.com/content/help/it-IT/campaign-classic/using/release-notes/latest-release.html) per correzioni e miglioramenti.
