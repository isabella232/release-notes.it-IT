...
| ----------- | ---------- | ------- |
| Aggiornamenti API Data Repair | 25 marzo 2021 | L&#39;API Data Repair ora supporta le variabili standard tra cui [!UICONTROL Pagina] e [!UICONTROL Indirizzo IP], le variabili mobile e video, nonché le variabili personalizzate [!UICONTROL props] e [!UICONTROL eVars].  È possibile eliminare i valori all’interno delle variabili oppure impostare nuovi valori. L’API ora offre anche la possibilità di filtrare URL, stringhe di query, segni “chiocciola” e altro ancora. |
