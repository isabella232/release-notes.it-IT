...
Le note sulla versione per le edizioni Open Source e Commerce sono disponibili nella pagina [Informazioni sulla versione](https://devdocs.magento.com/guides/v2.3/release-notes/bk-release-notes.html).
