...
* [[!DNL Adobe Experience Manager]](#aem) (aggiornato) **13 ottobre 2021**)
* [[!DNL Adobe Campaign]](#ac)
* [[!DNL Adobe Advertising Cloud]](#adcloud) (aggiornato) **7 ottobre 2021**)
...
| -----------| ---------- | ---------- | ---------- |---------- |
| 4 ottobre 2021 | Su richiesta | [Adobe Developers Live](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/2021/oct2021/overview.html?lang=en) | Video | I team di prodotti di Adobe di Adobe Experience Cloud, Document Cloud e Creative Cloud hanno presentato i più recenti progressi tecnologici e gli strumenti per sviluppatori che supportano la progettazione, i flussi di lavoro per la creazione di contenuti, i servizi di documentazione e la gestione dell’esperienza dei clienti nei diversi settori. Visualizza l’indirizzo della nota chiave, scopri le API di Analytics, il livello dati client, i progetti open source di Adobe I/O e molto altro. |
| 21 ottobre 2021 | 12 (EST) | [Chi l&#39;ha cliccato? Rapporti avanzati sui clic sui collegamenti con Adobe Analytics](https://www.youtube.com/channel/UCN-7ZEctit8Qu01BWeHQ0Fw) | Evento video live | Il reporting sull’interazione dell’utente con la proprietà web o mobile rappresenta un elemento fondamentale per comprendere il percorso del cliente. Con Adobe Analytics puoi capire chi, cosa, perché e dove di ogni clic nell’applicazione. Gli esperti di Adobe Analytics possono imparare a utilizzare le classificazioni Activity Map e l’attribuzione personalizzata per comprendere meglio il coinvolgimento degli utenti. |
...
| Experience Cloud [!UICONTROL Triggers] navigazione | [Trigger di Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/services/activation/triggers.html?lang=en) è disponibile per la navigazione diretta dallo switcher dell&#39;applicazione nell&#39;intestazione per gli utenti con provisioning. |
| **Avviso:** Aggiornamento pianificato per la navigazione nell’interfaccia | Nel novembre 2021, la _[!UICONTROL Vai a Launch / Raccolta dati]_ la funzione di navigazione verrà rimossa da <https://experience.adobe.com/implement>. |
...
* Sono stati risolti i problemi con [!UICONTROL Componenti di ricerca] in [!UICONTROL Area di lavoro] non risultando in corrispondenze esatte. (AN-253937; AN-271707)
...
Ultimi corsi, esercitazioni e articoli in [!DNL Analytics] e [!UICONTROL Customer Journey Analytics].
...
Include informazioni sull’aggiornamento della versione e la nuova documentazione per Experience Platform e [!UICONTROL SDK per dispositivi mobili].

**29 settembre 2021**

| Funzione | Descrizione |
| ------- | ------- |
| [[!UICONTROL Zona di destinazione dei dati]](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/cloud-storage/data-landing-zone.html) | [!UICONTROL Zona di destinazione dei dati] è un [!DNL Platform]con provisioning [!UICONTROL Archivio BLOB di Azure] che consente un unico storage sicuro e temporaneo per sandbox per portare i file in Experience Platform. |
| Supporto delle sorgenti in streaming per [preparazione dei dati](https://www.adobe.com/go/monitor-streaming-dataflows-en) | Le origini di streaming ora supportano la preparazione dei dati, che consente di fornire uno schema di origine JSON per mappare dati di origine non compatibili con XDM su uno schema XDM di destinazione. |
| [Credenziali non in scadenza](https://experienceleague.adobe.com/docs/experience-platform/query/ui/credentials.html) | Credenziali non in scadenza per [!UICONTROL Servizio query] gli utenti consentono connessioni più permanenti ai client esterni invece di rinnovare le credenziali ogni 24 ore. |
| [[!UICONTROL SDK per la destinazione]](https://www.adobe.com/go/destination-sdk-overview-en) | Utilizzo [!UICONTROL SDK per la destinazione] per integrare con [!DNL Platform] e contribuire al catalogo delle destinazioni in continua crescita. L’accesso a questa funzione è disponibile solo per i clienti di Experience Platform Activation . |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Ottobre 2021 | [Configurare e gestire i dati in [!DNL Journey Optimizer] per data engineer](https://experienceleague.adobe.com/?recommended=JourneyOptimizer-U-1-2021.2) | Corso | Scopri come configurare e gestire i dati necessari per la gestione dei percorsi in Journey Optimizer. |
| Ottobre 2021 | [Introduzione a [!DNL Journey Optimizer] per amministratori di Percorso e manager](https://experienceleague.adobe.com/?recommended=JourneyOptimizer-U-1-2021.1) | Corso | Scopri tutto quello che devi sapere per creare il tuo primo percorso. |
| Ottobre 2021 | [Configura [!DNL Journey Optimizer] per amministratori di Percorso](https://experienceleague.adobe.com/?recommended=JourneyOptimizer-A-1-2021.1) | Corso | Comprendere il [!DNL Journey Optimizer] architettura e punti di integrazione. Scopri come configurare [!DNL Journey Optimizer]. |

{style=&quot;table-layout:auto&quot;}

### Altre risorse [!DNL Journey Optimizer]
...
### Più recente [!DNL Journey Orchestration] rilasci di prodotti
...
#### Altre risorse [!DNL Journey Orchestration]
...
Ulteriori informazioni sulle funzionalità, i miglioramenti e le correzioni più recenti nel [Note sulla versione di Offer Decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html).
...
| Ottobre 2021 | [Gestione dei flussi di lavoro creativi tramite [!DNL Workfront] e Assets Essentials](https://experienceleague.adobe.com/?recommended=ExperienceManager-U-1-2021.2.assets.essentials) | Corso | Adobe [!DNL Workfront] e Experience Manager. |
...
| Ottobre 2021 | [Onboarding in AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/onboarding.html?lang=en) | Video | Scopri l’onboarding per AEM as a Cloud Service a partire dalla fase del contratto fino alla configurazione degli ambienti tramite [!UICONTROL Cloud Manager]. |
...
| Ottobre 2021 | [[!UICONTROL Strumenti di modernizzazione AEM]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/aem-modernization-tools.html?lang=en) | Video | Scopri come AEM [!UICONTROL Strumenti di modernizzazione] vengono utilizzati per aggiornare un progetto AEM esistente e il contenuto per renderlo AEM compatibile con gli as a Cloud Service. |
...
| Ottobre 2021 | [Manutenzione della cronologia delle versioni](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/versions.html) | Video | Scopri come Adobe Workfront e Experience Manager [!UICONTROL Assets Essentials] consente di mantenere le versioni di [!DNL Workfront] documenti e risorse Assets Essentials. |
...
| Ottobre 2021 | [Segment Builder in Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-builder-overview.html?lang=en#) | Video | Vai a fondo nei tuoi dati con la segmentazione in Adobe Analytics. Questo video illustra la procedura [!UICONTROL Generatore di segmenti] e offre una panoramica di base. |
...
| Ottobre 2021 | [Firma con [!DNL Digidentity]](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/digidentity/digidentity-sign.html) | Video | Scopri come utilizzare il tuo [!DNL Digidentity] ID digitale per autenticare la propria identità e autorizzare una firma digitale remota (firma cloud) su un documento. |
| Ottobre 2021 | [Ottieni un ID digitale da [!DNL Digidentity]](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/digidentity/digidentity-reg.html) | Video | Scopri come ottenere un certificato di firma digitale da [!DNL Digidentity]. Una volta registrato e verificato l&#39;identità, [!DNL Digidentity] causa problemi con un ID digitale utilizzato per applicare una firma cloud Adobe Sign. |
...
Vedi [Tutorial su Creative Cloud for enterprise](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/overview.html?lang=it) per le esercitazioni più recenti.
