...
* [Roadmap dei rilasci di AEM](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html): elenca i prossimi rilasci di AEM as a Cloud Service e delle versioni supportate di AEM On-Premise e Managed Services.
* [Aggiornamenti sui rilasci di AEM](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/aem-releases-updates.html): elenca le versioni più recenti di AEM as a Cloud Service e delle versioni supportate di AEM On-Premise e Managed Services e rimanda alla documentazione di tali versioni.
* [Rilasci di AEM Forms](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html): elenca i collegamenti del pacchetto Distribuzione di software di tutti i pacchetti aggiuntivi di Forms rilasciati.

Inoltre, l&#39;archivio include altri articoli importanti, come [Definizioni del veicolo della versione aggiornata di AEM](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/update-release-vehicle-definitions.html) e [Aggiornamenti recenti della documentazione AEM](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/doc-updates/documentation-updates.html).
...
| 8 ottobre 2020 | [Personalizzazione mediante Visual Experience Composer](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/integrations/target/personalization-using-vec.html) | Video | Scopri come creare un’attività di test A/B di Target utilizzando Visual Experience Composer (VEC). |
...
| 8 ottobre 2020 | [Esportare i frammenti di esperienza in Adobe Target](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/integrations/target/export-experience-fragment-target.html) | Video | Scopri come esportare un frammento di esperienza di AEM come offerte di Adobe Target. |
...
| 28 settembre 2020 | [Autenticazione a due fattori con SMS](https://docs.adobe.com/content/help/en/experience-manager-learn/forms/some-useful-integrations/two-factor-authentication.html) | Articolo | Effettuare la verifica OTP mediante SMS nei moduli adattivi. |
...
| 7 ottobre 2020 | [Estensibilità di Asset Compute](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/asset-compute/overview.html) | Articolo | Tutorial che illustra come creare un processo di lavoro per microservizio per personalizzare le risorse in AEM as a Cloud Service. |
...
| 21 ottobre 2020 | [Strumenti per il Dispatcher locale](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/local-development-environment-set-up/dispatcher-tools.html) | Articolo | Il Dispatcher di AEM è un modulo server web Apache HTTP che fornisce protezione e prestazioni tra il livello di CDN e AEM Publish. Scopri come configurare il Dispatcher come parte di un ambiente di sviluppo locale. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| 29 settembre 2020 | [Presentazione rapida di Adobe Sign](https://docs.adobe.com/content/help/en/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html) | Video | In questo video verrà illustrato brevemente Adobe Sign a partire dalla schermata iniziale. |
