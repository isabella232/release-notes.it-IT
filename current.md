...
* Aggiornato luglio 2021 - [Note sulla versione del Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)

### Nuovi corsi ed esercitazioni per Journey Orchestration {#tutorials-ajo}

Nuovi video, esercitazioni o corsi pubblicati per Adobe Campaign.

| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Agosto 2021 | [Introduzione alla costruzione di un percorso](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/introduction-to-building-a-journey.html) | Video | Comprendere le basi della costruzione di un percorso nell&#39;area di lavoro del percorso. |
| Agosto 2021 | [Configurare i dati: panoramica](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/get-started/data-configuration/set-up-data-overview.html) | Video | Scopri i dati del profilo cliente in tempo reale e quali passaggi sono necessari per impostare i dati del profilo cliente per Journey Optimizer. |
| Agosto 2021 | [Mappa le identità](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/get-started/data-configuration/map-identities.html) | Video | Scopri come e quando etichettare un campo di schema come identità, come creare uno spazio dei nomi, quando rendere principale un’identità e come acquisire e verificare i dati di identità. |
...
* **Versione di giugno 2021:** la classificazione AI ti consente di creare diverse strategie di classificazione (in base ai tuoi obiettivi aziendali). Queste strategie possono essere utilizzate da un sistema di modelli addestrati per classificare le offerte idonee da visualizzare per un determinato profilo.
...
* **Experience Manager as a Cloud Service**
   ...
   Per un riepilogo delle funzioni aggiunte, riproduci il video [Panoramica sulla versione di luglio 2021](https://video.tv.adobe.com/v/335580) .

   * **[!UICONTROL Cloud Acceleration Manager]**

      * [!UICONTROL Cloud Acceleration ] Manager è un’applicazione basata su cloud progettata per guidare i team IT durante l’intero percorso di transizione, dalla pianificazione al Cloud Service live. Imposta i team per una migrazione di successo con best practice, suggerimenti, documentazione e strumenti consigliati da Adobe per aiutarti in ogni fase del percorso ad Experience Manager come Cloud Service. Consulta [Guida introduttiva a Cloud Acceleration Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html?lang=en).
      Riproduci il video demo [Cloud Acceleration Manager](https://video.tv.adobe.com/v/335547) .
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Gli utenti possono cercare e filtrare le cartelle in base ai predicati delle proprietà.
      ...
      Nuove funzioni disponibili nel canale pre-rilascio delle risorse
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **[!UICONTROL Esternalizzatore dati variabile]** : è possibile salvare i dati delle variabili del flusso di lavoro di Experience Manager su un sistema di storage esterno gestito dalla tua organizzazione.
      * **[!UICONTROL Documento di record basato su Acroform]**  - È inoltre possibile  [utilizzare Adobe Acrobat Form PDF (Acroform PDF)](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=en) come modello per Document of Record oltre a modello di modulo basato su XFA.
...
* Adobe Campaign Classic v8 versione 8.1.14: consulta le [note sulla versione di Campaign Classic v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/start/release-notes.html?lang=en)
...
| ------- | ----------- |
| [!UICONTROL Visualizzazione ] pre-offerta per posizionamenti | [!UICONTROL I filtri di ] visualizzazione preofferta da Oracle Advertising (Moat) sono ora disponibili per i posizionamenti. |

{style=&quot;table-layout:auto&quot;}

### Nuove funzioni in [!DNL Advertising Cloud Search] {#adcloud-search}

Ultimo aggiornamento: **12 agosto 2021 per la versione del 21 agosto**
