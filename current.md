...
**[!UICONTROL Launch Server Side]:** invia dati a livello di evento ad AEP Edge Network, quindi utilizza Launch Server Side per trasformare, arricchire e inviare tali dati a un endpoint non Adobe utilizzando i server di Adobe, non il client, con latenza ridotta. [Altro...](https://experienceleague.adobe.com/docs/launch/using/server-side-info/server-side-overview.html?lang=it#server-side-info)

Aggiornato il **25 gennaio 2021**:

È stata rilasciata l’estensione del servizio Experience Cloud ID **5.1.1**. Per ulteriori informazioni, consulta le note sulla versione di [Estensione del servizio Experience Cloud ID](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/experience-cloud-id-release-notes.html?lang=it).

**Vedi anche**

* [Note sulla versione di Experience Platform Launch](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=it), per informazioni su Experience Platform Launch
...
* [Nuove funzioni di Adobe Analytics](#aa-features) (aggiornato il 25 gennaio 2021)
* [Nuove funzioni di Customer Journey Analytics](#cust-journey) (aggiornato il 25 gennaio 2021)
