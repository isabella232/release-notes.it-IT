...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Nuovi <span class="uicontrol"></span> modelli mobili per messaggi e posizione </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se la tua azienda ha un numero limitato di token di analisi contributi, ora l'interfaccia utente <span class="uicontrol"> di Analysis Workspace </span> mostra una notifica quando consumi un token. Puoi quindi sapere quanti token sono ancora disponibili.  </p> <p>(Gli utenti amministratori possono limitare il numero di utenti che possono utilizzare i token modificando le autorizzazioni del gruppo.)  </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/contribution/ca_main.html" format="html" scope="external"> Altro... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato modificato il funzionamento di Nessuno/Non specificato in <span class="uicontrol"> Analysis Workspace </span> in modo che sia coerente con [! UICONTROL Reporting &amp; Analytics], Segment Builder e il menu dei valori delle dimensioni in [! UICONTROL Analysis Workspace]. </p> <p>Ciò significa che il valore sarà visualizzato come "Non specificato" al posto di "Nessuno" nella maggior parte dei progetti in Analysis Workspace. (AN-146879) </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Appmeasurement (SDK legacy e <span class="uicontrol"> mobili </span> ) </p> </td> 
   <td colname="col2"> 
<!-- <draft-comment> 
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> È ora possibile attivare un'attività di segnale per i flussi di lavoro direttamente dall <span class="wintitle"> 'API </span> standard di Adobe Campaign. </p> <p>Per ulteriori informazioni, consulta la <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">relativa documentazione</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
