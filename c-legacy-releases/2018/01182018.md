...
| Esempi | Data di pubblicazione | Descrizione |
|--- |--- |--- |
...
| Digital Foundation | Maggio 2017 | L&#39;esempio Digital Foundation ti aiuta a implementare una piattaforma di marketing digitale con Analytics, ottimizzare e gestire le campagne. |
...
* A partire da marzo 2018, [!DNL Target] i flussi di lavoro Adobe non saranno disponibili in Adobe [!UICONTROL Mobile] Services.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Nuovi modelli mobili per messaggi e posizione </p> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> <b>Generatore di segmenti</b>: aggiunto un tipo di compatibilità prodotto Analysis Workspace </p> </td> 
   <td colname="col2"> <p>Nel <a href="https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html" format="html" scope="external"> generatore di segmenti </a> è stato aggiunto un tipo di compatibilità prodotto Analysis Workspace. </p> <p>I segmenti con intervalli di date integrati continueranno a funzionare diversamente in Analysis Workspace rispetto a Reports &amp; Analytics: In Workspace, un segmento con un intervallo di date integrato sostituisce l'intervallo di date del pannello. Reports &amp; Analytics, invece, consente l'intersezione dell'intervallo di date del rapporto e dell'intervallo di date integrato del segmento. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Risolto un bug in Regole di unione profilo sui browser Internet Explorer 11 per cui le opzioni di Profilo autenticato non erano visualizzate correttamente. (AAM-33628)
...
**[!DNL Adobe Campaign]Standard 18.1 - Data di rilascio: Gen. 15 2018**
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> È ora possibile attivare l'attività di un segnale per i flussi di lavoro direttamente dall'API standard di Adobe Campaign. </p> <p>Per ulteriori informazioni, consulta la <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">relativa documentazione</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Ricerca nei bulksheet e Ricerca in campagne - Funzione Beta </p> </td> 
