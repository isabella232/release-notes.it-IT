...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>Importante: </b>Con l'entrata in vigore del GDPR il 25 maggio 2018,  Adobe implementerà l'eliminazione <b>automatizzata dei file lasciati negli account FTP gestiti da Data Connector (precedentemente Genesis) partner.</b>(Questo NON si applica a tutti gli account FTP appartenenti ai clienti Analytics). Attualmente, i dati nelle cartelle FTP vengono conservati a tempo indefinito, il che può comportare il rischio che le aziende non siano pronte per il regolamento RGPD. A partire dal 25 maggio 2018, Adobe eliminerà tutti i file sui server FTP gestiti dai partner Data Connector 30 giorni dopo l'arrivo sul server.
   </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external">  <span class="wintitle"> Audience Manager  </span> e GDPR </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/it/campaign/kb/campaign-privacy.html" format="html" scope="external"> Campaign </a> </p> </td> 
...
<table id="table_FC7B5C6C59BD45238220D606D7BFC0A1"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Nuova pagina di destinazione dell’amministrazione </p> </td> 
   <td colname="col2"> <p>Quando accedi a Experience Cloud e apri la pagina Amministrazione, adesso è disponibile una nuova interfaccia intuitiva per aiutarti a visualizzare rapidamente le soluzioni e i servizi core di Experience Cloud. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Advertising Analytics ti permette di trasmettere i dati del tuo motore di ricerca  Adobe Analytics da Google AdWords, Yahoo! e Bing. </p> <p>Per eseguire la creazione di report affiancati con gli altri dati di Analytics hai a disposizione le metriche seguenti: </p> 
    ...
    </ul> <p>Inoltre, in Analytics sono disponibili le seguenti dimensioni: </p> 
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     <li id="li_B75433D55E0246C1AF2C86FDC830193A">Tipo di corrispondenza parola chiave (ID AMO) </li> 
     <li id="li_D0C425C5C99C4097B9465BB656872914">Piattaforma pubblicitaria (AMO ID) </li> 
     <li id="li_6CBD1FC70A134A088B4CD3C4854BBB9D">Account (ID AMO) </li> 
     <li id="li_3BF0E1D0E86C4E0A8A7CFB612EF728B0">Campaign (AMO ID) </li> 
     <li id="li_6F8CD2AD76DF4B50A87720F3FE88B39D">Ad Group (ID AMO) </li> 
     <li id="li_906E6AA5E2264995884C658B34E436CE">Annuncio (ID AMO) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Il connettore Adobe Analytics  è disponibile come connettore dati nativo nell'esperienza desktop Power BI. Quando viene avviato, è possibile eseguire l'autenticazione utilizzando l'Adobe ID  esistente. Puoi quindi accedere a un navigatore facile da usare per gli elementi dei dati della suite di rapporti e generare richieste di dati. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Le sessioni in base al contesto consentono agli analisti mobili e ai product manager di definire in che modo desiderano gestire una visita per la propria applicazione mobile retroattivamente. Consente di elaborare gli hit in background al di fuori di una visita e di avviare le visite all’avvio dell’app. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Reporting: Modifica alla dimensione Codici postali/ZIP del visitatore </p> </td> 
   <td colname="col2"> <p>Abbiamo aggiornato la dimensione Codici postali/ZIP del visitatore per allinearla con altre variabili geografiche in modo che il primo valore di un hit riceva credito per quell’hit. </p> <p>Ad esempio, se esegui un rapporto Città e lo suddividi per Codici postali/ZIP visitatore, nella suddivisione viene visualizzato solo il primo valore per ogni hit. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Modifica alle classificazioni </p> </td> 
   <td colname="col2"> <p>L’interfaccia utente Classificazioni è stata aggiornata per consentire l’uso finale dei tipi di classificazione numerici e abilitati per i dati. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Le seguenti modifiche sono state apportate all'interfaccia utente di Data Governance Labeling (Etichettatura per la governance dei dati): </p> 
    <ul id="ul_67929C32C8064D428216173D06C449BA"> 
     ...
     <li id="li_B6663A0FACA644A3AF11606892186CDC">I valori del campo con etichetta <span class="uicontrol">DEL-DEVICE</span> verranno resi anonimi solo quando nell'evento è presente un <span class="uicontrol">ID-DEVICE</span> specifico. Altre istanze di questi valori, che si verificano negli eventi che non vengono eliminati, non verranno modificate. Di conseguenza, i report che calcolano i conteggi univoci sul campo potrebbero essere modificati. Sui dispositivi condivisi, è possibile rimuovere gli identificatori di altri utenti oltre l'oggetto dati. </li> 
     ...
     <li id="li_BCB7DF19FA81459E9BE598B19C956460">Aggiunta la possibilità di esportare le etichette di governance dei dati sulle variabili in un file .csv. Questo semplifica la condivisione delle etichette con il team legale. </li> 
     <li id="li_CF202A81A675463BA3BC6783D9C9E0A1">Sono stati aggiunti valori di esempio per le dimensioni, che semplificano la visualizzazione del tipo di dati contenuti in ciascuna variabile e della relativa etichetta. </li> 
    </ul> <p>Inoltre, </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Rilascio effettivo programmato per il 15 maggio 2018</b> </p> <p> <span class="term">È stata aggiunta la colonna mc_audiences </span>. <span class="term"> mc_audiences </span> è l'elenco di ID segmento  Audience Analytics  Adobe <span class="wintitle">  Audience Manager </span>. </p> <p>Nota: non include i nomi descrittivi perché è una classificazione di ID. </p> 
    <!--<p>https://jira.corp.adobe.com/browse/AN-154807</p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Report Paesi in  Ad Hoc Analysis </p> </td> 
   <td colname="col2"> <p>Il rapporto Paesi in  Ad Hoc Analysis è stato rinominato Paesi/Regioni. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Analisi del video </p> </td> 
   <td colname="col2"> <p> <b>API di raccolta multimediale </b> </p> <p> Gli editori di contenuti multimediali che non sono stati in grado di misurare completamente le proprie viste video, a causa di restrizioni SDK VA o della mancanza di supporto SDK di Analytics video (VA), possono applicare l'API di Media Collection a questi dispositivi. Questo consente ai clienti di avere trasparenza rispetto a tutti i dispositivi su cui gli utenti visualizzano i video, compresi dispositivi come cuffie VR, console per videogiochi e altro ancora. L'API Media Collection fornisce le metriche granulari e standardizzate tramite la raccolta heartbeat VA SDK. Ora puoi combinare queste metriche per visualizzare l'intero percorso del cliente. </p> 
    <ul id="ul_FD2036F9D160400AAB654CEE30657AAB"> 
     <li id="li_5F4D87F536F6436DAD99F6CDB878BD52">Misurare Il Video Su Qualsiasi Dispositivo: Applica l’API Media Collection a qualsiasi dispositivo che al momento non dispone del supporto SDK, incluse le console di gioco e i dispositivi VR. </li> 
     <li id="li_2DEE2FE8ED26476CA4C25163D4803345">RESTful API to Compliment the VA SDK: L'API di Media Collection è stata creata per fornire un meccanismo di misurazione semplificato ed efficiente per ottenere gli stessi risultati granulari e metriche disponibili tramite l'SDK. </li> 
     <li id="li_F4D509A6904C484AA1F0BDFAEA678F8A">Misurazione del pubblico olistico: L'API di Media Collection ora può fornire una visione olistica di tutti gli impegni dei clienti con i video per acquisire una prospettiva più precisa sulla portata completa dei clienti. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Componente/strumento del prodotto </th> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">È stato risolto un errore che si verificava all'apertura del generatore di metriche calcolate in Analysis Workspace. Ciò causava la mancata visualizzazione delle opzioni nell'elenco a discesa Funzione. (AN-160698) </li> 
      <li id="li_C24CD6D3CDF748A0B959D44A4DF41C6A">Sono stati risolti diversi problemi con la funzione di ricerca nelle tabelle a forma libera. Il risultato è un'esperienza di modifica migliorata per le query filtro di base e avanzate. (AN-159843) </li> 
      <li id="li_727C26115CF946CDA62982DBEA4EAC6B">È stato risolto un problema che impediva la creazione di tag se il testo corrispondeva a un tag già esistente. (AN-159363) </li> 
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">È stato risolto un problema che causava l'impostazione predefinita delle visualizzazioni di testo nella parte superiore della pagina e che impediva loro di essere posizionate nella posizione desiderata. (AN-159148) </li> 
      <li id="li_ABD6A21F42664A3EAEE0036388831B8B">È stato risolto un problema che causava un problema di immissione dei caratteri giapponesi e coreani nel campo di ricerca nelle tabelle a forma libera. (AN-158778) </li> 
      <li id="li_A4F55515A9CA4845A4662DEA5712EE77">È stato risolto un problema che causava modifiche alle date di modifica del progetto quando gli utenti non amministratori preferivano, applicavano tag a progetti o approvavano progetti. (AN-157398) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">È stato risolto un problema nel Generatore di segmenti, a causa del quale l'etichetta nelle opzioni Solo prima della sequenza e Solo dopo la sequenza veniva modificata ed ora veniva ripristinata. (AN-160747) </li> 
      <li id="li_ED686B21894E4309841C7E322BB35843">È stato risolto un problema che causava agli utenti non amministratori l'accesso ad alcuni strumenti della suite di rapporti. (AN-159451) </li> 
      ...
      <li id="li_7AF0C1DF79844130B488EDAF27A35B91">È stato risolto un problema relativo alla funzione di scadenza della password in Impostazioni società. (AN-154927) </li> 
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">È stato risolto un problema che impediva il funzionamento della funzionalità Trasferisci risorse se l’utente le cui risorse dovevano essere trasferite era elencato come proprietario degli avvisi. (AN-160747) </li> 
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">È stato risolto un problema che si verificava durante l'accesso ad Analytics tramite l'Experience Cloud : quando più società di accesso erano associate a un nome utente, talvolta era selezionata una società di accesso non corretta. (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>API di generazione rapporti Web Services </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata rilasciata la versione 7.0 DIL che include gli aggiornamenti e le correzioni seguenti: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      ...
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">Sono state implementate le revisioni UX dell'estensione Lancio DIL. (CORE-8143) </li> 
     </ul> </p> <p>Contatta il consulente o l'Assistenza clienti di Adobe per l'ultima versione, oppure recuperala da <a href="https://marketing.adobe.com/resources/help/it_IT/dtm/c_overview.html" format="https" scope="external">Dynamic Tag Management (DTM)</a> o da <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external">Adobe Launch </a>. </p> </td> 
  </tr> 
  <tr> 
...
* È stato corretto un bug a causa del quale i clienti non potevano recuperare un elenco di tutte le caratteristiche tramite le chiamate API. (AAM-36824)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>L'ultima versione Enhanced Smart Tags offre miglioramenti fondamentali, come: </p> <p> 
     <ul id="ul_1F32257EF31548F986B7D547056BDB3C"> 
      <li id="li_4EDD96DF180B436CB817B8E1B150F1DF">Ottimizzazioni degli algoritmi per migliorare ulteriormente la precisione del modello e i valori di richiamo. </li> 
      <li id="li_86039BFA4E2E4B16A24F44A2FF710431"> Supporto per ripristinare la formazione sul modello per tutti i tag a livello di tenant. </li> 
      <li id="li_7363B9318FB1492A9F067B7F534C5355">Supporto per spazi dei nomi avanzati per evitare conflitti. </li> 
      <li id="li_9A675C8D29B549ADAE15BBC1B81311A7">Nuova politica di sostituzione del modello per evitare qualsiasi degrado dovuto alla riqualificazione. </li> 
      <li id="li_956259E154DC43DDAFE59836511AF87E">Monitoraggio dell’utilizzo del servizio per tenant. </li> 
      <li id="li_352CE4CD51AC4F798B11F6C2C0E9090C">Clustering, problemi specifici di connessione risolti per migliorare la robustezza del servizio. </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>La conferenza globale virtuale annuale fornisce sessioni approfondite per sviluppatori aziendali, architetti e esperti di dati a tutti i livelli di esperienza. Le sessioni in diretta si svolgono nei fusi orari Ora standard dell'India, Ora legale britannica e Pacifico. I titolari di biglietti dispongono inoltre di accesso illimitato a tutte le registrazioni per un anno. </p> <p> Adobe IMMERSE è la conferenza globale virtuale annuale per qualsiasi sviluppatore che sta creando soluzioni su Adobe Experience Manager. Quest'anno si terranno sessioni aggiuntive anche su Adobe Cloud Platform,  I/O Adobe,  Adobe Sensei, ColdFusion e FrameMaker. </p> <p>Ottenete presentazioni approfondite dei prodotti, ricette "come fare", best practice ed esempi di codice da esperti all'interno  Adobe e dalla community di sviluppatori più ampia. Le sessioni in diretta verranno trasmesse su tre fusi orari: </p> <p> 
     <ul id="ul_BDA2A6B569EF422B9327FBF7474D7D98"> 
      <li id="li_69F4FDE29DE14B1A969F428CB3A1A5A6">Americhe (ora standard del Pacifico) </li> 
      <li id="li_E3EA932CAA4F4122ACC7982CA1856CD1">Europa (Ora legale britannica) </li> 
      <li id="li_673F096F6C7541FB8F3FAA21914852F7">APAC (ora standard India) </li> 
     </ul> </p> <p>Controlla l'agenda, poi registrati usando il codice di sconto <b>MR765z</b> per avere lo sconto di 25,00 $ americani al seguente indirizzo: <a href="https://adobe.ly/immerse18" format="https" scope="external">https://adobe.ly/immerse18</a>. Non perdetevi la più grande conferenza per sviluppatori ospitata da  Adobe! </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Technologist Meetup Group </p> </td> 
   <td colname="col3"> <p>Questo gruppo virtuale fornisce notifiche per AEM webinar GEM, Ask the AEM Community Expert non appena vengono programmati. Vengono segnalati anche gli eventi di persona e gli incontri dei gruppi di utenti regionali. </p> <p> Iscriviti all’indirizzo <a href="https://adobe.ly/2sVoSwy" format="https" scope="external">https://adobe.ly/2sVoSwy  </a> </p> </td> 
  </tr> 
  <tr> 
...
## [!DNL Advertising Cloud] (già  Advertising Cloud)
