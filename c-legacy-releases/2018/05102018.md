...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
   &gt;[!IMPORTANTE]
 &gt;Con l'entrata in vigore del GDPR il 25 maggio 2018, Adobe implementerà <b>l'eliminazione automatica dei file rimasti negli account FTP gestiti dai partner Data Connector (già Genesis).</b>(Questo NON si applica a tutti gli account FTP appartenenti ai clienti Analytics). Attualmente, i dati nelle cartelle FTP vengono conservati a tempo indefinito, il che può comportare il rischio che le aziende non siano pronte per il GDPR. A partire dal 25 maggio 2018, Adobe eliminerà tutti i file sui server FTP gestiti dai partner Data Connector 30 giorni dopo l'arrivo sul server.
   </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_36A11615EEA34624AF7E422036B80723"> 
      ...
      <li id="li_CDDB0F0927B349DD9653F6B47EF57471"> È stata aggiunta una nuova API: <span class="codeph"> "retrieveThenRemoveIdentities" </span> che deve essere utilizzata nei casi in cui si desideri inviare una richiesta GDPR per accedere ed eliminare dei dati. Questa API imposterà la proprietà action su <span class="codeph"> ["access", "delete"] </span> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://www.adobe.com/privacy/general-data-protection-regulation.html" format="html" scope="external"> Adobe - Il GDPR e la tua attività </a> </p> </td> 
   <td colname="col2"> <p>Che cosa significa il GDPR per te in qualità di cliente Adobe. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Documentazione per gli sviluppatori sull'implementazione dell'API GDPR. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://www.adobe.io/apis/cloudplatform/gdpr/services.html" format="html" scope="external"> Servizi GDPR </a> </p> </td> 
   <td colname="col2"> <p>La libreria JavaScript di Adobe per la privacy e il GDPR. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Come configurare i namespace Identity per la conformità GDPR. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>API conformi al GDPR per i soggetti incaricati del controllo dei dati. Le API consentono agli utenti di recuperare le identità memorizzate localmente e di impostare i flag per lo stato di consenso alla raccolta e alla trasmissione di dati. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Documentazione e procedure sulla gestione delle richieste GDPR per l'amministratore della privacy dei clienti o per l'amministratore AEM. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/index.html" format="html" scope="external"> Analytics e GDPR </a> </p> </td> 
   <td colname="col2"> <p> Operazioni da effettuare in Adobe Analytics per supportare i diritti di accesso ed eliminazione GDPR dei tuoi soggetti interessati. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Data Workbench supporta i processi GDPR per rendere anonime le informazioni di identificazione personale. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/dtm/opt-in.html" format="html" scope="external"> Dynamic Tag Management </a> </p> </td> 
   <td colname="col2"> <p>Come evitare che i tag Adobe vengano attivati finché non è stato acquisito il consenso. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobelaunch.com/client-side-information/deploy-javascript-tags-to-opt-in-to-launch" format="https" scope="external"> Launch di Adobe </a> </p> </td> 
   <td colname="col2"> <p> Come gli sviluppatori possono utilizzare le estensioni e l'utilità di creazione regole per definire soluzioni di gestione dei consensi e delle rinunce. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Come consentire ai clienti di eliminare dati dal loro r [!DNL Target] profilo visitatore. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Come utilizzare il modulo di richiesta GDPR per consultare o eliminare i dati raccolti durante il tuo utilizzo di Adobe Social. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Come effettuare le richieste di accesso e di eliminazione consentite dal GDPR. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Scopri le nuova funzionalità di Adobe Campaign relative al GDPR. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>10 maggio 2018 </p> </td> 
   <td colname="col2"> <p>A causa della fine del supporto di TLS 1.0, abbiamo consigliato agli utenti di Adobe Report Builder (ARB) di scaricare Adobe Report Builder v5.6.21 prima del 13 settembre 2018. In seguito a questa data, le versioni precedenti di Report Builder di Adobe non saranno supportate. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ad Hoc Analysis Project Converter converte i progetti Ad Hoc in Analysis Workspace con un clic. </p> <p>I progetti copiati possono quindi essere usati e contrassegnati come necessari in Analysis Workspace. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/reference/vrs-mobile-visit-processing.html" format="html" scope="external"> Adobe Context-Aware Sessions </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>Aggiornamenti ad <a href="https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/index.html" format="html" scope="external">Analytics e al GDPR </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Rilascio effettivo programmato per il 15 maggio 2018</b> </p> <p> <span class="term">È stata aggiunta la colonna mc_audiences </span>. <span class="term"> mc_audiences </span> è l'elenco di ID del segmento di analisi del pubblico di Adobe Audience Manager. </p> <p>Nota: non include i nomi descrittivi perché è una classificazione di ID. </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poiché si avvicina il 25 maggio 2018, data in cui entrerà in vigore il Regolamento generale sulla protezione dei dati (GDPR), è stata preparata la documentazione per aiutarti a gestire i dati dei clienti in Audience Manager e a rispettare gli obblighi del GDPR. Fai riferimento a </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      ...
      <li id="li_C52BF49842114AF08B292CDCF330A19C"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-faq.html" format="https" scope="external"> Domande frequenti sul GDPR </a> </p> </li> 
      <li id="li_9873DB17A8C04497B0DD63AD87085F82"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-partners.html" format="https" scope="external"> Rimozione dei segmenti dei partner per il GDPR </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM e GDPR </p> </td> 
   <td colname="col3"> <p>Il Regolamento generale per la protezione dei dati (GDPR) dell'Unione europea sui diritti relativi alla privacy dei dati entra in vigore a maggio 2018. Altre informazioni sulla conformità di AEM e <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external">GDPR </a>. </p> </td> 
  </tr> 
  <tr> 
...
## [!DNL Advertising Cloud] (precedentemente Media Optimizer)
