...
Durante la settimana del 7 maggio 2018, Adobe ha rilasciato aggiornamenti di prodotto per supportare il [Regolamento generale sulla protezione dei dati (RGPD)](https://www.eugdpr.org). Le informazioni che seguono hanno lo scopo di aiutarti a comprendere e implementare queste ottimizzazioni, nonché ad adottare tutte le necessarie policy e procedure.
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Come consentire ai clienti di eliminare dati dal loro [!DNL Target] profilo visitatore. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Analytics ti consente di passare i dati del motore di ricerca in Adobe Analytics da Google AdWords, Yahoo! e Bing. </p> <p>Per effettuare il reporting affiancato con il resto dei dati di Analytics sono disponibili le seguenti metriche: </p> 
    ...
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     ...
     <li id="li_3BF0E1D0E86C4E0A8A7CFB612EF728B0"> </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poiché si avvicina il 25 maggio 2018, data in cui entrerà in vigore il Regolamento generale sulla protezione dei dati (RGPD), è stata preparata la documentazione per aiutarti a gestire i dati dei clienti in Audience Manager e a rispettare gli obblighi RGPD. Fai riferimento a </p> <p> 
...
* È stato corretto un bug nella visualizzazione del [Codice Builder](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) in cui le espressioni contenenti parentesi rimuovevano quest&#39;ultime se i clienti modificavano di nuovo il segmento. (AAM-36393)
