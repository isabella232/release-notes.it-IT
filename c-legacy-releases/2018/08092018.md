...
Consultate [le note sulla versione](https://helpx.adobe.com/experience-manager/cloud-manager/using/release-notes-2018-50.html).

**Componenti core, versione 2.1.0**

È ora disponibile la release 2.1.0 dei [componenti di base](https://helpx.adobe.com/it/experience-manager/core-components/user-guide.html), con miglioramenti a livello di componenti [immagine](https://helpx.adobe.com/it/experience-manager/core-components/using/image.html), un nuovo componente [Teaser](https://helpx.adobe.com/it/experience-manager/core-components/using/teaser.html) e numerose correzioni di bug.
...
Consultate le sessioni imminenti o guardate le sessioni precedenti [qui](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html).
...
Consultate le sessioni imminenti o guardate le sessioni precedenti [qui](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html).
...
 Evolve18 è una conferenza basata su community su Adobe Experience Manager, Campaign e Analytics per sviluppatori, professionisti del marketing e responsabili IT.  
