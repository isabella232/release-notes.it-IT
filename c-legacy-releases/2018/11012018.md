...
| Adobe [!DNL Analytics] e Regolamento generale sulla protezione dei dati (RGPD) | [!DNL Analytics][!DNL Analytics] supporta un nuovo metodo per trasmettere l&#39;ID visitatore di precedente a una richiesta RGPD (vedi [AAID](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_namespaces.html)). Also, [!DNL Analytics] now supports [deleting (anonymizing) the Purchase ID value](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_labels.html) as part of a delete request. |
