...
Per ulteriori informazioni, consulta [Piani DTM per abbandono](https://forums.adobe.com/community/experience-cloud/platform/launch/blog/2018/10/05/dtm-plans-for-a-sunset).
...
| -----------| ---------- |  
| [Modifiche a VRS/cura del progetto](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/curate-projects-vrs.html) | (Implementato a settembre 2018.) Sono state apportate modifiche ai componenti che amministratori e non amministratori possono visualizzare nei progetti Workspace curati e nelle suite di rapporti virtuali (VRS) curate. In precedenza, chiunque poteva vedere i componenti non curati facendo clic sul pulsante **[!UICONTROL Mostra tutti i componenti]**. L’esperienza di gestione aggiornata consente un controllo più dettagliato sui componenti visibili. |
| Adobe [!DNL Analytics] e Regolamento generale sulla protezione dei dati (RGPD) | [!DNL Analytics] supporta un nuovo metodo per passare il precedente ID visitatore di [!DNL Analytics] a una richiesta RGPD (consulta [AAID](https://marketing.adobe.com/resources/help/it_IT/analytics/gdpr/gdpr_namespaces.html)). Inoltre, [!DNL Analytics] ora supporta [l’eliminazione (anonimizzazione) del valore ID acquisto](https://marketing.adobe.com/resources/help/it_IT/analytics/gdpr/gdpr_labels.html) come parte di una richiesta di eliminazione. |
| [Miglioramenti a RGPD/ePrivacy per l’inoltro a lato server](https://marketing.adobe.com/resources/help/it_IT/analytics/audiences/ssf-gdpr.html) | In base al [regolamento UE sulla conformità ai cookie](http://ec.europa.eu/ipg/basics/legal/cookies/index_en.htm), i titolari del trattamento dei dati (clienti [!DNL Analytics]) hanno ora la possibilità di limitare i dati divulgati prima del consenso ad Adobe [!DNL Analytics] e di impedire che vengano inoltrati al server ad Adobe Audience Manager (AAM). Una nuova variabile di contesto dell&#39;implementazione consente di contrassegnare le richieste dove non è stato ricevuto il consenso. La variabile, quando impostata, impedisce che queste richieste vengano inviate all&#39;AAM fino al ricevimento del consenso. |
...
Per le ultime informazioni, consulta [Note sulla versione di Workbench dati](https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/).
...
| [Funzionalità avanzate di Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab-advanced.html) - **Duplica modello di allocazione** e **Test segmenti di prova** | Sono state rilasciate due funzioni che incrementano la produttività nell’utilizzo di Audience Lab. Scopri come iniziare a utilizzarli nelle [Funzionalità avanzate di Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab-advanced.html). |
...
* L&#39;ultima versione di Safari include gli strumenti ITP (Intelligent Tracking Prevention) 2.0. Ciò influisce sulle metriche del pubblico indirizzabile per gli utenti di Safari e sulla raccolta di dati utilizzando il segnale h_referer. Leggi il traffico di Safari come [causa di bassi tassi di corrispondenza per tipi di pubblico utilizzabili](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences-match-rates.html) e [raccolta dati utilizzando il prefisso h_](https://marketing.adobe.com/resources/help/en_US/aam/r_tb_variable_prefixes.html).
* Il rilascio delle [Esclusioni di caratteristiche nella·modellazione algoritmica](https://marketing.adobe.com/resources/help/en_US/aam/trait-exclusion-algo-models.html) ha introdotto un problema per i clienti che utilizzano [controlli di accesso basati sul ruolo](https://marketing.adobe.com/resources/help/en_US/aam/c_administration.html). Quando crei un nuovo modello, se selezioni origini di dati a cui hai accesso, nella finestra **Esclusioni** vengono elencate le caratteristiche corrispondenti. Tuttavia, se oltre alle origini di dati a cui hai accesso ne selezioni anche altre cui non hai accesso, l’elenco risulta vuoto. Per vedere le caratteristiche, deseleziona le origini di dati a cui non hai accesso. (AAM-42380)

**Aggiornamenti alla documentazione**

* Abbiamo aggiunto definizioni ed esempi per tutte le metriche nei Rapporti generali. Leggi la [Documentazione sui report generali](https://marketing.adobe.com/resources/help/en_US/aam/c_general_reports.html).
* Abbiamo aggiornato la documentazione relativa al pubblico indirizzabile per chiarire la differenza tra le metriche a livello di cliente e di segmento. Leggi la [Documentazione sul pubblico di riferimento](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audience-metrics.html).
...
Consulta le [Note sulla versione di AEM Dispatcher](https://helpx.adobe.com/experience-manager/dispatcher/release-notes.html).
...
Vedi anche: [Configura l’integrazione di AEM Assets con Experience Cloud](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/configure-assets-cc-integration.html) e [Best practice per intergrazione di Creative Cloud e AEM e Creative Cloud](https://helpx.adobe.com/experience-manager/6-4/assets/using/aem-cc-integration-best-practices.html).
...
Fai riferimento a [Note sulla versione di Adobe Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) per le ultime informazioni di rilascio per i seguenti prodotti:
