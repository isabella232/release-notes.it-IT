...
Gli [esempi pratici di Experience Cloud](https://helpx.adobe.com/it/marketing-cloud/how-to/use-cases.html) aiutano a implementare flussi di lavoro e integrazioni tra le diverse soluzioni.
...
* API DCS: abbiamo aggiunto un nuovo codice di errore: 198 - Le richieste provenienti da questo paese sono bloccate dal partner. Ulteriori informazioni sono disponibili in [Riferimento API DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html).
...
### Note sulla versione {#section_8CD42C5750254AA88D6ACA7DBFA0D9A1} di AEM
