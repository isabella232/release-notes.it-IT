...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> I registri di utilizzo di Analytics ora tengono traccia del momento in cui un utente apre un progetto in <span class="uicontrol"> Analysis Workspace </span> (oltre al tracciamento esistente per creare, aggiornare, annullare la condivisione ed eliminare le azioni.) Ciò consente di avere una migliore visibilità degli utenti che utilizzano l’Area di lavoro e della frequenza con cui questa viene utilizzata. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A giugno 2018, Adobe deprecherà il supporto per il protocollo TLS 1.0. La funzionalità di Adobe <span class="wintitle"> Audience Manager </span> non funzionerà per gli utenti finali che utilizzano browser che supportano solo TLS 1.0. Abbiamo raccolto un elenco di browser, versioni e supporto TLS. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>È ora possibile creare elenchi di remarketing di Google AdWords (RLSA) dai segmenti condivisi di Analytics. In precedenza, l'inserzionista doveva disporre di Adobe <span class="wintitle"> Audience Manager </span>. Per essere idoneo, un inserzionista deve implementare il servizio Adobe Experience Cloud ID, fornire il proprio ID organizzazione IMS e distribuire un tag sui propri siti Web. </p> </td> 
  </tr> 
  <tr> 
