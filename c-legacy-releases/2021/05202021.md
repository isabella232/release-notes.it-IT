...
Consulta le [!DNL Marketo Engage] [note sulla versione](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=en) per informazioni aggiornate sulla pianificazione.
