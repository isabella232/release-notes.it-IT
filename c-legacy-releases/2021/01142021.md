...
I servizi di Experience Cloud e la documentazione sull&#39;amministrazione includono Attributi del cliente, Libreria Pubblico ([!UICONTROL Persone] ), attivazione, gestione di utenti e prodotti e cookie di Experience Cloud.
...
Generale: l&#39;SDK è ora distribuito utilizzando [!DNL XCFrameworks] al fine di supportare l&#39;hardware con la nuova architettura Apple M1, mantenendo al contempo il supporto per l&#39;architettura Intel® esistente.
...
| 9 dicembre 2020 | [Creare regole in Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=it) | Video | Scopri come creare regole in [!UICONTROL Offer Decisioning]. Le regole vengono create utilizzando gli eventi e gli attributi in Platform [!UICONTROL Profilo cliente in tempo reale] e dai vincoli di idoneità delle offerte. |
...
| ----------- | ---------- | ----- |
| Dimensioni [!UICONTROL Dispositivo] e [!UICONTROL Geografia] | 30 ottobre 2020 | Queste dimensioni sono ora disponibili per impostazione predefinita come parte del [Ricerca standard](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/standard-lookups.html) progetto di supporto in Adobe Analytics [!UICONTROL Connettore sorgente]. Questa aggiunta fortemente richiesta aumenta la [parità tra Adobe Analytics e Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-aa.html?lang=it#cja-overview). |
| Journey IQ: [!UICONTROL Cross-Channel Analytics] | 11 gennaio 2021 | IQ percorso: [!UICONTROL Analisi cross-channel] consente di reimpostare un set di dati di un evento Adobe Analytics (o di altro tipo) in un data lake di Experience Platform da uno spazio dei nomi ID a un altro. In genere è possibile reimpostare il set di dati dell’evento da un ID basato su cookie a un ID basato su persona. In questo modo, il set di dati rekeyed può essere combinato con altri dati basati su persona in una connessione CJA, consentendo così l’analisi tra dispositivi e canali in Analysis Workspace. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/cca/overview.html?lang=it#cja-connections) |
| Analysis Workspace - Selezione di componenti | 4 febbraio 2021 | Il componente per la zona di rilascio o a discesa disponibile in [!UICONTROL Quick Insights] è stato aggiunto a tutte le zone di rilascio in [!UICONTROL Workspace]. Questo miglioramento consente di scegliere da un elenco a discesa di componenti compatibili o continuare a utilizzare lo spazio come zona di rilascio. |
...
Per ulteriori informazioni su questo plug-in, consulta [Esperienza unificata](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=it#benefits).
      * Index Converter è un&#39;utilità che può essere utilizzata per trasformare le definizioni di indice OAK personalizzato di un cliente in definizioni di indici OAK compatibili as a Cloud Service ad Experience Manager.
...
| 9 dicembre 2020 | [Compatibilità API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=it) | Articolo | Crea un semplice articolo che comunica chiaramente quali API AEM (npm, Java™, HTTP) possono essere utilizzate per vari [!UICONTROL Risorse] operazioni. |
...
| -----------| ---------- |
| Nuova guida | La guida precedente è stata sostituita da pagine aggiornate, disponibili dal collegamento Aiuto nel menu principale DSP e sempre disponibili dal menu [https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html?lang=it) |
