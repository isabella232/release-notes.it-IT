...
| Aprile 2021 | [Modellazione avanzata per GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/advanced-modeling.html?lang=it) | Video | Scopri come creare relazioni tra modelli di frammenti di contenuto in Adobe Experience Manager (AEM) e come utilizzarle nelle query GraphQL. |
| Aprile 2021 | [Creazione di query GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/creating-graphql-queries.html?lang=it) | Video | Scopri come creare query GraphQL per restituire contenuto da Adobe Experience Manager (AEM) e come utilizzare lo strumento GraphiQL per testare, perfezionare ed eseguire il debug delle query in modo rapido. |
