...
| 3 febbraio 2021 | [Attivare i dati per applicazioni non Adobe](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=it) | Video | Scopri come usare Adobe Real-time CDP per creare vere strategie di personalizzazione con il tuo pubblico. Inoltre, scopri come si inserisce nell’ecosistema e nelle applicazioni non Adobe esistenti da Microsoft®, Google e Facebook. |
