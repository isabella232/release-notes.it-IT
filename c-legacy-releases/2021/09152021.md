...
| Funzione | Descrizione |
| ------- | ----------- |
| Sicurezza del marchio | (Versione del 22 settembre) [!DNL DoubleVerify] prodotti pre-bid per la sicurezza del marchio sono stati aggiornati a [!DNL Brand Suitability Tiers], che consentono agli inserzionisti di scegliere tra tre livelli di rischio (basso, medio e alto) per segmenti specifici senza evitare tutte le istanze di un determinato argomento. Storicamente, i segmenti non includevano livelli di tolleranza. |
...
| Funzione | Descrizione |
| ------- | ----------- |
| Approfondimenti sulla pubblicità | (8 settembre) Ulteriori informazioni sono disponibili in modalità beta. |  | Sicurezza del marchio | (Versione del 22 settembre) [!DNL DoubleVerify] prodotti pre-bid per la sicurezza del marchio sono stati aggiornati a [!DNL Brand Suitability Tiers], che consentono agli inserzionisti di scegliere tra tre livelli di rischio (basso, medio e alto) per segmenti specifici senza evitare tutte le istanze di un determinato argomento. Storicamente, i segmenti non includevano livelli di tolleranza. |
