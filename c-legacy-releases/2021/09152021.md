...
| Funzione | Descrizione |
| ------- | ----------- |
| Approfondimenti sulla pubblicità | (8 settembre) Ulteriori informazioni sono disponibili in modalità beta. |  | Sicurezza del marchio | (versione del 22 settembre) [!DNL DoubleVerify] i prodotti pre-bid per la sicurezza del brand sono stati aggiornati a [!DNL Brand Suitability Tiers], che consente agli inserzionisti di scegliere tra tre livelli di rischio (basso, medio e alto) per segmenti specifici senza evitare tutte le istanze di un determinato argomento. Storicamente, i segmenti non includevano livelli di tolleranza. |
