...
Consulta [Servizio Experience Cloud ID](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) per note sulla versione cumulative.
...
* È stata aggiornata la definizione della guida per [la documentazione della sintassi](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) di metrica (X, B). (AN-180527)
