...
Per le note sulla versione cumulative, consulta [Servizio Experience Cloud ID](https://marketing.adobe.com/resources/help/it_IT/mcvid/mcvid-release-notes.html).
...
Per ulteriori informazioni sui Mobile SDK, consulta: [Android SDK 4.x per Experience Cloud Solutions](https://docs.adobe.com/content/help/en/mobile-services/android/overview.html) e [iOS SDK 4.x per Experience Cloud
Solutions](https://docs.adobe.com/content/help/it-IT/mobile-services/ios/overview.html).
...
* È stata aggiornata la definizione dell’Aiuto per la documentazione della sintassi della metrica [log (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html). (AN-180527)
