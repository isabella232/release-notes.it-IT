...
* È stato risolto un problema in cui il nome/cognome dell’utente (migrato) di Analytics era diverso da quello collegato all’Adobe ID dell’utente in Experience Cloud. Per aggiornare il nome di Analytics con quello di Experience Cloud, passa a **Admin** &gt; **!UICONTROL User Management (Legacy)**&gt;**!UICONTROL Edit Users** (Amministrazione &gt; Gestione utente (versione precedente) &gt; Modifica utenti) e fai clic sull’ID utente. Fai clic su **!UICONTROL Update from Experience Cloud **(Aggiorna da Experience Cloud). (AN-172825)
...
* La [pagina di riepilogo sulle caratteristiche](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_tb_trait_summary.html) visualizza ora il tipo di caratteristica. (AAM-25784)
...
Leggi la sezione sul [monitoraggio e aggiunta in blacklist degli ID](https://marketing.adobe.com/resources/help/en_US/aam/id-monitoring-blacklisting.html) per capire in che modo il DCS monitora gli ID ricevuti e inserisce nella blacklist quelli che vengono inviati con una frequenza insolitamente alta in un breve periodo di tempo.
...
Per ulteriori informazioni, consulta l’articolo sui [rapporti di notifica push](https://helpx.adobe.com/it/campaign/standard/reporting/using/push-notification-report.html).
...
Per ulteriori informazioni, consulta l’articolo sull’[utilizzo di Adobe Experience Platform SDK](https://helpx.adobe.com/it/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Per ulteriori informazioni, consulta le [informazioni sulla messaggistica in-app](https://helpx.adobe.com/it/campaign/standard/channels/using/about-in-app-messaging.html) e la relativa [esercitazione in-app](https://helpx.adobe.com/campaign/kt/acs/using/acs-in-app-message-tutorial.html).
...
* Durante l’uso della funzione **Carica file**, è ora possibile aggiungere una marca temporale al nome del file contenente i record rifiutati. Per ulteriori informazioni, consulta la [documentazione dettagliata](https://helpx.adobe.com/campaign/standard/automating/using/load-file.html#configuration).
...
Consulta le relative [note sulla versione](https://docs.adobe.com/content/help/en/experience-manager-cloud-manager/using/release-notes/release-notes-current.html) associate.
...
Per informazioni dettagliate, consulta [Novità di AEM Assets Brand Portal](https://helpx.adobe.com/it/experience-manager/brand-portal/using/whats-new.html) e [Note sulla versione](https://helpx.adobe.com/it/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html).
...
Per le ultime informazioni, consulta le [Note sulla versione di Livefyre](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html).
