...
Per ulteriori informazioni, consulta [Rapporti di notifica push](https://helpx.adobe.com/it/campaign/standard/reporting/using/push-notification-report.html).
...
Per ulteriori informazioni, consulta la guida sull’[utilizzo di Adobe Experience Platform SDK](https://helpx.adobe.com/it/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Per ulteriori informazioni, consulta la sezione sulla [messaggistica in-app](https://helpx.adobe.com/it/campaign/standard/channels/using/about-in-app-messaging.html) e l’[esercitazione in-app](https://helpx.adobe.com/it/campaign/kt/acs/using/acs-in-app-message-tutorial.html) dedicata.
...
Consulta le relative [Note sulla versione](https://docs.adobe.com/content/help/it-IT/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).
...
Per informazioni aggiornate, consulta le [Note sulla versione di Livefyre](https://docs.adobe.com/content/help/it-IT/livefyre/using/release-notes/c-rn.html).
