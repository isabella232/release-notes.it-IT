...
* È stato risolto un problema in cui il nome/cognome dell’utente (migrato) di Analytics era diverso da quello collegato all’Adobe ID dell’utente in Experience Cloud. To update the Analytics name with the one in Experience Cloud, go to **[!UICONTROL Admin]** > **[!UICONTROL User Management (Legacy)]** > **[!UICONTROL Edit Users]** and click the User ID. Fai clic su **[!UICONTROL Update from Experience Cloud]** (Aggiorna da Experience Cloud). (AN-172825)
...
Per ulteriori informazioni, consulta [Utilizzo di Adobe Experience Platform SDK](https://helpx.adobe.com/it/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Con Cloud Manager 2019.2.0 è stata aggiunta una funzione di monitoraggio del sistema. Questa nuova funzionalità consente ai clienti di visualizzare a livello di sistema lo stato dei propri ambienti Adobe Managed Services.
...
Per informazioni dettagliate, consultate [Novità in  Portale](https://helpx.adobe.com/it/experience-manager/brand-portal/using/whats-new.html) marchio AEM Assets e [Note](https://helpx.adobe.com/it/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)sulla versione.
