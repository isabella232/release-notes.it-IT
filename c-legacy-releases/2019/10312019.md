...
| Fine del ciclo di vita dell’opzione **[!UICONTROL Enforce IP Login Restrictions]** | 30 ottobre 2019 | Annuncio della data di fine del ciclo di vita, gennaio 2020, per la funzionalità IP Allowed List (**[!UICONTROL Applica restrizioni di accesso IP]**) nel menu **[!UICONTROL Amministratore > Impostazioni società > Sicurezza]**. |
