...
* Consultate [[! Note sulla versione DNL Experience Platform]](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) su Adobe. io per gli aggiornamenti più recenti.[!DNL Experience Platform]
...
| **Raccolta dati:** Nuovo cookie s_ecid | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
