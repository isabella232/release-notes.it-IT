...
* Audience Analytics : È stato risolto un problema che si verificava dopo la modifica del nome di un&#39;audience in  Audience Manager (AAM). Il nome aggiornato non veniva riflesso in  Audience Analytics. (AN-176237)
* È stato risolto un problema che impediva agli utenti di salvare segmenti Analytics in AAM. Ciò è stato causato da cartelle AAM esistenti con nomi composti in caratteri maiuscoli e minuscoli. Ora tutte le cartelle vengono considerate senza distinzione tra maiuscole e minuscole in modo da poterle sincronizzare. (AN-177934)
* È stato risolto un problema che si verificava quando gli utenti accedevano ad Analytics tramite il Experience Cloud  e quindi la sessione terminava. Quando si riprende la sessione, l&#39;utente è stato reindirizzato a un URL errato. (AN-176812)
...
AEM 6.5, disponibile dall’8 aprile 2019, è un upgrade della codebase di AEM 6.4. I nostri ultimi aggiornamenti a AEM 6.5 ti consentono di accedere immediatamente a miglioramenti entusiasmanti che ti consentono di progredire ancora più rapidamente.
...
L’ultima release di Cloud Manager (2019.4.0 rilasciata il 18 aprile 2019) aggiunge un’interfaccia utente localizzata in francese, tedesco e giapponese. Sono stati inoltre migliorati i passaggi di distribuzione.
...
AEM 6.4, Service Pack 4 (6.4.4.0 rilasciato il 04 aprile 2019) è un aggiornamento importante che include correzioni di problemi fondamentali per i clienti, introdotte successivamente alla data di disponibilità generale del AEM 6.4, aprile 2018.

[Note sulla versione per le versioni AEM 6.4 Service Pack](https://helpx.adobe.com/it/experience-manager/6-4/release-notes/sp-release-notes.html)[AEM Forms](https://helpx.adobe.com/it/aem-forms/kb/aem-forms-releases.html)

**Connettore AEM S3**

AEM istanze con versioni precedenti del connettore S3 Datastore potrebbero non essere disponibili a causa di problemi di accesso S3 dopo la fine del supporto per la versione 2 della firma il 24 giugno 2019. Come cliente AEM,  Adobe consiglia di verificare la versione del connettore S3 Datastore in uso. Se necessario, eseguite l&#39;aggiornamento a una versione recente.

Vedere [L&#39;impatto di AWS Signature Versione 2 Obsoleto per  Amazon S3](https://helpx.adobe.com/it/experience-manager/kb/the-impact-of-aws-signature-version-2-deprecation-for-amazon-s3.html)

### Aiuto e documentazione

**Modernizza la base di codice per gli AEM Sites**

Scopri come sfruttare la tecnologia AEM più recente per modernizzare la base di codice per gli AEM Sites. [Modernizzazione Della Base Di Codici Adobe Experience Manager Sites  Esistente](https://expleague.azureedge.net/labs/L761/index.html)

**Editor Rich Text AEM - Dive profonde**

Scoprite le procedure ottimali relative alle configurazioni avanzate e all&#39;utilizzo dell&#39;Editor Rich Text in AEM.

Vedere [AEM Rich Text Editor (RTE) Deep Dive](https://helpx.adobe.com/it/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
