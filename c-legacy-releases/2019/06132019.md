...
* Per informazioni aggiornate, consulta [Experience Platform Launch](https://docs.adobelaunch.com/).
...
| Guardrail, Robustezza e Scalabilità | Una serie di miglioramenti è stata aggiunta a Campaign Classic. Guardrail, robustezza e scalabilità sono elencati in [Note sulla versione Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
