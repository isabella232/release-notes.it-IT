...
| Modifica imminente del comando Debugger di Analysis Workspace | 4 aprile 2019 | Il comando Console per attivare il debugger di Analysis Workspace verrà modificato in adobeTools.debug.includeOberonXml il **13 giugno 2019**. Dopo tale data, adobe.tools.debug.includeOberonXml cesserà di funzionare. |
...
Sono state aggiunte nuove funzionalità per consentire agli utenti amministratori di connettere gli indirizzi IP alle istanze Campaign Classic.
