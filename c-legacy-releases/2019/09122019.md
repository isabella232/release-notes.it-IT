...
| Modifiche imminenti al comando Debugger di Analysis Workspace | 4 aprile 2019 | Il comando Console per attivare il debugger di Analysis Workspace verrà modificato in adobeTools.debug.includeOberonXml il **13 giugno 2019**. Dopo tale data, adobe.tools.debug.includeOberonXml cesserà di funzionare. |
...
La data di fine del ciclo di vita di [!DNL Digital Publishing Suite Classic] (DPSC) è il 31 agosto 2019. For more information, see the [[!DNL Digital Publishing Suite Classic] End-of-Life FAQ](https://helpx.adobe.com/it/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
Sono state aggiunte nuove funzionalità per consentire agli utenti Admin di consentire agli indirizzi IP di connettersi alle istanze di Campaign Classic.
