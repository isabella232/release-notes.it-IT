...
# Note sulla versione di Adobe Experience Cloud - febbraio 2019
...
* [Target](https://docs.adobe.com/content/help/it-IT/target/using/release-notes/target-release-notes.html) (collegamenti alla docuemntazione della soluzione)
...
* [Note sulla versione](https://helpx.adobe.com/it/experience-manager/release-notes--aem-6-1-cumulative-fix-pack-.html)
* [Versioni Cumulative Fix Pack di AEM Forms](https://helpx.adobe.com/it/aem-forms/kb/aem-forms-releases.html)

### Aiuto e documentazione

Per suggerimenti per la risoluzione dei problemi relativi ai problemi di integrazione di AEM, consulta [Risoluzione dei problemi di integrazione](https://helpx.adobe.com/it/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html).
