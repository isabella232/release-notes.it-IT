...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) - Collegamenti alla guida della soluzione
...
* [Launch](https://docs.adobelaunch.com/) - collegamenti alla guida del prodotto
...
Con la versione 8.1, la libreria DIL è ora conforme ai criteri di sicurezza più rigorosi di Google Tag Manager. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. Questa modifica verrà integrata in versioni future. (CORE-24189)
