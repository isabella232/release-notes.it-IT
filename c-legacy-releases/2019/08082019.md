...
[Campaign Standard versione 19.3](https://docs.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html)
...
Le [funzionalità del nuovo pannello di controllo](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html) includono la capacità di aggiungere URL a cui Campaign Classic si connette per i trasferimenti di dati e file.
