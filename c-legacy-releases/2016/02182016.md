...
Marketing Cloud: Le nuove funzioni includono miglioramenti alle risorse di Marketing Cloud e un flusso di lavoro migliorato per il collegamento di account di soluzioni all&#39;Adobe ID .  Adobe mobile: Aggiornamenti alle integrazioni Apteligent e appFigures. Analytics: Nuova configurazione dell&#39;autorizzazione Report in tempo reale in Strumenti di amministrazione. Audience Manager : Disattiva feed di dati in  Audience Marketplace. Experience Manager : service pack e hotfix. Inoltre, correzioni e miglioramenti generali nella versione di manutenzione di febbraio.
...
<table id="table_C9B288CF42034F329C3C72D95D22E515"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Miglioramenti a Risorse Marketing Cloud </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     ...
     <li id="li_741A006D5EEE4612AD7BF748BB6742A4">È stato corretto un problema di gestione utente/reimpostazione della password a causa del quale l'amministratore che effettuava l'accesso con le credenziali di Marketing Cloud causava un errore. (AN-108518) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> provider di dati di Audience Marketplace possono revocare l'accesso dell'acquirente a un feed sottoscritto. Per informazioni su come i venditori revocano i feed e cosa accade agli acquirenti, vedi: </p> 
...
Aggiornamenti e aggiunte di documenti importanti alle versioni precedenti di Adobe Marketing Cloud.
