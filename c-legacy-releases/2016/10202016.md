...
>[!IMPORTANT]
>
>Se si utilizza la libreria 1.9.0+ del servizio Marketing Cloud ID, la sincronizzazione degli ID verrà avviata per Adobe Media Optimizer per impostazione predefinita. Consulta [Informazioni sulla sincronizzazione degli ID e sulle percentuali di corrispondenza](https://marketing.adobe.com/resources/help/it_IT/mcvid/mcvid-match-rates.html).
...
* **(Aggiornato il 28/10, 04/11)** Il servizio ID sincronizza automaticamente [!DNL  Marketing Cloud] gli ID (MID) con [!DNL  Adobe Media Optimizer] e altri domini interni [!DNL  Adobe] direttamente sulla pagina. La sincronizzazione automatica è abilitata per tutti gli account esistenti e nuovi. Ciò consente di migliorare le percentuali di corrispondenza di [!DNL  Media Optimizer]. Applicabile a VisitorAPI.js versione 1.9 o versioni successive. Consulta anche [Informazioni sulla sincronizzazione ID e sulle percentuali di corrispondenza](https://marketing.adobe.com/resources/help/it_IT/mcvid/mcvid-match-rates.html). (MCID-152, MCID-184)
...
Per ulteriori informazioni, consulta l’articolo sulle [modifiche alle API di autorizzazione di Ottobre](https://marketing.adobe.com/developer/forum/administration/permissions-api-changes-for-october) in Developer Connection.
...
* [!DNL  Adobe Social] ora supporta il nuovo calcolo del numero di caratteri di Twitter, che permette di includere più caratteri nei tweet. Per ulteriori informazioni, consulta il [blog Twitter](https://blog.twitter.com/express-even-more-in-140-characters).
