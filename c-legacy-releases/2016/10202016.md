...
>[!IMPORTANT]
>
>Se si utilizza la libreria 1.9.0+ del servizio Marketing Cloud ID, la sincronizzazione degli ID verrà avviata per Adobe Media Optimizer per impostazione predefinita. Consulta [Informazioni sulla sincronizzazione degli ID e delle percentuali di corrispondenza](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).

* È stato corretto un bug a causa del quale gli [!DNL  Audience Manager] ID utente univoci (AAMUUID) venivano [!DNL  Marketing Cloud] trasferiti al servizio ID. (MCID-203)
...
* **(Aggiornato 10/28, 11/4)** Il servizio ID sincronizza automaticamente [!DNL  Marketing Cloud] gli ID (MID) con [!DNL  Adobe Media Optimizer] e altri domini interni [!DNL  Adobe] direttamente sulla pagina. La sincronizzazione automatica è abilitata per tutti gli account esistenti e nuovi. This helps improve match rates for [!DNL  Media Optimizer]. Applicabile a VisitorAPI.js versione 1.9 o versioni successive. Consultare anche [Understanding ID Synchronization and Match Rates](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html) (Descrizione della sincronizzazione degli ID e delle percentuali di corrispondenza). (MCID-152, MCID-184)
    ...
    <ul id="ul_05ED67AA88094BB7B87CD7E648CF61CF"> 
     ...
     <li id="li_63188564A41B44E28970F204553E60FC"> <span class="uicontrol"> Dimensioni: </span> 
      <ul id="ul_3DC61B9C1EA54CDCA7C8895EED163E9A"> 
       ...
       <li id="li_DC9E47E50F0541FF8894D2693B06230E">I rapporti video e mobili riguardano la categoria delle dimensioni, come gli altri rapporti delle soluzioni Analytics (Experience Manager, Media Optimizer, Social e così via). </li> 
...
* Ora è possibile salvare un segmento con le stesse regole di segmento e la stessa origine dati di un altro segmento, a condizione che il nuovo segmento abbia una regola di unione profilo differente. (AAM-26671)
...
**Nuove funzioni in Media Optimizer**
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p>Le regole di aggiornamento delle strategie pubblicitarie nelle campagne ottimizzate vengono adesso applicate all'offerta ottimizzata generata da Media Optimizer, piuttosto che all'offerta di base. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>I target degli annunci creati negli editor di Facebook tramite target flessibili sono visibili in modalità di sola lettura in Media Optimizer. </p> </td> 
  </tr> 
  <tr> 
