---
description: Rilascio delle funzioni di Analytics - Autunno 2016. Le nuove funzioni di  Analysis Workspace includono funzionalità Funnel (Fallout e Flusso), avvisi intelligenti, istogrammi personalizzati e progetti iniziali. Rilevamento delle anomalie e Analisi contributi sono ora disponibili in  Analysis Workspace. I miglioramenti principali delle autorizzazioni sono disponibili in Amministratore > Gruppi. Report Builder 5.4 e aggiornamenti ad Adobe Mobile. AEM versioni includono Mobile 2016.12, Desktop App 1.3, AEM feature pack Risorse 3D e aggiornamenti a Livefyre e Scene7.
...
Rilascio delle funzioni di Analytics - Autunno 2016. Le nuove funzioni di  Analysis Workspace includono funzionalità Funnel (Fallout e Flusso), avvisi intelligenti, istogrammi personalizzati e progetti iniziali. Rilevamento delle anomalie e Analisi contributi sono ora disponibili in  Analysis Workspace. I miglioramenti principali delle autorizzazioni sono disponibili in Amministratore > Gruppi. Report Builder 5.4 e aggiornamenti ad Adobe Mobile. AEM versioni includono Mobile 2016.12, Desktop App 1.3, AEM feature pack Risorse 3D e aggiornamenti a Livefyre e Scene7.
...
>[!IMPORTANT]
>
>Utilizzando la libreria 1.9.0+ del servizio ID di Marketing Cloud, la sincronizzazione degli ID verrà avviata per Adobe Advertising Cloud per impostazione predefinita. Consulta [Informazioni sulla sincronizzazione degli ID e delle percentuali di corrispondenza](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-match-rates.html).
...
<table id="table_3D79042552CA4F608A57688E642C7841"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> È stato aggiunto un nuovo tipo di postback: PII </p> <p>Il tipo di postback PII consente agli utenti di inviare dei dati con tag delle chiamate CollectPII agli endpoint di terze parti.<sup></sup> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Messaggi push </p> </td> 
   <td colname="col2"> <p> La gestione della scadenza dei certificati push consente di visualizzare la data di scadenza dei certificati push e ricevere anche promemoria per aggiornare il certificato prima della scadenza. Per ulteriori informazioni, consulta <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_troubleshooting-push-messaging.html" format="html" scope="external">Risoluzione dei problemi relativi ai messaggi push </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Reporting di Analytics </p> </td> 
   <td colname="col2"> <p> Le autorizzazioni Dimension e metrica impostate in  Adobe Analytics ora si applicano a Mobile Services. Per ulteriori informazioni, consulta <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">Modifiche amministrative del prodotto previste per ottobre 2016 </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Per modificare le impostazioni in Mobile Services, in precedenza era necessario aggiungere gli utenti a un gruppo denominato Amministratori app mobili in  Adobe Analytics. Questo è stato modificato e gli utenti ora devono solo appartenere a un gruppo per il quale è stato selezionato Amministratori app mobili nella sezione Strumenti delle impostazioni del gruppo. A causa di questa modifica, tutti gli amministratori di Analytics ora sono amministratori di app mobili. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<!-- <draft-comment> 
  ...
  <tr> 
   <td colname="col1"> <p>SiteCatalyst 14, ExcelClient e così via fine della vita a ottobre 2016 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Il nuovo sistema di avvisi globale di Adobe Analytics, Avvisi intelligenti, consente di creare e gestire gli avvisi in <span class="wintitle">Analysis Workspace</span>, anche con l'ausilio di anteprime e regole. È possibile </p> 
    <ul id="ul_C07279562C9D4D84B9B47442B3D1FF72"> 
     <li id="li_214A13AA62B948A3A1628BC076816D50">Creare avvisi basati su anomalie (soglie del 90%, 95% o 99%; % di variazione; sopra/sotto). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Consentono di verificare se le modifiche dei dati con tendenze sono significative e di conoscerne le cause. </p> <p>Rilevamento delle anomalie e Analisi del contributo sono adesso flussi di lavoro principali in <span class="wintitle">Analysis Workspace </span>. È possibile rilevare automaticamente le anomalie statisticamente significative dei dati, quindi eseguire Analisi del contributo per le anomalie giornaliere e integrarle nel progetto di <span class="wintitle">Analysis Workspace</span>. </p> <p> <b> Disponibilità - Aggiornato il 21/10</b> </p> 
    <ul id="ul_66A3F13AD76D41BAB27BD41C57DC9723"> 
     <li id="li_B4CD4781E4274FE3AF2B530147AB0BBC">Clienti Analytics Premium: 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">È stato risolto un problema con l'utilizzo di "Try In Workspace" (Prova in area di lavoro) nel report Metriche chiave, con metriche calcolate. (AN-130945) </li> 
      <li id="li_3D924E85C1FE43C98D348CF87FEB8E08">È stato risolto un problema di localizzazione del calendario per la lingua giapponese. (AN-131745) </li> 
      <li id="li_FE87E48E9B2247F19DD00F2F9FBA400C">È stato risolto un problema che impediva agli utenti di accedere  Analysis Workspace anche se l'utente disponeva dei diritti di accesso. (AN-131515) </li> 
      <li id="li_34F3B016376A4431B79EEEB31B263A34">È stato risolto un problema di visualizzazione nei grafici ad anello e a barre. (AN-104491) </li> 
      <li id="li_092222C7A3DE4751ADD723B5AD32BEEE">È stato risolto un problema di visualizzazione del calendario. (AN-115527) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* [!DNL  Adobe Social] ora supporta il nuovo calcolo del numero di caratteri di Twitter, che permette di includere più caratteri nei tweet. For more information, see the [Twitter blog](https://blog.twitter.com/express-even-more-in-140-characters).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>I target degli annunci creati negli editor di Facebook utilizzando target flessibili sono visibili come di sola lettura in  Advertising Cloud. </p> </td> 
  </tr> 
  <tr> 
