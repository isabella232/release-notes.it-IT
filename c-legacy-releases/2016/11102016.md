...
<table id="table_E9C662271DD94D84818FA962CADFC822"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Aggiornamento di Profilo e password </p> </td> 
...
* È stato risolto un problema relativo alle password tecniche che causava un errore nella condivisione delle cartelle tra Creative Cloud e Marketing Cloud. (MAC-31067, MAC-32014)
...
See [Marketing Cloud Product Documentation](https://docs.adobe.com/content/help/it-IT/core-services/interface/about-core-services/core-services-landing.html) for product help.
...
>* Utilizzando la libreria 2.0.0+ del servizio ID di Marketing Cloud, la sincronizzazione degli ID verrà avviata per Adobe Advertising Cloud per impostazione predefinita. Consulta [Informazioni sulla sincronizzazione degli ID e delle percentuali di corrispondenza](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-match-rates.html).
...
* È stata aggiunta la marca temporale ` TS = *` UTC`*` come proprietà della funzione ` visitor.appendVisitorIDsTo`. Il servizio ID utilizza la marca temporale per determinare se devono essere utilizzati gli ID nell&#39;URL di reindirizzamento in base a un intervallo di durata di 5 minuti. Consultare la sezione relativa alla [funzione di aggiunta dell’ID del visitatore](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-appendvisitorid.html) (MCID-219)
...
Consultate la documentazione di prodotto del [Servizio Marketing Cloud ID](https://docs.adobe.com/content/help/it-IT/id-service/using/home.html).
...
<table id="table_3D79042552CA4F608A57688E642C7841"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Collegamenti universali e collegamenti app </p> </td> 
   <td colname="col2"> <p> A partire da iOS 9.2, i collegamenti profondi non sono più supportati. I collegamenti universali (iOS) e i collegamenti app (Android) sono il nuovo metodo di deep linking nell’app o nel sito Web. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le seguenti funzioni sono state aggiunte a <span class="wintitle">Segment Builder </span>: </p> 
    <ul id="ul_721555FA02DA43C28DA4B600F321298F"> 
     <li id="li_06711B764EAE490A914EA03C6BFECB76"> <b>Intervalli di date nei segmenti</b>. È possibile creare segmenti che contengono intervalli di date dinamici per rispondere a domande su campagne o eventi in corso. Ad esempio, ora puoi creare facilmente un segmento che include "tutti coloro che hanno effettuato un acquisto negli ultimi 60 giorni". <a href="https://marketing.adobe.com/resources/help/en_US/analytics/segment/date-ranges.html" format="https" scope="external"> Altro... </a></li> 
     ...
     <li id="li_D71A7FA16C0F4031830EEA42916A78FB"> <b>Vincoli dimensionali nei segmenti sequenziali (aggiunti in ottobre)</b>. In una clausola “within” (entro), tra istruzioni THEN, è possibile aggiungere, ad esempio, “within 1 search keyword instance”, “within 1 eVar 47 instance”. Questo vincola il segmento all’interno di un’istanza di una dimensione. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/segment/sequence-filters.html" format="https" scope="external"> Altro... </a></li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_F413249D8B4B48F79D6EBA73D4C9E7F5">Sono stati corretti alcuni problemi relativi alle autorizzazioni introdotti con il rilascio di ottobre. (AN-133298, AN-133399, AN-132985, AN-133124, AN-133217, AN-133122) </li> 
      <li id="li_6B1B0D2C4A0C4156AE964CC4D27C2027">Sono stati corretti alcuni problemi relativi agli avvisi introdotti con il rilascio di ottobre. (AN-132996, AN-133307, AN-133268, AN-133247, AN-133407) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      ...
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Sono stati risolti dei problemi relativi alle visualizzazioni di testo che impedivano il salvataggio e determinavano la creazione di progetti vuoti. (AN-133355) </li> 
      <li id="li_8E6EB700F40C4D26BBC2E8D9B937F5AC">È stato corretto un problema a causa del quale le impostazioni a doppio asse non venivano salvate o caricate correttamente. (AN-133315, AN-133177, AN-133096) </li> 
      <li id="li_9CD496E14AC649B1BA30B339CB19422C">È stato risolto un problema che impediva il salvataggio dei segmenti all'interno di funzioni (nelle metriche calcolate). (AN-133305) </li> 
      <li id="li_C709CA5D5DB241BB9FA32BED72B04D0F">È stato risolto un problema che impediva il download di file PDF. (AN-133289, AN-133120) </li> 
      <li id="li_2851CA5E366F42A680CAD9482ADB93DA">È stato risolto un problema che impediva la modifica dei segmenti da parte di utenti non amministratori. (AN-133269) </li> 
      <li id="li_9D8A1EFAFF8D490F8F15CD50DDAA5DFB">È stato risolto un problema relativo al widget del calendario. Ora, quando si apre il widget Calendario, il primo clic (a destra/all'inizio o a sinistra/alla fine del calendario) indica la data iniziale dell'intervallo.(AN-133263) </li> 
      <li id="li_194C1A0009984F13866AEA3D2CC16425">È stato risolto un problema che causava il blocco della funzione di confronto dei segmenti. (AN-133222) </li> 
      ...
      <li id="li_C976AF0B62814BC19FCAC8C25E75E407">È stato risolto un problema che causava la reimpostazione di tutte le suddivisioni nella soluzione/sezione pagine. I clienti dovevano aggiungere nuovamente tutte le suddivisioni. (AN-133177) </li> 
      <li id="li_D6660DB6252C4228A3340C6868C7D5E4">È stato risolto un problema che impediva al grafico a barre orizzontale di regolarne le dimensioni in base al numero di righe selezionate. Le barre orizzontali ora hanno un'altezza minima ed è stata aggiunta una barra di scorrimento verticale per adattarle a determinate situazioni. (AN-132939, AN-133177) </li> 
      ...
      <li id="li_ADA65FD51F3C4BBEAE51F2EA8E13E32C">È stato risolto un problema che impediva la copia dei progetti. (AN-133309) </li> 
      <li id="li_5ACED6D10B984854AAD7783B5CF7B811">È stato risolto un problema che impediva ad alcuni progetti di caricarsi correttamente. (AN-133282) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6"> Data Warehouse è stato aggiornato per rispettare le regole di Reports &amp; Analytics utilizzate per determinare quando deve essere utilizzato "Altro" come nome della pagina nei report. Ciò si verifica principalmente quando il nome della pagina è vuoto. (AN-131951) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A5FC169793F4266922D1352CF0428AE"> 
      <li id="li_D46A0F2C1481431BA3E8E076BA1C9FE0">È stato corretto un errore che si verificava durante l'attivazione di un set di regole di classificazione. (AN-130658) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_28C660B50A4A4E67932EBF1CE1C0E2BA"> 
     <li id="li_0646F779E65B4EB4A3EC59BE26FA0959">Aggiunta verifica del nome host SSL. (AN-130350) </li> 
     <li id="li_F9306731A69F48688BD3EE8164EAF8BE">Rimosso il supporto per Java 1.4. È supportato solo 1,5+. </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le nuove funzioni includono un'interfaccia utente riprogettata, miglioramenti dei report che includono percentuali di corrispondenza a livello di segmento e opzioni di look-back aggiuntive per i report. Consulta <a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html" format="https" scope="external"> Tipi di pubblico utilizzabili </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Nuova opzione di definizione ID per tutte le origini dati multi-dispositivo: gli ID in un&#39;origine dati multi-dispositivo ora possono essere definiti come &quot;Persona&quot; o &quot;Famiglia&quot;. Questa definizione indica la relazione dell’ID multi-dispositivo con l’ID Audience Manager . L&#39;opzione predefinita per tutte le origini dati multi-dispositivo è Persona. Consulta il documento [Creazione di origini](https://docs.adobe.com/content/help/it-IT/audience-manager/user-guide/features/data-sources/manage-datasources.html#create-data-source) dati. (AAM-25988)
...
<table id="table_9D23A6C03A0C45B5AD4D545B703723AA"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>I filtri delle regole di ascolto Twitter vengono migrati ai nuovi filtri. Queste migrazioni saranno automatiche e potrebbero influenzare i risultati. Non sono necessari adeguamenti. </p> <p>Gli operatori dei seguenti filtri subiranno delle modifiche: la biografia contiene, il nome della biografia contiene, il codice del paese, la lingua, l'URL contiene. </p> <p> I seguenti filtri verranno ritirati: lingua bio, la posizione della biografia contiene, contiene, il posto contiene. Per le regole che includono questi filtri, continueranno a esistere ma non estrarranno più dati. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A86BCBB810894CDEB2A807F2A19F73D2"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> Include funzioni chiave come le esperienze di navigazione dei contenuti avanzati (banner dinamici) e le notifiche push di Android. Include inoltre il supporto completo per l'interfaccia utente Coral 3. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/it-IT/dynamic-media-developer-resources/release-notes/s7rn2017.html" format="https" scope="external">Rilascio di Scene7 - Autunno.</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>È stato abilitato il supporto per i clienti a effettuare le seguenti operazioni: </p> <p> 
     <ul id="ul_B38451AECBC0406BA724969365464ED1"> 
      ...
      <li id="li_1B766FA9071648098C2541B96A3F3627">Cura i contenuti tramite feed RSS con formati variabili per supportare un elenco esteso di origini, quali YouKu, Pinterest, Vimeo e così via. </li> 
      <li id="li_E42F347B56204C7CBE93C3E98BAB066A">Configurare il livello di nidificazione e il numero di risposte da caricare nei commenti per migliorare l'esperienza dell'utente. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col2"> <p>IMMERSE </p> </td> 
   <td colname="col3"> <p>IMMERSE è una conferenza virtuale globale per sviluppatori di AEM. </p> <p>La nostra conferenza inaugurale si è tenuta lo scorso aprile. È stato così accolto che  Adobe Systems ha deciso di rendere questo evento annuale con più contenuti. L’evento comprende un’area espositiva, discussioni tematiche di tipo round table e sale dedicate al networking. IMMERSE17 si terrà dal 15 al 19 maggio 2017. Puoi partecipare comodamente dall’ufficio o da casa, a seconda di dove ti trovi. <a href="https://docs.adobe.com/dev/products/aem/events/0416.html" format="https" scope="external"> Per saperne di più </a>. </p> <p>Condividi le tue esperienze con la community. La Call for Presentations di IMMERSE è aperta. Consulta i requisiti e sottoponete la tua sessione <a href="https://goo.gl/forms/a9HOKLkfB6SwS7KR2" format="https" scope="external">qui </a>. I relatori possono usufruire di un pass gratuito e dell'accesso a tutte le 75 sessioni. </p> <p>Sei un membro attivo della community degli sviluppatori AEM? La tua azienda vuole essere vista come una sostenitrice importante della community? Consulta il nostro prospetto sulle sponsorizzazioni <a href="https://files.acrobat.com/a/preview/a2b82990-996a-47a2-aeed-909189ecb159" format="https" scope="external">IMMERSE17 Sponsorship</a> per diventare parte attiva di questa community dinamica. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Chiedi agli esperti della community AEM </p> </td> 
   <td colname="col3"> <p>La sessione di novembre è intitolata "Best practice per utilizzare  Experience Manager e  Adobe Campaign". </p> <p> Adobe Tecnico Trainer per  Adobe Worldwide Field Enablement, Abhishek Dwevedi fornisce istruzioni sull'uso di Adobe Experience Manager e  Adobe Campaign insieme. </p> <p> 29 novembre 2016 08:00-09:00 (ora standard del Pacifico). </p> <p> <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_6.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external"> Le informazioni sulla sessione sono disponibili qui </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM GEMS </p> </td> 
   <td colname="col3"> <p> 
     <ul id="ul_B48A3A49928549FBAB09F57DF4E163AD"> 
      <li id="li_00999D77C173495EB80C53843DE390DC"> <p>"Introduzione a AEM Screens" </p> <p> AEM Screens è la nuova soluzione di digital signage integrata in Adobe Experience Manager. In questa sessione AEM Gems presenteremo le caratteristiche principali di  AEM Screens e come impostare un progetto semplice con una presentazione e un'esperienza interattiva. Forniamo quindi una panoramica su come sviluppare  componenti ottimizzati per AEM Screens e come impostare i canali per l’utilizzo offline. Infine, esploreremo  AEM Screens REST API e spiegheremo come integrare i plug-in Cordova personalizzati. </p> <p>Potete partecipare alle due sessioni seguenti: </p> <p> 
      ...
      <li id="li_208C9492C62740FC9331891C0BC6F115"> <p>"Dal testing di unità al test di integrazione di un'applicazione di Experience Manager " </p> <p>Un ciclo di testing automatizzato è indispensabile per lo sviluppo di qualsiasi applicazione. Questa presentazione AEM GEMS vi guida attraverso i vari strumenti che potete utilizzare per testare il codice Java, iniziando con le nozioni di base del testing di unità fino al testing funzionale e di integrazione. Scoprite come aggiungere i test nel modo più efficace alla base di codice, indipendentemente dal fatto che dobbiate testare un semplice metodo di utilità, un servizio OSGi o un endpoint HTTP. </p> <p>14 dicembre 2016, 08:00-09:00 (ora standard del Pacifico). Join Carsten Ziegeler (Project Lead, Software Development) e Robert Munteanu (Senior Developer) condurranno questa sessione dal vivo. <a href="https://communities.adobe.com/en/communities/aem_technologistsdevelopersarchitects/events.html" format="https" scope="external"> Rispondete qui per partecipare a questa sessione </a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> 
    <ul id="ul_D2101E2880894DCEBB2C396B96062B58"> 
     <li id="li_010CC4B9077E42EB8B830EAA5C79EF9D"> <p>"Best practice per  Experience Manager e  AEM Assets" </p> <p> Adobe Technical Trainer per  Adobe Worldwide Field Enablement, Abhishek Dwevedi, parla dell'utilizzo  AEM Assets. Guardate questa sessione preregistrata per apprendere le procedure ottimali per l’utilizzo delle risorse in  Experience Manager. </p> <p> <a href="https://bit.ly/ATACE92016" format="http" scope="external"> Riproduci la versione Adobe Connect </a>. </p> <p> <a href="https://bit.ly/ATACE92016MP4" format="http" scope="external"> Riproduci la versione MP4 </a>. </p> </li> 
     <li id="li_349F5DBF90754DCF93B6D3C251B32C73"> <p>"Configurazione di DAM per Enterprise" </p> <p>Questa sessione è stata progettata per aiutarvi a migliorare il successo nell'utilizzo  AEM Assets. La sessione si concentra sui casi di utilizzo di clienti DAM Enterprise reali, sulle loro problematiche e sulle soluzioni create per supportarli e per aumentare il successo che vedono con DAM. </p> <p>Gli argomenti trattati durante la sessione includono: </p> <p> 
       <ul id="ul_515B26FA4B1A4354967DEC9D34886B37"> 
        <li id="li_E44DFFBFE2D24D81BD68C741673EF868"> <p>Problematiche aziendali dei clienti Enterprise come l'assimilazione su larga scala, l'app desktop, l'ottimizzazione delle prestazioni e il dimensionamento. </p> </li> 
        <li id="li_903E529927A148B4B59F0F34E6BAB1A3"> <p>Informazioni sui miglioramenti delle funzionalità che supportano il cliente Enterprise, i casi di utilizzo del cliente allineati alle sfide aziendali e la roadmap del prodotto. </p> </li> 
       </ul> </p> <p>Visualizzando questa sessione potrai capire meglio come utilizzare DAM nei tuoi ambienti. Attraverso la ricerca di case study da clienti reali e dai partecipanti che lavorano con un DAM esistente, comprenderete in che modo le nuove soluzioni offerte da questa offerta possono aiutare i vostri flussi di lavoro esistenti e la comprensione della tecnologia. </p> <p> <a href="https://bit.ly/GEMS10616" format="http" scope="external"> Riproduci la versione Adobe Connect </a>. </p> <p> <a href="https://bit.ly/GEMS10416MP4" format="http" scope="external"> Riproduci la versione MP4 </a>. </p> </li> 
     <li id="li_C916481D23AD4F7A9CCF639EE69D4611"> <p>"Comparative architecture analysis of large scale  Experience Manager installazioni" </p> <p>Questa sessione descrive architetture su larga scala dall'esperienza del relatore con Cisco e Symantec. Confrontano e confrontano l'architettura tra il ridimensionamento dell'architettura dell'infrastruttura, le integrazioni di eCommerce e l'approccio di migrazione da legacy ad Adobe Experience Manager, integrazioni di Marketing Cloud digitali come personalizzazione, analisi e DMP. </p> <p> <a href="https://bit.ly/atace102516" format="http" scope="external"> Riproduci la versione Adobe Connect </a>. </p> <p> <a href="https://bit.ly/ATACE102516MP4" format="http" scope="external"> Riproduci la versione MP4 </a>. </p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>(Google AdWords) Sono disponibili nuove colonne di bulksheet per le inserzioni relative all’installazione di app mobili: “Mobile App Platform”, “Mobile App ID”, “Mobile App Name” e “Exclude Tablet”. </p> <p>Se l’inserzionista utilizza EF Redirect, potete aggiungere facoltativamente il codice di tracciamento agli URL dell’annuncio quando caricate o pubblicate un bulksheet. L’impostazione "Auto-upload during sync" (Caricamento automatico durante la sincronizzazione) è applicabile anche agli annunci in un portfolio. Le impostazioni di tracciamento si basano sul partner di misurazione mobile specificato per l’inserzionista. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campagne basate su ricerche - Funzione Beta </p> </td> 
   <td colname="col2"> <p>Ora puoi gestire le impostazioni per Yahoo! Japan. </p> <p>Puoi anche configurare siti Web negativi per le campagne Google AdWords e Yahoo Gemini e i gruppi di annunci Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Visualizza campagne gestite </p> </td> 
   <td colname="col2"> <p>Facebook ha dichiarato obsoleto Facebook Exchange (FBX) il 1° novembre 2016, e i tuoi annunci FBX esistenti non sono più in esecuzione. Eventuali creatività e strategie pubblicitarie FBX precedentemente create restano in pausa in  Advertising Cloud a scopo di reporting. Puoi eliminarli, ma non attivarli né modificarli, né creare nuove creatività FBX o strategie pubblicitarie. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Suddivisione in fasce orarie </p> </td> 
   <td colname="col2"> <p>Tutti gli utenti ora possono impostare l'dayparting per qualsiasi strategia di annunci. Per attivare una pianificazione è necessario attivare la funzione Daypart Scheduling (Programmazione fasce orarie), disponibile nella sezione Targeting (Impostazione destinazione) della strategia per gli annunci. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Visualizza pubblico </p> </td> 
   <td colname="col2"> <p>Per ciascun elenco di segmenti, ora puoi vedere il pubblico di destinazione totale (dimensione prevista del pubblico) per ciascun segmento, oltre al numero di visitatori unici per specifici incrementi di tempo. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È ora possibile accedere al forum  Advertising Cloud Community da ? &amp;Community nella parte superiore di qualsiasi pagina. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> La versione Autunno 2016 di  Adobe Analytics include diversi aggiornamenti per i gruppi e la gestione delle autorizzazioni. Consulta le informazioni seguenti. </p> </td> 
   <td colname="col3"> <p>20 ottobre 2016 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/it_IT/analytics/analysis-workspace/" format="https" scope="external"> Autunno 2016 - Novità di Analysis Workspace </a> </p> </td> 
