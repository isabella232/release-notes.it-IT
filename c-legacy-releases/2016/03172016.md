...
|--- |--- |
| Traccia arresti app | La versione SDK 4.8.6 di iOS contiene modifiche importanti che impediscono la segnalazione di falsi arresti. Si consiglia vivamente di effettuare l&#39;aggiornamento alla versione 4.8.6. |
...
Procedure di implementazione del servizio ID riviste per i clienti [!DNL  Analytics]. Consulta [Configurare il servizio Marketing Cloud ID con Analytics](https://marketing.adobe.com/resources/help/it_IT/mcvid/?f=mcvid-setup-analytics.html).
...
* [Note sulla versione v6 di Adobe Campaign ](https://marketing-stage.adobe.com/resources/help/it_IT/whatsnew/)
