---
description: Note sulla versione - Luglio 2016
keywords: note sulla versione
seo-description: Note sulla versione - Luglio 2016
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Nuovo requisito di autorizzazione per Gestione impostazioni app </p> </td> 
...
Consulta [Adobe Mobile Services](https://marketing.adobe.com/resources/help/it_IT/mobile/) per la documentazione del prodotto. Per leggere le note sulle versioni precedenti, espandi *Note sulle versioni precedenti* nel riquadro a sinistra.

### Dynamic Tag Management {#dtm}

| Funzione | Descrizione |
|---|---|
| Strumento del servizio ID Marketing Cloud | L&#39;opzione per scaricare lo strumento del servizio ID Marketing Cloud in DTM nella parte superiore della pagina è ora attivata per impostazione predefinita. |
...
Con questa versione, la versione viene aggiornata alla versione 1.6.0 e comprende le seguenti funzioni, correzioni e altre modifiche.
...
<table id="table_0CF2AF14F0E64FA7A48C340C3D94E98F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Requisiti del codice AppMeasurement </p> </td> 
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>CORS consente ai browser di richiedere risorse da un dominio diverso da quello corrente. Il servizio <span class="keyword">Marketing Cloud ID</span> supporta gli standard CORS per consentire le richieste di risorse tra le origini lato client. Il servizio ID ripristina le richieste JSONP sui browser che non supportano CORS. (AAM-23988) </p> <p>Vedi: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Supporto CORS nel servizio Marketing Cloud ID </a> </li> 
...
* Il valore predefinito ` loadTimeout` è stato modificato da 500 a 30.000 millisecondi (30 secondi). Consultare [Variabili utilizzate dalla funzione getInstance del servizio ID](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html). (MCID-96)
* È stato aggiunto il parametro ` d_fieldgroup` alle chiamate per la sincronizzazione ID verso ` dpm.demdex.net`. Questo nuovo parametro viene utilizzato per la risoluzione interna dei problemi e per il debug. (MCID-94)
...
* È stato aggiunto ` idSyncAttachIframeASAP: true` come flag opzionale impostabile nella funzione ` Visitor.getInstance`. Quando è ` true`, il servizio ID carica l&#39;iFrame di sincronizzazione ID il più rapidamente possibile. Questa funzione è stata progettata per migliorare le percentuali di corrispondenza della sincronizzazione ID. Per impostazione predefinita il servizio ID carica l’iFrame al caricamento della finestra. (MCID-86)

**Documentazione nuova e rivista**

* Nuovo: [Implementazione del servizio Marketing Cloud ID per Analytics e Audience Manager](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-setup-aam-analytics.html)
* Aggiornato: [Test e verifica del servizio Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-test-analytics.html)

Vedere anche la documentazione del servizio [Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A ottobre 2016, gli amministratori Analytics potranno gestire utenti e configurazione del prodotto (gruppi) utilizzando l’<span class="wintitle">Enterprise Dashboard </span>. Enterprise Dashboard è l'interfaccia di amministrazione per Adobi Marketing, Creative e Document Cloud. </p> <p>Potrai: </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">Crea configurazioni di prodotto per prodotti, strumenti, prodotti, suite di rapporti (e altro). </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">Crea utenti e assegnali alle configurazioni di prodotto. </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">Delega ruoli amministrativi agli utenti per configurazioni di prodotti specifiche. </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">Applicare autorizzazioni a dimensioni e metriche specifiche. </li> 
    </ul> <p>Inoltre, l’attuale funzione Strumenti di amministrazione per la gestione degli utenti riceverà importanti miglioramenti. </p> <p> <p class="important">Importante: per ulteriori informazioni, vedere <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external"> Modifiche al prodotto di amministrazione per la fine del 2016 </a>. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> AppMeasurement per Flash - Aggiornamento della sicurezza </td> 
 ...
 <p>Adobe ha rilasciato un <a href="https://helpx.adobe.com/security/products/analytics/apsb16-13.html" format="https" scope="external"> aggiornamento sulla sicurezza APSB16-13 </a> per la libreria <span class="term"> AppMeasurement per Flash </span>. Questo aggiornamento risolve un’importante vulnerabilità nella libreria, applicabile solo quando <span class="codeph">debugTracking</span> viene abilitato e che avrebbe potuto portare a <a href="https://www.owasp.org/index.php/DOM_Based_XSS" format="https" scope="external">attacchi XSS basati su DOM </a>. </p> <p> <p class="important">Nota: questo problema riguarda <span class="term"> AppMeasurement per Flash </span> solo quando <span class="codeph"> debugTracking </span> è abilitato ( <span class="codeph"> debugTracking </span> è disabilitato nella configurazione predefinita). <b>Se interessato, consigliamo di disabilitare <span class="codeph">debugTracking</span> immediatamente.</b> Di seguito vi sono alcuni esempi di codice: </p> </p> 
  ...
  <tr> 
   <td colname="col1"> <p>Codice postale del Regno Unito </p> </td> 
   <td colname="col02"> <p>18 febbraio 2016 </p> </td> 
   <td colname="col2"> <p>Il fornitore di servizi geografici di Adobe sta modificando il nostro metodo di ricezione dei codici postali del Regno Unito. Dal 18 marzo circa, passeremo dall'invio di codici postali troncati al codice postale completo. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta un’informazione modale in <span class="uicontrol">Progetto</span> &gt; <span class="uicontrol">Informazioni sul progetto </span>. In questo pannello vengono visualizzate le seguenti informazioni sul progetto: 
     ...
     <ul id="ul_AC21E32F5F6E4B2480455AE681F56BAB"> 
      <li id="li_F88988131A834E6BAC006ADD20E4EFB4">Nome del progetto </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>I nuovi clienti che effettuano l’accesso in <span class="keyword"> Analytics </span> attraverso <span class="keyword"> Marketing Cloud </span> possono implementare velocemente <span class="keyword"> Analytics </span> tramite la modalità <span class="term"> Guida introduttiva ad Adobe Analytics </span>, e quindi distribuire Analytics utilizzando Dynamic Tag Management. </p> <p>Questa implementazione semplificata è ospitata da Dynamic Tag Management e permette di: </p> 
    <ul id="ul_2479AF2B543E4C2A995A83216A4B4ABE"> 
     ...
     <li id="li_E83C3BE4A3ED45C9A9D727319AE56157">Eseguire report sui dati di base a livello di pagina. </li> 
     <li id="li_0BF98AA4DF7A4713A9E04583E98E5B6C">Distribuisci Analytics e il servizio ID Marketing Cloud. </li> 
...
Correzioni e miglioramenti sono stati applicati ai seguenti prodotti e servizi:
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">Amministratore: È stato risolto un problema che impediva il tracciamento delle attività per gli utenti che effettuavano l’accesso tramite il Marketing Cloud utilizzando il proprio Adobe ID. Questa correzione replica il tracciamento delle attività per gli utenti che effettuano l’accesso in modo tradizionale tramite nome società, nome utente e password. (AN-124792) </li> 
      <li id="li_0BDA039583054473BC3190E0AF57D03D">È stato risolto un problema che impediva l'applicazione delle metriche calcolate condivise agli utenti non amministratori. (AN-125412) </li> 
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">È stato risolto un problema raro che causava l’invio di rapporti, anche se il rapporto non era pianificato per la distribuzione. (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">È stato risolto un problema di accesso che si verificava per gli utenti il cui accesso predefinito del prodotto era SearchCenter (AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      <li id="li_602B55D4F7DF4D0C8B240C0B43679808"> Nei progetti pianificati ora viene utilizzato il fuso orario della suite di rapporti anziché quello del browser. (AN-126233) </li> 
      ...
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> È stato corretto un errore che si verificava durante il download di progetti PDF in anteprima nel browser Chrome. (AN-123674) </li> 
      <li id="li_4584537608434E7CBCBCC18EA8F01B59">È stato risolto un problema che impediva il posizionamento e il ridimensionamento dei componenti (in rare situazioni). (AN-126175) </li> 
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">È stato risolto un problema di definizione del segmento che si verificava quando si aggiungeva un segmento Browser e si modificava il Tipo di browser nella tabella. (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">È stato risolto un problema nella pianificazione settimanale dei progetti a causa del quale il giorno della settimana non veniva visualizzato correttamente nell’interfaccia di . (AN-125760) </li> 
      ...
      <li id="li_D8E69F309E144BCB999B19B59AE502A4">È stato risolto un problema casuale che impediva la visualizzazione delle dashboard di progetto dopo l’accesso. (AN-124635) </li> 
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">È stato risolto un problema di ordinamento nella tabella per i progetti che utilizzano più metriche e segmenti. (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">Metriche di sovrapposizione non supportate rimosse da Activity Map (Nuovi visitatori e Nuovi clienti). (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> La modalità Live di Activity Map ora riporta tutti i collegamenti presenti nella pagina web. (AN-116094) </li> 
      <li id="li_7044F2E995024A48873E6209146C1678">È stato risolto un problema che impediva la visualizzazione delle metriche calcolate dopo il ricaricamento della pagina. (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p> È stato migliorato il supporto per la pianificazione delle cartelle di lavoro inizialmente aperte dall'interfaccia Web di Excel tramite Office 365. (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse  </td> 
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> È stato aggiunto il supporto per i segmenti per le visualizzazioni di pagina in Data Warehouse (AN-125067). </li> 
      <li id="li_59787469534B455686696BA9E095D388"> È stato risolto un problema di logica di segmento nelle regole in cui è presente un valore hash "0" nella tabella di ricerca della classificazione (AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">È stata aggiunta la possibilità di inviare rapporti vuoti invece di rispondere con "nessun dato". (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">Le nuove liste di distribuzione e-mail create dopo le modifiche alla suite di rapporti virtuali dell’interfaccia ora funzionano in Data Warehouse. (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">La suddivisione ora fornisce i tipi MIME corretti nelle e-mail prodotte (AN-124243) </li> 
      <li id="li_93364B7D632E49C5AE6C222BCBE5EC1F">È stato risolto un problema che impediva la visualizzazione dei nomi delle metriche di partecipazione. (AN-117260) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">È stato risolto un problema che causava la chiamata del metodo offuscato errato in API Visitor da parte di AppMeasurement. (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">È stato risolto un problema che causava l’errore JavaScript: "Attributo valido solo su v:image". (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Report degli errori di esempio </p> </td> 
   <td colname="col2"> <p>Il <span class="wintitle">Sample Error Report</span> (Report errori campione) verifica i tassi d’errore e di successo nell’elaborazione dei record nei propri file di origine dei dati in ingresso. Il reporting degli errori visualizza i dati in un grafico a barre interattivo e fornisce metriche di riepilogo sotto forma di tabella. Inoltre, include un'opzione che campiona i file per un intervallo di tempo fisso e visualizza gli errori più comuni per ogni tipo di errore. </p> <p>La documentazione sarà disponibile quando la funzione verrà rilasciata alla fine di luglio. </p> </td> 
  </tr> 
  <tr> 
...
* Google Bid Manager aggiornato da v201601 a v201603. (AAM-24618)
* È stato corretto un bug a causa del quale il rapporto sulle regole di unione profili mostrava 0. (AAM-24685)
* È stato corretto un bug a causa del quale i clienti non potevano modificare o eliminare i gruppi di utenti a causa di un errore di chiave univoca nella tabella di controllo. (AAM-24864)
* È stato corretto un bug a causa del quale non veniva applicato alcun limite alle destinazioni S2S e Bulk S2S. (AAM-24905)
* È stato modificato lo stile della riga che divide l’accesso legacy da quello al Marketing Cloud. (AAM-24378)
* È stato corretto un bug a causa del quale venivano visualizzati messaggi di errore errati dopo l’eliminazione di utenti, gruppi o origini dati. (AAM-24638)
...
Per le informazioni di supporto più recenti su Primetime, vedere la [pagina principale della guida di Primetime](https://helpx.adobe.com/it/support/primetime.html).
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>“Gems on AEM” è una serie di approfondimenti tecnici offerti dagli esperti Adobe. Questa serie completa la documentazione del prodotto e i canali tecnici. Consente inoltre agli sviluppatori di entrare in contatto ed esplorare in dettaglio un argomento specifico. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Versioni con correzione rapida AEM </p> </th> 
   <th colname="col2" class="entry"> <p>Descrizione </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates.html?lang=it" format="https" scope="external"> Hotfix per AEM 6.2 </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/it/experience-manager/kb/aem61-available-hotfixes.html" format="https" scope="external"> Hotfix per AEM 6.1 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le nuove funzioni includono: 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>Supporto delle espressioni regolari (regex) per filtri e regole della cache. </p></li> 
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">Supporto della connessione HTTP persistente (nota anche come connessione HTTP keep-alive) su tutte le piattaforme. </li> 
...
La tabella seguente contiene una serie di collegamenti relativi ad argomenti consigliati. Questi argomenti possono aiutarti a trarre il massimo dall’implementazione e dall’utilizzo di AEM.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM include l’interfaccia classica e quella ottimizzata per il tocco. L'argomento "User Interface Recommendations for Customers" (Raccomandazioni per i clienti in merito all'interfaccia utente) può essere utile per stabilire quale interfaccia utente meglio si adatta alle vostre esigenze. Queste informazioni sono utili durante l’implementazione del progetto o quando esegui l’aggiornamento da una versione precedente. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Informazioni su quando creare indici e quando non sono necessari. Sono inoltre inclusi suggerimenti per evitare l’utilizzo di query quando non sono necessari e suggerimenti per l’ottimizzazione delle prestazioni di indici e query. </p> </td> 
  </tr> 
  <tr> 
...
L’Aiuto di Advertising Cloud è disponibile nel prodotto all’indirizzo **[!UICONTROL ? > Sommario]**.
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager 6.2 è una versione aggiornata della base codice di Adobe Experience Manager 6.1. Offre funzioni nuove e migliorate, correzioni per clienti chiave, miglioramenti per clienti con priorità elevata e correzioni di bug orientati alla stabilizzazione del prodotto. Include inoltre le versioni con feature pack, hotfix e service pack di Adobe Experience Manager 6.1. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Una raccolta degli argomenti di integrazione disponibili. </p> </td> 
   <td colname="col3"> <p>15 maggio 2016 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta una tabella di confronto dei prodotti per i prodotti Analytics. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta la documentazione relativa alle nuove funzioni di Analysis Workspace. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiornata la documentazione del prodotto Analysis Workspace con descrizioni delle funzioni, attività per la creazione di progetti, video e casi d’uso. </p> </td> 
   <td colname="col3"> <p>17 settembre 2015 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Aggiunta la documentazione di prodotto e le buone prassi per Marca temporale opzionale. Questa funzione ti consente di integrare sia dati con marca temporale che dati senza marca temporale in una suite di rapporti. Tutte le nuove suite di rapporti saranno Marca temporale opzionale per impostazione predefinita. </p> </td> 
   <td colname="col3"> <p>17 settembre 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Collegamento profilo funziona tra più dispositivi e consente di identificare e raccogliere caratteristiche dei visitatori del sito autenticati. Include la funzione Regole unione profili, che consente di segmentare e individuare in maniera precisa gli utenti tra più dispositivi. </p> </td> 
   <td colname="col3"> <p>20 agosto 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Crea tabelle di dati e metriche drag-and-drop, dimensioni, segmenti e visualizzazioni multiple per un pannello di progetto. </p> </td> 
   <td colname="col3"> <p>18 giugno 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata rivista la documentazione del prodotto Adobe Mobile . </p> </td> 
   <td colname="col3"> <p>22 maggio 2015 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Un elenco di alto livello delle operazioni da eseguire per modernizzare le implementazioni delle soluzioni per i servizi di base. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se acquisisci dati del cliente di livello Enterprise in un database CRM (Customer Relationship Management), puoi caricarli nel Marketing Cloud. </p> </td> 
   <td colname="col3"> <p>19 marzo 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="uicontrol"> Strumenti di amministrazione </span> &gt; <span class="uicontrol"> Generatore regole di classificazione </span> &gt; <span class="term"> &lt;nome set di regole&gt; </span>, due nuove opzioni consentono di selezionare una modalità di sovrascrittura: </p> 
    ...
    </ul> <p>In precedenza, se una chiave era già stata classificata in una colonna o in una cella, la regola non veniva eseguita su tale chiave e la riga nella tabella veniva ignorata. </p> </td> 
