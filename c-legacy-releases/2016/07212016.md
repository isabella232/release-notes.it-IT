...
Consulta [Adobe Mobile Services](https://marketing.adobe.com/resources/help/it_IT/mobile/) per la documentazione di prodotto. Per leggere le note sulle versioni precedenti, espandi *Note sulle versioni precedenti* nel riquadro a sinistra.

### Dynamic Tag Management {#dtm}

| Funzione | Descrizione |
|---|---|
| Strumento del servizio ID Marketing Cloud | Per impostazione predefinita, l’opzione per il caricamento dello strumento del servizio ID Marketing Cloud in Gestione dinamica dei tag nella parte superiore della pagina è ora abilitata. |
...
Con questa versione la versione viene incrementata a 1.6.0. Include le seguenti funzioni, correzioni di bug e altre modifiche.
...
Vedere anche la documentazione del servizio [Marketing Cloud ID](https://docs.adobe.com/content/help/it-IT/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A ottobre 2016, gli amministratori Analytics potranno gestire utenti e configurazione del prodotto (gruppi) utilizzando l’<span class="wintitle">Enterprise Dashboard </span>. Enterprise Dashboard è l'interfaccia di amministrazione per  Adobe  Marketing, Creative e Document Cloud. </p> <p>Potrete: </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">Crea configurazioni di prodotto per prodotti, strumenti, prodotti, suite di rapporti (e altro ancora). </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">Crea utenti e assegnali alle configurazioni di prodotto. </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">Delega di ruoli amministrativi agli utenti per configurazioni di prodotti specifiche. </li> 
...
Sono stati risolti e apportati miglioramenti ai seguenti prodotti e servizi:
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">Amministratore: È stato risolto un problema che impediva il tracciamento dell'attività per gli utenti che accedono tramite il Marketing Cloud utilizzando il proprio Adobe ID . Questa correzione replica il tracciamento dell'attività per gli utenti che accedono tradizionalmente tramite nome società, nome utente e password. (AN-124792) </li> 
      ...
      <li id="li_D1237FEB03554D7793CCF09148F32530">È stato risolto un problema di accesso che si verificava per gli utenti il cui accesso predefinito al prodotto era SearchCenter (AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      ...
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> È stato corretto un errore che si verificava durante il download di progetti PDF durante la visualizzazione in anteprima dei progetti nel browser Chrome. (AN-123674) </li> 
      ...
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">È stato risolto un problema di definizione del segmento che si verificava quando si aggiungeva un segmento del browser e si modificava il tipo di browser nella tabella. (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">È stato risolto un problema nella programmazione settimanale dei progetti che causava la visualizzazione errata del giorno della settimana nell'interfaccia. (AN-125760) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">Metriche di sovrapposizione non supportate rimosse dai Activity Map  (New Visitors and New Customers). (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A">  modalità Live Activity Map ora crea rapporti su tutti i collegamenti presenti nella pagina Web. (AN-116094) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> È stato migliorato il supporto per la pianificazione di cartelle di lavoro inizialmente aperte dall'interfaccia Web di Excel tramite Office 365. (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse  </td> 
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> Aggiungete il supporto per i segmenti per le visualizzazioni di pagina in Data Warehouse (AN-125067). </li> 
      <li id="li_59787469534B455686696BA9E095D388"> È stato risolto un problema di logica del segmento nelle regole in cui è presente un valore hash "0" nella tabella di ricerca classificazione (AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">Aggiunta la possibilità di inviare report vuoti invece di rispondere con "nessun dato". (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">I nuovi elenchi di distribuzione e-mail creati dopo le modifiche apportate alla suite di rapporti virtuali nell'interfaccia ora funzionano in Data Warehouse. (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">La suddivisione ora fornisce tipi MIME corretti nelle e-mail che produce (AN-124243) </li> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">È stato risolto un problema che causava la chiamata da parte di AppMeasurement del metodo offuscato errato nell’API del visitatore. (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">È stato risolto un problema che causava l'errore JavaScript: "Attributo valido solo in v:image". (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Report errori di esempio </p> </td> 
   <td colname="col2"> <p>Il <span class="wintitle">Sample Error Report</span> (Report errori campione) verifica i tassi d’errore e di successo nell’elaborazione dei record nei propri file di origine dei dati in ingresso. La segnalazione degli errori visualizza i dati in un grafico a barre interattivo e fornisce metriche di riepilogo sotto forma di tabella. Inoltre, include un'opzione che campiona i file per un intervallo di tempo fisso e visualizza gli errori più comuni per ogni tipo di errore. </p> <p>La documentazione sarà disponibile al rilascio della funzione alla fine di luglio. </p> </td> 
  </tr> 
  <tr> 
...
* È stato corretto un bug a causa del quale il rapporto sulle regole di Profile Merge (Unione profili) mostrava 0. (AAM-24685)
...
* È stato modificato lo stile della riga che divide il login legacy con il Marketing Cloud. (AAM-24378)
* È stato corretto un bug a causa del quale venivano visualizzati messaggi di errore non corretti dopo l’eliminazione di utenti, gruppi o origini dati. (AAM-24638)
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le nuove funzioni includono: 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      ...
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">Supporto della connessione HTTP permanente (nota anche come connessione HTTP keep-alive) su tutte le piattaforme. </li> 
