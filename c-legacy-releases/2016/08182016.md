...
I clienti che usano [!DNL  Audience Manager] il codice DIL e visitorapi. js nella stessa pagina devono impostare la variabile ` secureDataCollection= false`DIL. Consulta [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html).
...
<!-- <draft-comment> 
    ...
    <!--<p> <b>JavaScript H code (Legacy)</b> </p>--> <p> <b>AppMeasurement per la libreria Flash</b> </p> <p>Flash versione 4.0.2 </p> 
...
* Sono state aggiunte nuove funzioni per rapporti per [!UICONTROL tipi di pubblico ammessi]. (AAM-24411)
...
* DIL effettua ora chiamate HTTPS sicure per impostazione predefinita. I clienti che usano [!DNL  Audience Manager] il codice DIL e visitorapi. js nella stessa pagina devono impostare la variabile ` secureDataCollection= false`DIL. Consulta [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html).
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le gemme su AEM sono approfondimenti tecnici offerti dagli esperti Adobe. Tali approfondimenti completano la documentazione del prodotto e i canali tecnici. Consente inoltre agli sviluppatori di restare in contatto e di approfondire un argomento specifico. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Adobe ha rilasciato degli hotfix di sicurezza per Adobe Experience Manager. Questi risolvono due problemi di convalida che avrebbero potuto essere sfruttati per attacchi di script tra siti diversi (CVE-2016-4168 e CVE-2016-4170): </p> 
    <ul id="ul_3A2AA8F2994F487A8EAC0116DFC7C077"> 
     ...
     <li id="li_7DA7E77439754D049D8B86A9A8C24492">Una vulnerabilità importante che avrebbe potuto divulgare eventi di registro di audit a utenti non autorizzati (CVE-2016-4169). Consultate <a href="https://helpx.adobe.com/security/products/experience-manager/apsb16-27.html" format="https" scope="external">https://helpx.adobe.com/it/security/products/experience-manager/apsb16-27.html </a></li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
