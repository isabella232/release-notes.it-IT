...
>[!IMPORTANT]
>
>Per impostazione predefinita, il codice v2.0 del servizio ID sincronizza automaticamente gli ID con [!DNL  Adobe Media Optimizer]. Consulta anche [Informazioni sulla sincronizzazione ID e sulle percentuali di corrispondenza](https://marketing.adobe.com/resources/help/it_IT/mcvid/mcvid-match-rates.html).
...
La guida del Servizio Marketing Cloud ID si trova [qui](https://marketing.adobe.com/resources/help/it_IT/mcvid/).
...
* [Domande frequenti sulle funzioni e funzionalità del prodotto](https://marketing.adobe.com/resources/help/en_US/aam/faq_features_functions.html) includono una nuova voce su come trovare l’[!UICONTROL ID organizzazione].
* [Domande frequenti sulla raccolta dei dati e integrazione del prodotto](https://marketing.adobe.com/resources/help/en_US/aam/faq_data_collection_integration.html) includono una nuova voce sulla white list degli indirizzi IP e FTP di [!DNL  Audience Manager].
* [Domande frequenti sulla privacy e conservazione dei dati](https://marketing.adobe.com/resources/help/en_US/aam/faq_privacy.html) includono il contenuto rivisto sulla privacy.
* [DIL traffico in Google Tag Manager (GTM)](https://marketing.adobe.com/resources/help/en_US/aam/t_dil_google_tagmanager.html) descrive come caricare il codice DIL nella sezione HTML personalizzata di un tag.
* [TraitWeight](https://marketing.adobe.com/resources/help/en_US/aam/traitweight.html) include nuove informazioni su un ulteriore passaggio nel processo di rilevamento algoritmico.
* [Tassi di errore relativi al campionamento dei dati nei rapporti di Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/report-sampling.html) includono nuove informazioni sul funzionamento del campionamento dei dati.
* [Requisiti per nome Amazon S3 e dimensione file per i File di dati in entrata](https://marketing.adobe.com/resources/help/en_US/aam/inbound-s3-filenames.html) includono nuove informazioni su come il processo di convalida reagisce a file di dati vuoti.
...
* Note sulla versione: [note sulla versione 6.2 di Adobe Experience Manager](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html).
