...
# Note sulla versione - Febbraio 2017
...
[Utilizzo di prefetch DNS con diverse soluzioni e servizi di Marketing Cloud](https://marketing.adobe.com/resources/help/it_IT/mcloud/dns-prefetch.html)
...
* È stato aggiornato il diagramma di Venn, con la spiegazione dei termini Pubblico di riferimento. Consulta la [documentazione sui tipi di pubblico utilizzabili](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html). (AAM-27559)
* È stata aggiunta una nuova macro di contenuto &lt;DPUUIDS&gt; nei file di dati in uscita. Consulta [Macro modello in uscita](https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html) e [Esempi macro in uscita](https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html). (AAM-28000)
...
Per informazioni sull’ultima versione, consulta le [note sulla versione di Primetime](https://help.adobe.com/en_US/primetime/release_notes/index.html).
...
* Pagina principale delle note sulla versione: [Note sulla versione 6.2 di Adobe Experience Manager](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html)
