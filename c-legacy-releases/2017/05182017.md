...
L’articolo [Informazioni sulla sincronizzazione degli ID e sulle percentuali di corrispondenza]( https://marketing.adobe.com/resources/help/it_IT/mcvid/mcvid-match-rates.html) contiene nuove informazioni sulla chiamata ` cm.eversttech.net` effettuata dal servizio ID a [!DNL  Adobe Media Optimizer].
