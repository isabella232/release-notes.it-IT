---
description: Note sulla versione - Aprile 2017
keywords: note sulla versione
seo-description: Note sulla versione
...
Ulteriori informazioni sull&#39;annuncio [Adobe Experience Cloud](https://www.adobe.com/it/experience-cloud.html) al Summit Adobe 2017.
...
Le ricette di esempio mostrano come implementare e distribuire flussi di lavoro e integrazioni applicabili a differenti soluzioni. Altri video e ricette di auto-aiuto saranno presto disponibili.
...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/it/marketing-cloud/how-to/use-cases.html" format="html" scope="external"> Digital Foundation </a> </p> </td> 
...
Consulta [Adobe Mobile Services](https://docs.adobe.com/content/help/it-IT/mobile-services/using/home.html) per la documentazione del prodotto. Per leggere le note sulle versioni precedenti, espandi *Note sulle versioni precedenti* nel riquadro a sinistra.
...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Metrica delle persone </p> </td> 
   <td colname="col2"> <p> In Analysis Workspace, puoi applicare la metrica Persone per identificare i visitatori attraverso i loro dispositivi. </p> <p>Ulteriori informazioni su come accedere alla metrica Persone nella documentazione di <a href="https://marketing.adobe.com/resources/help/it_IT/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Prima del 20 aprile 2017, per usare le regole di elaborazione tutti gli utenti (anche gli amministratori) dovevano superare un esame e ottenere l'autorizzazione dell'assistenza clienti Adobe. </p> <p>Ora gli amministratori dispongono delle autorizzazioni per utilizzare le regole di elaborazione <b> per impostazione predefinita</b>. L'esame non è più necessario. Gli amministratori possono inoltre concedere questi diritti a non amministratori tramite l’interfaccia Strumenti di amministrazione . <a href="https://marketing.adobe.com/resources/help/it_IT/reference/processing_rules.html" format="html" scope="external"> Altro... </a></p> </td> 
  </tr> 
 </tbody> 
</table>
...
Correzioni e piccoli aggiornamenti all’interfaccia, agli strumenti e ai componenti di Adobe Analytics (come Analysis Workspace, Reports &amp; Analytics, Report Builder e così via).
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8A8B70BF95EE4E9D895043277974ED74"> 
     ...
     <li id="li_BBB9F3D8177A4FB1B0E66FA053E02F79">È stato risolto un problema che causava un errore di sola lingua giapponese durante il tentativo di creazione di segmenti. (AN-139916) </li> 
     <li id="li_9424DBAF511C4273AC52EF4016697E3C">È stato risolto un problema a causa del quale gli avvisi venivano attivati in modo errato a causa del mancato aggiornamento dei fusi orari. (AN-134390) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     ...
     <li id="li_3067A6CC3B6544DDA2D0307E68EFC501">È stato risolto un problema che si verificava durante la suddivisione di una metrica % da una dimensione. La metrica per la dimensione associata risultava un decimale anziché una percentuale. (AN-141122) </li> 
     ...
     <li id="li_35D4F40C41414D5F82398C3CFA54EB1D">È stato risolto un problema a causa del quale le metriche calcolate in formato ora non visualizzavano le informazioni corrette. (AN-139688) </li> 
     ...
     <li id="li_7C5BD4DD52204E589364EB2BBE904814">È stato risolto un problema che causava modifiche a un'area di lavoro pianificata per l'attivazione delle e-mail da inviare ai destinatari. (AN-131167) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_22A36506B82A4404B03B00F8D9D7CE92">È stato risolto un problema che si verificava tentando di creare una nuova suite di rapporti duplicando le impostazioni da una suite di rapporti esistente. (AN-137797) </li> 
      <li id="li_2E955336BE30493E894DE94D7EE6BD6D">È stato risolto un problema a causa del quale le suite di rapporti di rollup non gestivano i segmenti. D’ora in poi, le richieste di rollup ignoreranno i segmenti. (AN-137333) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">È stato risolto un problema che impediva l’aggiornamento delle etichette delle suite di rapporti assegnate alle richieste. (AN-139276) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">È stato risolto un problema che si verificava quando, ad esempio, non venivano raccolti clic sul collegamento per un intervallo di date selezionato. Ciò causava il blocco della barra degli strumenti di Activity Map in uno stato di sospensione. (AN-140163, AN-140119, AN-136186) </li> 
      ...
      <li id="li_A4A1CD597F5A49A797C4CA4513598E4D">È stato risolto un problema a causa del quale le sovrapposizioni a bolle non venivano posizionate correttamente. (AN-131969, AN-124094) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Oltre alle regole di elaborazione esistenti, una sessione video verrà chiusa anche se: </p> <p> 
     <ul id="ul_66AFFF96E4A546F1B59A50567E1651F3"> 
      <li id="li_6A990D453B1640F8A28D3B1CA9EFC926">Non sono disponibili dati visitatore (MCID o ID visitatore). <p>Il fallback al meccanismo <span class="codeph">s_vi</span>. </p></li> 
     ...
     <ul id="ul_A50E675542D94AB3B1206ECAC3C39BC8"> 
      <li id="li_A5C2F2B605694CE6B31BF547D7E15462"> Sono stati risolti i problemi relativi ai segmenti: 
       <ul id="ul_8FA1BE67BC124B4CBE56327F16C11BA6"> 
        ...
        <li id="li_2DB5D7A7EE77439AB22DACB02FAC8038">È stato aggiunto il taglio mancante dagli operatori "NOT CONTAINS ONE/ALL OF". </li> 
       </ul></li> 
      <li id="li_94115FD800EF4DF891D0AF616CE8AD83">È stato corretto un bug nel filtro del segmento visita/visitatore nidificato (AN-116275). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement</span> per JavaScript</b> </p> <p>Versione 2.1.0 </p> 
    <ul id="ul_80BCF27E492246AD883ABD5B417004E1"> 
     ...
     <li id="li_CB1E4CAC306B473FBFC2E50B440568B1"> API visitatore 2.1.0 nuovamente inclusa. (AN-140873) </li> 
     <li id="li_6580254F13314576982878605EAAAB96"> Aggiunto parametro <span class="codeph">mcorgid</span>. (AN-139586) </li> 
     <li id="li_497C769C26394C0C8992E21269D9272E"> È stato aggiunto il parametro cp (customerPerspective). (AN-140897) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Miglioramenti a Ricerca e Filtro delle caratteristiche </p> </td> 
   <td colname="col2"> <p>Abbiamo migliorato l’interfaccia utente per la ricerca e il filtraggio delle caratteristiche. Per ulteriori informazioni consulta la documentazione <a href="https://marketing.adobe.com/resources/help/en_US/aam/c_tb_dashboard.html" format="https" scope="external">Dashboard caratteristiche</a>. </p> </td> 
  </tr> 
  <tr> 
...
* È stato risolto un problema a causa del quale, per alcuni clienti, la stringa URL completa non veniva salvata durante la mappatura di un URL a una destinazione URL. (AAM-28510)
* È stato risolto un problema nelle regole di unione profili per gli utenti RBAC a causa del quale agli utenti privi di autorizzazioni per visualizzare le caratteristiche veniva visualizzata una pagina vuota invece del messaggio di avviso relativo all’autorizzazione per la visualizzazione della pagina. (AAM-28361)
* È stato risolto un problema a causa del quale, per alcuni clienti, la pagina Elenco caratteristiche conteneva collegamenti interrotti alle origini dati. (AAM-29174)
* È stata migliorata la funzione Collegamento profilo . La funzione ora collega un [UUID Audience Manager](https://docs.adobe.com/content/help/it-IT/audience-manager/user-guide/reference/ids-in-aam.html) ad altri tre UUID Audienci Manager, per un totale di 4 UUID Audienci Manager in un cluster. (AAM-28808)
...
* È stata effettuata la migrazione dei metodi API del segmento a Swagger. Consulta [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
* Sono stati rimossi un paio di piccoli bug visivi in Addressable Audience per le destinazioni DAID. (AAM-28679)
...
* È stato corretto un bug visivo a causa del quale venivano visualizzate icone errate nella finestra modale per la reimpostazione della password, in Audience Marketplace e nell’ordinamento delle colonne nelle pagine di elenco nell’interfaccia utente. (AAM-28953)
* È stato risolto un problema nell’interfaccia di amministrazione di Audience Manager che impediva l’aggiunta di un ID utente finale di Audience Marketplace a un’azienda. (AAM-28953)

## [!DNL Social]

**Correzioni**

* Flussi di lavoro di pubblicazione: È stato risolto un problema a causa del quale gli utenti che ignoravano un flusso di lavoro di approvazione ricevevano comunque le notifiche di approvazione. Solo gli utenti che sono approvatori in un flusso di lavoro riceveranno un messaggio per approvare un post.
* Publish Anywhere: È stato risolto un problema a causa del quale gli utenti non venivano avvisati quando un caricamento di foto o video superava i limiti di dimensione API di una determinata piattaforma.
* Publish Anywhere: È stato risolto un problema che causava la pubblicazione su Facebook di post mirati di album fotografici senza foto.
* Calendario dei contenuti: È stato risolto un problema che impediva agli utenti di modificare l&#39;ora di un post figlio pianificato.
* Calendario dei contenuti: È stato risolto un problema che impediva la visualizzazione di emoticon e testo durante la pubblicazione dei video su Twitter.
* Rapporti: È stato risolto un problema che generava un errore durante il download del rapporto Panoramica moderazione .
* Dettagli proprietà Facebook: È stato risolto un problema relativo al raggiungimento dei fan in base alla posizione geografica dei dati per le proprietà di Facebook.
...
* Moderazione: È stato risolto un problema che impediva la visualizzazione della cronologia completa delle interazioni con l’autore nella pagina Dettagli autore .
...
* Tag per social network: È stato risolto un problema che impediva la visualizzazione di alcuni tag applicati ai post di LinkedIn in Post Analytics .
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Funzionalità di editing immagine migliorate con Creative SDK </p> </td> 
   <td colname="col2"> <p>Ora puoi accedere a un set completo di funzioni fornite da Creative SDK per migliorare le immagini direttamente nell’editor dei contenuti durante la modifica di e-mail o la destinazione di una pagina. </p> <p> Queste funzioni non richiedono l’acquisizione di soluzioni Creative Cloud aggiuntive. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Notifiche push transazionali </p> </td> 
   <td colname="col2"> <p> Il canale dell’applicazione mobile è stato aggiunto alle funzionalità di messaggistica transazionale di Adobe Campaign. Sono ora supportati tre canali per i messaggi transazionali: notifiche e-mail, SMS e push. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Notifiche push ricorrenti </p> </td> 
   <td colname="col2"> <p> Ora puoi utilizzare notifiche push ricorrenti in un flusso di lavoro. Le notifiche ricorrenti ti consentono di inviare la stessa consegna di notifiche push per app mobili più volte alla stessa destinazione o a un pubblico dinamico con una particolare frequenza (giornaliera, mensile, ecc.). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Connettore Amazon Simple Storage Service (S3) </p> </td> 
   <td colname="col2"> <p> È ora possibile utilizzare il connettore Amazon Simple Storage Service (S3) per importare o esportare dati in Adobe Campaign. Può essere configurato in un’attività del flusso di lavoro. La configurazione viene eseguita in un account esterno. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Integrazione live Dreamweaver </p> </td> 
   <td colname="col2"> <p>L’integrazione tra Adobe Campaign e Dreamweaver è ora live. Ora funziona con l’ultima versione ufficiale di Dreamweaver (17.0.2). </p> <p>È necessaria l'installazione dell'estensione dell'integrazione di Adobe Campaign dai <a href="https://adobe.ly/acdw_addon" format="http" scope="external">componenti aggiuntivi Adobe </a>. </p> <p> Per ulteriori informazioni puoi guardare il video <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external">Integrazione standard tra Dreamweaver e Adobe Campaign</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Gli ultimi AEM Oak Cumulative Fix Pack consigliati sono disponibili nelle seguenti posizioni: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Il 25 aprile 2017, 09:00-10:00 a.m. ora solare fuso occidentale; MST, unisciti a AEM Community Super User Lokesh BS, membro della community dell'anno 2015-2016 per una discussione sulla generazione di layout reattivi mediante l'avvio e Angular JS in Experience Manager. </p> <p>Scoprirai AEM tecniche di sviluppo che puoi applicare ai tuoi progetti AEM. Lokesh fornirà demo e risponderà alle tue domande. In qualità di sviluppatore AEM, questa è una sessione che non desideri perdere. La risposta può essere inserita <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">qui </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Una nuova versione del feed di dati inversi da Advertising Cloud ad Analytics migliora notevolmente l’accuratezza dei dati. Tutti gli inserzionisti con un’integrazione di Analytics verranno aggiornati al nuovo feed inverso nelle prossime settimane. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Cerca </p> </td> 
   <td colname="col2"> <p>Ora puoi creare un pubblico Google (elenchi di remarketing per gli annunci di ricerca) utilizzando elenchi di e-mail o segmenti dal pubblico Adobe Experience Cloud esistente: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      <li id="li_B56CA061540B4414861918CAFCB81397">Elenchi e-mail di Adobe Campaign: Il tuo account manager ti aiuterà a configurare un flusso di lavoro per creare e aggiornare un pubblico dell’elenco dei clienti Google da un elenco di e-mail all’interno di Campaign. </li> 
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmenti Adobe Audience Manager: (Beta solo per gli inserzionisti inseriti nell'elenco Consentiti) Da Campaigns Beta &amp;gt; Pubblico &amp;gt; Audiences, puoi creare un pubblico basato su tag di un sito web Google da uno qualsiasi dei tuoi segmenti di Audience Manager con Advertising Cloud come destinazione. Ciò può includere i segmenti Adobe Analytics pubblicati in Adobe Experience Cloud e i segmenti creati in Adobe Experience Cloud utilizzando il servizio core Persone. Advertising Cloud invierà automaticamente un URL di tracciamento di Google ai segmenti di Audience Manager in modo che Google possa tracciare il pubblico. </li> 
     </ul> </p> <p>Advertising Cloud non memorizza nessuno dei dati dei clienti dagli elenchi delle e-mail o dai segmenti di Audience Manager utilizzati per creare o modificare un pubblico Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campagne basate su ricerche - Funzione Beta </p> </td> 
   <td colname="col2"> <p>(Solo per gli inserzionisti inseriti nell'elenco Consentiti in versione beta) Sarà disponibile una nuova interfaccia utente di Search Beta la settimana successiva al rilascio, con: </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">Un menu Pubblico con Libreria, Target ed Esclusioni. La Libreria elenca tutti i tipi di pubblico di Google (elenchi di remarketing) e puoi creare tipi di pubblico Google utilizzando i segmenti da Adobe Audience Manager. Puoi utilizzare uno qualsiasi dei tipi di pubblico nelle campagne Google come target a livello di gruppo e come esclusioni a livello di campagna ed annuncio. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Ricerca Advanced Campaign Management (ACM) </p> </td> 
   <td colname="col2"> <p>I modelli di annunci di testo di Bing Ads includono una nuova impostazione della lingua a livello di gruppo. </p> </td> 
  </tr> 
  <tr> 
