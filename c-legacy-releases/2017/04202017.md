...
Ulteriori informazioni sull&#39;annuncio [Adobe Experience Cloud](https://www.adobe.com/experience-cloud.html) al Summit Adobe 2017.
...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> L'esempio Digital Foundation ti aiuta a implementare una piattaforma di marketing digitale con analisi, ottimizzazione e gestione della campagna. </p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement</span> per JavaScript</b> </p> <p>Versione 2.1.0 </p> 
    ...
    </ul> <p> <b>AppMeasurement per la libreria Flash</b> </p> <p>Versione 4.0.3 </p> 
...
* Abbiamo migliorato la funzionalità Collegamento profilo. La funzionalità ora collega un [UUID Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) ad altri tre UUID Audience Manager UUID, per un totale di 4 UUID Audience Manager UUID in un cluster. (AAM-28808)
* Ora esponiamo gli ID del segmento di test ([SID e csegID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html)) con un parametro di query testSegments=true nelle seguenti API (AAM-27591):
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* È stata effettuata la migrazione dei metodi API del segmento a Swagger. Vedi [Migrazione dei codici API di Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
...
Adobe ha rilasciato un [aggiornamento di sicurezza per Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v6.11 per Windows e Linux.
...
Livefyre presenta un&#39;offerta completa di contenuti generati dagli utenti, tra cui funzionalità di gestione dei social network e applicazioni di iterazione on-site.
