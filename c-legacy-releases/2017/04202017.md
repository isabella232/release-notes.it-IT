...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ora puoi creare audience Google (elenchi di remarketing per la ricerca di annunci) utilizzando gli elenchi di e-mail o i segmenti dal pubblico Adobe Experience Cloud esistente: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmenti di Adobe Audience Manager: (Beta solo per gli inserzionisti elencati) Da Campaigns Beta &amp;gt; Audience &amp;gt; Audiences, puoi creare un sito Web Google basato su tag di pubblico da qualsiasi segmento Audience Manager con Advertising Cloud come destinazione. Ciò può includere segmenti di Adobe Analytics pubblicati in Adobe Experience Cloud e segmenti creati in Adobe Experience Cloud utilizzando il servizio di base Persone. Advertising Cloud invierà automaticamente un URL di tracciamento Google ai segmenti Audience Manager in modo che Google possa tracciare il pubblico. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Beta solo per gli inserzionisti elencati) Sarà disponibile una nuova interfaccia utente Search Beta la settimana dopo il rilascio, con: </p> <p> 
