...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Una nuova versione del feed di dati inversi da Advertising Cloud ad Analytics migliora notevolmente la precisione dei dati. Tutti gli inserzionisti con un'integrazione di Analytics otterranno l'aggiornamento al nuovo feed inverso nelle prossime settimane. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Ora puoi creare pubblico Google (elenchi di remarketing per la ricerca di annunci) mediante gli elenchi di e-mail o io segmenti dal pubblico Adobe Experience Cloud esistente: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmenti di Adobe Audience Manager: (Beta solo per gli inserzionisti autorizzati) Da Campaigns Beta &amp;gt; Audience &amp;gt; Audiences, puoi creare un sito Web Google basato su tag di pubblico da qualsiasi segmento Audience Manager con Advertising Cloud come destinazione. Ciò può includere segmenti Adobe Analytics pubblicati su Adobe Experience Cloud e segmenti creati in Adobe Experience Cloud usando il servizio core Persone. Advertising Cloud invierà automaticamente un URL di tracciamento Google ai segmenti Audience Manager in modo che Google possa tracciare il pubblico. </li> 
     </ul> </p> <p>Advertising Cloud non archivia i dati dei clienti dagli elenchi delle e-mail o dai segmenti Audience Manager utilizzati per creare o modificare un pubblico Google. </p> </td> 
  </tr> 
  <tr> 
