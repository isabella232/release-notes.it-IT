...
Consulta la documentazione del [servizio Experience Cloud ID](https://marketing.adobe.com/resources/help/it_IT/mcvid/).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Prima del 20 aprile 2017, per usare le regole di elaborazione tutti gli utenti (anche gli amministratori) dovevano superare un esame e ottenere l'autorizzazione dell'assistenza clienti Adobe. </p> <p>Adesso l'impostazione predefinita consente agli amministratori diusare le regole di elaborazione. L'esame non è più necessario. Gli amministratori possono concedere questo diritto anche ai non amministratori utilizzando l'interfaccia Strumenti di amministrazione. <a href="https://marketing.adobe.com/resources/help/en_US/reference/processing_rules.html" format="html" scope="external"> Altro.. </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Sono state aggiunte virgole ai numeri del limite massimo di utilizzo per caratteristiche, segmenti, destinazioni, ecc. Consulta la sezione sui [limiti di utilizzo](https://marketing.adobe.com/resources/help/en_US/aam/usage-limits.html). (AAM-29310)
...
* L’articolo sulle [chiamate al dominio Demdex](https://marketing.adobe.com/resources/help/en_US/aam/demdex-calls.html) spiega perché [!DNL  Audience Manager] effettua chiamate a questo dominio.
* L’articolo sui [file di sequenza Handoop in uscita](https://marketing.adobe.com/resources/help/en_US/aam/outbound-seq-files.html) descrive come esportare i dati da [!DNL  Audience Manager] a Hadoop utilizzando file di sequenza binari.
* Le [domande frequenti sulle regole di unione profili](https://marketing.adobe.com/resources/help/en_US/aam/profile-merge-faq.html) forniscono risposte ad alcune domande comuni sulle [!UICONTROL Regole di unione profili] e sul grafico dei dispositivi.
* I [casi d’uso di Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab-use-cases.html) forniscono esempi sull’utilizzo di questa funzione per eseguire confronti e test.
