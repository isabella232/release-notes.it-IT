...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Ricerca migliorata per gli elementi di Dimension </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI è una suite di dashboard di analisi business per l’analisi dei dati e la condivisione di approfondimenti. L'integrazione di Adobe Analytics con Power BI consente di visualizzare i dati analitici di Report Builder con Microsoft Power BI. </p> <p>Con il Power BI, puoi integrare  Adobe Analytics con origini dati aggiuntive (ad es. punto vendita, CRM) per scoprire approfondimenti unici dei clienti, associazioni e opportunità e condividerli facilmente all'interno dell'organizzazione. Unendo la funzionalità di generazione dei rapporti di Report Builder con le funzioni di Power BI, le informazioni sono più accessibili sul Web per tutte le persone dell'organizzazione. </p> <p>L'integrazione con Report Builder Adobe consente di: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">È stato risolto un problema che causava un errore di creazione del segmento quando si selezionava l'opzione "Make this a Marketing Cloud audience" (Imposta come pubblico di riferimento). (AN-142218, AN-143300) </li> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">È stato corretto un problema a causa del quale i nomi dei gruppi di utenti non venivano ordinati in ordine alfabetico nel Admin Console . (AN-142769, AN-142274) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_6DE7C39FEAF142C1883651EB14BB5834">È stato risolto un problema che causava la sovrascrittura delle impostazioni "Condiviso con" in Gestione metriche calcolate, Gestore segmento e Gestore intervallo date per la condivisione automatica di componenti incorporati [segmenti, metriche calcolate, intervalli di date] con Destinatari in Gestione metriche calcolate. Questo problema causava una riduzione significativa dell'elenco dei destinatari. (AN-142804, AN-142378, AN-142533) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">È stato risolto un problema a causa del quale l'opzione "Collega a questo rapporto" non era disponibile quando l'utente effettuava l'accesso tramite il Marketing Cloud. (AN-118492) </li> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Feature pack per 3D Assets al AEM 6.3, rilasciato il 26 maggio 2017. </p> <p>Funzionalità AEM 3D migliorata per assimilazioni di file 3D, gestione DAM e rendering 2D. </p> <p> <a href="https://docs.adobe.com/content/docs/en/aem/6-3/release-notes/aem3d-release-notes.html" format="https" scope="external"> Note sulla versione </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Sono disponibili biglietti per sessioni on demand durante IMMERSE17. Sono acquistabili <a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external">qui</a> utilizzando 
     <code>OD#1AEM</code> code. </p> <p>Le sessioni disponibili includono: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Sessione di maggio: Utilizzo di Lazybones e di modelli modificabili nei progetti AEM. </p> <p> Unisciti ad Ankur Ahlawat e Scott Macdonald per una discussione sull'utilizzo di Lazybones e dei modelli modificabili nei progetti AEM. </p> <p>Leggendo questa sessione, puoi imparare a creare AEM progetti che sfruttano Lazybones e i nuovi Modelli modificabili nei tuoi progetti. Registrata il 30 maggio 2017, 08:00 PDT (<a href="https://bit.ly/ATACE517" format="http" scope="external">http://bit.ly/ATACE517</a>). </p> </td> 
  </tr> 
 </tbody> 
</table>
