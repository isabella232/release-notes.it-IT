...
* La schermata Ricerca in Audience Marketplace ora include un collegamento a [Audience Finder](https://www.adobe-audience-finder.com/). Usa Audience Finder per trovare partner che possono offrire il giusto tipo di feed di dati per la tua campagna. (AAM-30241)
...
[DIL](https://marketing.adobe.com/resources/help/en_US/aam/dil-overview.html) è il codice di raccolta di dati API per Audience Manager. Con il rilascio di agosto, DIL è stato incrementato alla versione 6.11.

* È stata aggiunta la nuova configurazione ` isCoopSafe`. Si tratta di una configurazione booleana opzionale che consente di determinare se DIL invia o meno dati ad [!DNL  Adobe Marketing Cloud Device Co-op]. Vedi [isCoopSafe](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-coopsafe.html). (CORE-4334)
