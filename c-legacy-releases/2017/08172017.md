...
<table id="table_2D2E3E490C7347399F25F056AC601E39">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Configurazione booleana opzionale che consente di determinare se il servizio ID invia o meno dati ad Adobe Marketing Cloud Device Co-op. Vedi <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-coopsafe.html" format="https" scope="external">isCoopSafe </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Il 22 agosto, Adobe Analytics abiliterà i rapporti di [Segmentazione geografica](https://marketing.adobe.com/resources/help/en_US/reference/reports_geosegmentation.html) per tutti i clienti. Questa modifica è un’anticipazione della prossima rimozione delle impostazioni di segmentazione geografica in Admin Console.
...
* Gli utenti collegati con gli [ID organizzazione](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) possono ora accedere all’interfaccia utente di Audience Manager con il proprio Adobe ID anziché con nome utente e password. (AAM-28161)
...
[DIL](https://marketing.adobe.com/resources/help/en_US/aam/dil-overview.html) è il codice di raccolta dati API per Audience Manager. Con il rilascio di agosto, DIL è stato incrementato alla versione 6.11.

* È stata aggiunta la nuova configurazione ` isCoopSafe`. Si tratta di una configurazione booleana opzionale che consente di determinare se DIL invia o meno dati ad [!DNL  Adobe Marketing Cloud Device Co-op]. Consulta [isCoopSafe](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-coopsafe.html). (CORE-4334)

**Aggiornamenti importanti alla documentazione**

È stata riscritta la documentazione su come utilizzare le API Data Collection Server (DCS). Inizia con [Codice e metodi API del server DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs-intro.html) e avanza verso operazioni più complesse con le API di DCS.
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In Media Optimizer i sitelink condivisi di Yahoo Gemini creati in Yahoo sono ora sincronizzati e sono attribuiti ricavi in base ai clic su sitelink agli annunci e alle parole chiave pertinenti. </p> <p>Puoi inoltre modificare i sitelink condivisi nel bulksheet. Il parametro “Descrizione” non è ancora supportato ma Media Optimizer non modificherà i valori esistenti. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Solo amministratori e client manager con accesso diretto) Puoi consentire a Media Optimizer di estrarre metadati, dati gerarchici e dati del pubblico univoci per segmenti di Audience Manager in Search Advertising &gt; Campaigns Beta &gt; Audiences view (Ricerca annunci &gt; Campagne &gt; Campagne - Funzione Beta). Per configurare un inserzionista, immetti il relativo ID partner per Adobe Audience Manager in Search Advertising &gt; Admin &gt; Audience Manager Setup (Ricerca annunci &gt; Amministratore &gt; Configurazione Audience Manager). </p> </td> 
  </tr> 
 </tbody> 
</table>
