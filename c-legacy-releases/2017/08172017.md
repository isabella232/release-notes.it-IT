...
<table id="table_2D2E3E490C7347399F25F056AC601E39">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Configurazione booleana opzionale che consente di determinare se il servizio ID invia o meno dati ad Adobe Marketing Cloud Device Co-op. Vedi <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-coopsafe.html.html" format="https" scope="external">isCoopSafe </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> I dati del rapporto Visualizzatore simultaneo ora possono essere esportati al di fuori del reporting di Analytics utilizzando le API dei servizi Web. Puoi utilizzare i numeri in strumenti di reporting personalizzati o condividere i valori con i partner. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p></p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C4E913B41B1E46E7821A312C42FFDADB"> 
      ...
      <li id="li_6CFDD8DDB0F345A498786663BDC24A40">È stato risolto un problema che impediva ai segmenti di pubblico di essere pubblicati da Analytics al Marketing Cloud. (AN-146486) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_41A7B52EFE5A4A2CBBEDC38389E17E13"> 
      <li id="li_89D4145EE47A4C49A209C9DEFA7C3811"> È stato corretto un bug a causa del quale i processi di Data Warehouse orari venivano creati per l’ora sbagliata intorno alle transizioni di ora legale (AN-140128) </li> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.3 CFP 6.3.0.2, rilasciato l’8 agosto 2017, è un aggiornamento importante che include correzioni di problemi fondamentali per il cliente, introdotte successivamente alla data di disponibilità generale del AEM 6.3 aprile 2017. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> AEM Forms ha avviato i modelli per i seguenti elementi: </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM gruppo di tecnici *Virtual </p> </td> 
   <td colname="col3"> <p>Non perdete mai una notifica sulle sessioni di webinar AEM GEM o Ask the Expert. Iscriviti al nostro gruppo virtuale per ricevere notifiche sulle sessioni in programma. Ci trovi su <a href="https://www.meetup.com/AEM-Technologist-Group/" format="https" scope="external">https://www.meetup.com/AEM-Technologist-Group/ </a>. </p> <p>Inoltre, pubblichiamo tutti i nostri incontri regionali di persona nel caso in cui tu o un collega vi troviate nella zona e desideriate partecipare. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Advertising Cloud ora sincronizza i sitelink condivisi Yahoo Gemini creati in Yahoo, e attribuisce i ricavi dai clic sui sitelink al relativo annuncio e parola chiave. </p> <p>È inoltre possibile modificare i sitelink condivisi nei bulksheet. Il parametro "Descrizione" non è ancora supportato, ma  Advertising Cloud non modificherà i valori esistenti. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Solo amministratori e client manager con accesso diretto) È possibile consentire  Advertising Cloud di estrarre metadati, dati gerarchici e dati di audience univoci per  segmenti di Audience Manager in Search Advertising &amp;gt; Campagne Beta &amp;gt; Visualizzazione Pubblico. Per configurare un inserzionista, immetti il relativo ID partner per Adobe Audience Manager in Search Advertising &gt; Admin &gt; Audience Manager Setup (Ricerca annunci &gt; Amministratore &gt; Configurazione Audience Manager). </p> </td> 
  </tr> 
 </tbody> 
</table>
