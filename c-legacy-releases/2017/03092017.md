...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le opzioni di «ottimizzazione automatica delle regolazioni delle offerte» consentono a Advertising Cloud di modificare automaticamente le impostazioni di regolazione delle offerte per gruppi di annunci pubblicitari nel portafoglio quando il portfolio viene ottimizzato, per ottimizzare le prestazioni. Advertising Cloud può ottimizzare le regolazioni delle offerte per Google, Bing e Yahoo! Japan; target di tablet e computer Google e Bing; target Google RLSA; target posizione Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Account Bing Merchant Center con URL finale) È disponibile un campo “Tracking Template” (Modello tracciamento) per i gruppi di prodotti nei modelli Bing Shopping e bulksheet. </p> <p>Per il tracciamento della conversione di Advertising Cloud, non è necessario immettere un valore se si dispone di un modello di tracciamento a livello di account, campagna o gruppo di annunci. </p> </td> 
  </tr> 
  <tr> 
