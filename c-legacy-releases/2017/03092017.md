...
* È stata effettuata la migrazione delle caratteristiche e dei metodi API della cartella a Swagger. Consulta l’articolo sulla [migrazione del codice API di Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28221 e AAM-27133)
...
Questo rilascio corregge un errore che impediva a ` GA.submitUniversalAnalytics` di inviare dati ai server di raccolta dei dati. Consulta [GA.submitUniversalAnalytics](https://marketing.adobe.com/resources/help/en_US/aam/dil-google-universal-analytics.html). (MCID-354)

**Documentazione nuova e rivista**

**Novità**

[Utilizzo del recupero preventivo del DNS con diverse soluzioni e servizi](https://marketing.adobe.com/resources/help/it_IT/mcloud/dns-prefetch.html) descrive come utilizzare il prefetch DNS per ridurre i tempi di caricamento delle pagine.

**Elementi revisionati**

* [Codici di errore DCS, messaggi ed esempi](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html) includono gli avvisi sull&#39;integrazione.
* [Nomi file dati in uscita](https://marketing.adobe.com/resources/help/en_US/aam/c_name_reqs_outbound.html) includono il parametro opzionale ` PID-ALIAS`.
* La [visualizzazione Riepilogo segmenti](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_summary.html) include gli intervalli di look-back del rapporto.
* La sezione sulla funzione [DIL.create](https://marketing.adobe.com/resources/help/en_US/aam/r_dil_create.html) include nuove informazioni sulla proprietà ` containerNSID`.
* La sezione sulle [metriche per i tipi di pubblico utilizzabili](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audience-metrics.html) include definizioni riviste e contenuti riorganizzati.
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le opzioni di “ottimizzazione automatica delle regolazioni delle offerte” consentono a Media Optimizer di modificare automaticamente le impostazioni di regolazione delle offerte per gruppi di annunci pubblicitari contenuti nel portfolio quando questo viene ottimizzato, al fine di migliorare le prestazioni. Media Optimizer può ottimizzare le regolazioni delle offerte per i target dei dispositivi mobili Google, Bing e Yahoo! Japan; target di tablet e computer Google e Bing; target Google RLSA; target posizione Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Account Bing Merchant Center con URL finale) È disponibile un campo “Tracking Template” (Modello tracciamento) per i gruppi di prodotti nei modelli Bing Shopping e bulksheet. </p> <p>Per il tracciamento della conversione Media Optimizer, non devi immettere un valore se nell'account, nella campagna o a livello di gruppo hai un modello di tracciamento. </p> </td> 
  </tr> 
  <tr> 
