...
Consulta [Android SDK 4.x per soluzioni](https://marketing.adobe.com/resources/help/it_IT/mobile/android/) Marketing Cloud e [iOS SDK 4.x per soluzioni](https://marketing.adobe.com/resources/help/it_IT/mobile/ios/) Marketing Cloud per la documentazione SDK. Per leggere le note sulle versioni precedenti, espandi *Note sulle versioni precedenti* nel riquadro a sinistra.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_DE987D7BAD144978AD6D163DD5C6C4FB"> 
      ...
      <li id="li_5EE7FD8A9B6642E6A601A42FC4424B6B">È stato risolto un problema che impediva agli utenti connessi tramite l'accesso a Marketing Cloud di condividere i rapporti. (AN-143642) </li> 
      ...
      <li id="li_A981D5780A804BDB88E9919C940053CA">È stato risolto un problema che impediva agli utenti connessi tramite l'accesso a Marketing Cloud di condividere i rapporti. (AN-143642) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8C16C6ACD0B54F3CB097A5FC4C2E0FE6"> 
     <li id="li_57D83C770E6D4A7291A4DF790A8F9307">È stato risolto un problema di Data Warehouse che a volte impediva la consegna di rapporti dettagliati contenenti dati antecedenti al 2008 (AN-143591). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9A3691CC67074D219596D9FF3B2474F5"> 
     ...
     <li id="li_05944EB2B35A4D2D9AF866F324DBD80C">API di reporting: È stato risolto un problema per il quale gli ID delle metriche erano nulli durante la richiesta di rapporti Data Warehouse. (AN-145354) </li> 
