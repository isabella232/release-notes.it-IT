...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>(Portfolio con l'impostazione «Model and optimize search on an intraday basis» (Modello e ottimizzazione della ricerca su base intraday)) Advertising Cloud ora prende in considerazione i dati sulle entrate quando si modificano le offerte e i budget delle campagne per rispettare le tendenze infragiornaliere. In precedenza venivano considerati solo i dati sui clic. </p> <p>Ora le offerte vengono aumentate durante le parti della giornata con prestazioni più elevate. </p> </td> 
  </tr> 
  <tr> 
