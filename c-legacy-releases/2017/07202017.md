...
Consulta la documentazione per l’[SDK 4.x per Android per le soluzioni Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/mobile/android/) e l’[SDK 4.x per iOS per le soluzioni Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/mobile/ios/). Per leggere le note sulle versioni precedenti, espandi *Note sulle versioni precedenti* nel riquadro a sinistra.
