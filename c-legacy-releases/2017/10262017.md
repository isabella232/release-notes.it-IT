...
* È possibile lavorare con le nostre API DCS utilizzando i metodi GET o POST. [Metodi API DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs-api-methods.html) descrivono la sintassi da utilizzare in ogni caso.
...
La documentazione del prodotto è disponibile nella sezione dedicata alla [documentazione di Adobe Campaign Standard](https://docs.adobe.com/docs/en/campaign/ACS.html).

* [Note sulla versione di Adobe Campaign Standard](https://docs.campaign.adobe.com/doc/standard/en/RN.html)
* [Documentazione di Adobe Campaign Standard](https://docs.adobe.com/docs/en/campaign/ACS.html)
* [Note sulla versione v7 di Adobe Campaign](https://docs.campaign.adobe.com/doc/AC/en/RN.html)
* [Documentazione su v7 di Adobe Campaign](https://docs.adobe.com/docs/en/campaign/AC.html)
* [Documentazione su v6 di Adobe Campaign](https://docs.adobe.com/docs/en/campaign/AC6.html)
