...
Per informazioni sempre aggiornate, consulta le [note sulla versione di Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=en).
