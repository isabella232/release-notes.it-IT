...
* [Analytics](#analytics) e [Customer Journey Analytics](#cust-journey) (Aggiornato **8 dicembre 2020**)
...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * Cloud Readiness Analyzer (Analisi di preparazione al cloud) dispone di una console di stato iniziale che presenta un **[!UICONTROL Genera report]** per consentire all’utente di selezionare per eseguire l’analisi dei rischi.
