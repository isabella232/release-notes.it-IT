...
| 5 ottobre 2020 | [Creazione automatica di tabelle a forma libera in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/auto-build-freeform-tables-in-analysis-workspace.html?lang=it#analysis-workspace) | Video | Puoi rilasciare i componenti direttamente in un progetto o pannello vuoto oppure in una tabella a forma libera vuota per creare automaticamente una tabella a forma libera in un formato consigliato. |
...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * Cloud Readiness Analyzer (Analisi di preparazione al cloud) dispone di una console di stato iniziale che visualizza un pulsante **[!UICONTROL Genera report]** esplicito per l’utente da selezionare per l’esecuzione dell’analisi di preparazione al cloud.
