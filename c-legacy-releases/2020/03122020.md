...
Per la documentazione sul prodotto, consulta la guida di [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en).
...
* **Experience Cloud Audience Optimization**: questa funzione consente di pubblicare segmenti in Experience Cloud entro 8 ore (anziché 48 ore come in precedenza). [Ulteriori informazioni...](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-publish.html?lang=en)
...
Consulta [Note sulla versione di AppMeasurement per JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en). La versione 2.20.0 è stata rilasciata il 5 marzo 2020.
...
| [!DNL Adobe Campaign] | Tutorial: [notifica push con Android™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | Invia notifiche push personalizzate e segmentate ai dispositivi mobili iOS e Android™. Questo tutorial illustra i passaggi necessari per l’invio di notifiche push da Adobe Campaign e per la ricezione di tali notifiche nell’app Android™. |
