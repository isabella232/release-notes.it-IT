...
| [!DNL Adobe Campaign] | Tutorial: [notifica push con Android™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | Invia notifiche push personalizzate e segmentate ai dispositivi mobili iOS e Android™. Il presente tutorial illustra i passaggi necessari per l’invio di notifiche push da Adobe Campaign e la ricezione di tali notifiche all’interno dell’app Android™. |
