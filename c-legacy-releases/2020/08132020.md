...
Per informazioni aggiornate, consulta [Note sulla versione precedente - 21 maggio 2020](https://experienceleague.corp.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html#status) .
...
Consulta le [note sulla versione precedente](https://experienceleague.corp.adobe.com/docs/release-notes/experience-cloud/previous/2020/07162020.html#ecloud) di luglio per informazioni sugli aggiornamenti dell’interfaccia e sul dominio di prodotto unificato.
...
| ----------- | ---------- | ------- |
| [!UICONTROL Analisi multidispositivo]: disponibilità in EMEA e APAC | 31 agosto 2020 | [Analisi multidispositivo](https://experienceleague.corp.adobe.com/docs/analytics/components/cda/overview.html) e Private Graph saranno disponibili per i clienti EMEA e APAC. |
...
* **AEM as a Cloud Service**
   ...
   * AEM Commerce è ora disponibile su Cloud Service. Consulta la [Guida introduttiva di AEM Commerce as a Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/commerce/getting-started.html).
   ...
   * La versione 2.11.0 dei [Componenti core di AEM](https://experienceleague.corp.adobe.com/docs/experience-manager-core-components/using/introduction.html) è ora disponibile come parte di AEM Sites e include:
      ...
      * Compatibilità con la versione 1.0.2 di [Adobe Client Data Layer](https://experienceleague.corp.adobe.com/docs/experience-manager-core-components/using/developing/data-layer/overview.html).
   * Diversi miglioramenti all’interfaccia utente in Cloud Manager.
   * Le pipeline di Cloud Manager ora supportano variabili e segreti impostati dal cliente. Consulta [Variabili delle pipeline.](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/creating-aem-application-project.html#pipeline-variables)
   * [I registri possono essere inoltrati agli account Splunk](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/implementing/developing/logging.html#splunk-logs), consentendo così alle organizzazioni di sfruttare il proprio investimento [!DNL Splunk].
...
* **AEM Assets**
   ...
   * Sono stati aggiunti ulteriori suggerimenti per la [risoluzione di problemi](https://experienceleague.corp.adobe.com/docs/experience-manager-desktop-app/using/troubleshoot.html) per l’app desktop Experience Manager.
...
* **AEM Forms**
   ...
   * Utilizza il [sito di riferimento](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/getting-started/aem-forms-reference-collaterals/forms-gov-reference-site-user-demo.html) per scoprire il flusso di lavoro end-to-end del servizio di conversione automatica dei moduli.
   ...
   * [Importare certificati attendibili](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/manage-administer-aem-forms/hardening-aem-forms-environment/hardening-aem-forms-jee-environment.html#configuring-ssl) in JVM durante la protezione avanzata di AEM Forms in un ambiente JEE.
   * Sono stati apportati miglioramenti alla [documentazione di configurazione di PDF Generator.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/install-aem-forms/osgi-installation/install-configure-document-services.html)
...
| 21 luglio 2020 | [Creare una live copy](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-live-copy.html) | Esercitazione | Come creare una [!UICONTROL live copy] per il sito da una [!UICONTROL blueprint] utilizzando la procedura guidata [!UICONTROL Crea live copy]. |
...
| 21 luglio 2020 | [Progetti di traduzione](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html) | Esercitazione | Scopri come creare, modificare e gestire un progetto di traduzione per la [!UICONTROL copia in lingua]. |
| 21 luglio 2020 | [Lavori di traduzione](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html) | Esercitazione | Scopri come aggiungere un lavoro di traduzione a un progetto di traduzione esistente. |
...
| 21 luglio 2020 | [Live copy e blueprint](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/live-copy-and-blueprint.html) | Esercitazione | Comprendere la relazione tra una [!UICONTROL live copy] e la relativa [!UICONTROL blueprint] in [!UICONTROL AEM Sites]. |
...
| 21 luglio 2020 | [Creare una copia in lingua](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html) | Esercitazione | Descrizione |
...
| 21 luglio 2020 | [Creare un sito del paese](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-new-site.html) | Esercitazione | Scopri come creare un sito del paese da [!UICONTROL copie in lingua] esistenti utilizzando la procedura guidata [!UICONTROL Crea sito]. |
...
| 21 luglio 2020 | [Stato del lavoro di traduzione](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/multi-site-management/translation-job-status.html) | Esercitazione | Comprendi i diversi stati associati a un lavoro di traduzione o a un elemento di esso. |
...
| 21 luglio 2020 | [Casella in entrata AEM](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/forms/inbox-customization/introduction.html) | Esercitazione | La [!UICONTROL Casella in entrata AEM] consolida le notifiche e le attività da vari componenti AEM, inclusi i flussi di lavoro Forms. |
...
* Versione 20.2.1 - [Ulteriori informazioni](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html#release-20-2-2-build-9180)
...
| 31 luglio 2020 | [Generazione di un rapporto di analisi descrittivo](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/reporting/generating-a-descriptive-analysis-report.html) | Campaign Classic | Scopri come generare un rapporto di analisi descrittivo. |
