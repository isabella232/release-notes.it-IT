...
* **Configurazione di Dynamic Media - Modalità Scene7**
   ...
   Consulta [Creazione di una configurazione di Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/config-scene7-mode/config-dms7.html?lang=en).
