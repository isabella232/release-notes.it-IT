...
| Funzione | Descrizione |
| -----------| ---------- |
| Quadro di riferimento per la trasparenza e il consenso GDPR |  Advertising Cloud sta aggiornando il supporto per l&#39;AIB Transparency and Consent Framework alla versione 2.0 entro il 15 agosto 2020. Al momento, non sono necessarie modifiche da parte del cliente.  In qualità di Data Processor per ciascuno dei nostri clienti, Adobe Advertising Cloud ha le capacità a disposizione dei clienti per adempiere ai propri obblighi in base al GDPR applicabili all&#39;uso dei nostri prodotti e servizi. |
| Integrazione Audience Manager  | (Beta solo per i clienti Adobe Audience Manager con Adobe Experience Platform) DSP è possibile inviare file di registro fruibili contenenti i dati di coinvolgimento pubblicitario di un inserzionista  Audience Manager tramite Adobe Experience Platform. In  Audience Manager, gli inserzionisti possono utilizzare i dati per segmentazione avanzata e l&#39;utilizzo in strumenti di approfondimento, come  rapporti Audience Optimization. |
| Targeting del grafico tra dispositivi basato su persone | I clienti DSP possono utilizzare un grafico del dispositivo ( Adobe Device Co-op o LiveRamp) per il targeting basato sulle persone e la gestione delle frequenze nelle nuove campagne. In questo modo gli inserzionisti possono raggiungere il pubblico attraverso i loro dispositivi di proprietà, ma limitare l&#39;esposizione. Inoltre, la modifica collettiva delle impostazioni di targeting cross-device tra più posizioni è ora in versione beta. Per abilitare la versione beta per il tuo account, contatta il tuo responsabile commerciale  Adobe. |
| Targeting del sito | Le &quot;liste nere&quot; e le &quot;liste bianche&quot; sono state rinominate in termini più equi &quot;bloccati (siti)&quot; e &quot;mirati (siti).&quot; |
| Annunci Flashtalk | DSP ora inserisce automaticamente le macro di clic per tutti i tag degli annunci Flashspeak tramite i flussi di lavoro per la creazione di singoli annunci e la creazione di massa di annunci da parte di terze parti. |
| Rapporti | (Beta solo per i clienti Adobe Experience Platform) Un nuovo rapporto tra canali in Advertising Cloud Search fornisce una visualizzazione unificata della spesa media nelle DSP e nella ricerca, con metriche chiave giornaliere per DSP posizionamenti e campagne di ricerca. |
