...
In novembre e dicembre, Adobe anticipa un grande volume di caricamenti di classificazioni per la base cliente. Questi caricamenti verranno elaborati il più rapidamente possibile, ma i tempi di elaborazione potrebbero richiedere più tempo del previsto. Per suggerimenti su come ridurre il tempo di elaborazione, consulta larticolo sul·[tempo di elaborazione delle classificazioni](https://helpx.adobe.com/it/analytics/kb/saint-processing-time.html).
