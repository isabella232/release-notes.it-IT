...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data warehouse supporta Analytics Reporting API 1.4. </p> <p>Per ulteriori informazioni consultate <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> nella documentazione relativa ad API per Data Warehouse disponibile in Developer Connection. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* È stato risolto un problema con i collegamenti abbreviati a causa del quale i collegamenti alle pagine all&#39;interno di un sito Web causavano il reindirizzamento alla home page della società.
