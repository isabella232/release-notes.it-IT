...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> È stata aggiunta una sostituzione regionale per i collegamenti di acquisizione nel browser desktop. Questa impostazione ti consente di selezionare l’app store specifico per la regione a cui desideri indirizzare il collegamento di acquisizione quando un utente fa clic su tale collegamento da un browser desktop. </p> <p> Questa funzione può essere impostata solo dagli utenti con privilegi amministrativi per creare collegamenti di acquisizione (amministratori di app mobili). </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_1A8173DB38E8426D96BB7C57BF8FD2D5"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>SDK per iOS versione 4.5 </p> </td> 
   <td colname="col2"> <p>A partire dalla versione SDK 4.5 per iOS, una nuova estensione iOS consente di raccogliere i dati di utilizzo dalle app Apple Watch, dai widget Oggi, dai widget per l'editing di foto e da tutte le altre app di estensione iOS. </p> <p>Consulta <a href="https://docs.adobe.com/content/help/it-IT/mobile-services/ios/ios-ext/ios-ext.html" format="https" scope="external">Implementazione estensione iOS</a> nella guida <a href="https://docs.adobe.com/content/help/it-IT/mobile-services/ios/overview.html" format="https" scope="external">iOS SDK 4.x per soluzioni Marketing Cloud</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> Descrizione della funzione </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Data Warehouse  </td> 
   <td colname="col2"> È stata aggiunta la metrica "Marketing Channel Last Touch Instances" (Istanze ultimo contatto canale di marketing) per il reporting sulle Date Warehouse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Modifica di Origini dati in arrivo a giugno 2015 </td> 
   <td colname="col2"> <p>Reports &amp; Analytics non dispone di sorgente dati di tipo "Sorgente dati traffico" dall'introduzione di SiteCatalyst 15. L’interfaccia utente delle origini dati ti consente ancora di creare un’origine dati Traffico, ma questo tipo di origine dati può essere applicata solo a intervalli di date precedenti alla data in cui l’azienda ha effettuato la migrazione dal SiteCatalyst 14 a SiteCatalyst 15. Il mese successivo (giugno 2015), Adobe pianifica di rimuovere Sorgenti dati traffico come opzione. A giugno saranno inoltre introdotte nuove funzionalità in Reports &amp; Analytics che consentiranno di creare semplici metriche di traffico senza dover usare Sorgenti dati traffico. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data Warehouse supporta l'API di reporting di Analytics 1.4. </p> <p>Per ulteriori informazioni consultate <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> nella documentazione relativa ad API per Data Warehouse disponibile in Developer Connection. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Consulta [Cronologia rilascio ](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) per una cronologia del rilascio di [!DNL  AppMeasurement]AppMeasurement per le seguenti piattaforme:
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Post oscuri su Facebook </p> </td> 
   <td colname="col2"> <p>Crea post su Facebook che non vengono visualizzati sulla Timeline ma a cui è possibile accedere tramite collegamenti diretti. Questa opzione consente ai creatori di contenuti di creare post da promuovere come annunci sponsorizzati (a pagamento). </p> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Seleziona un fotogramma fisso da qualsiasi punto del video da caricare e utilizzalo come immagine miniatura del video nel post. Precedentemente, <span class="keyword">Social</span> selezionava il fotogramma di inizio da usare come immagine di anteprima. 
  ...
  <tr valign="top"> 
   <td colname="col1"> <p>Approvazione dei post </p> </td> 
   <td colname="col2"> <p>Gli approvatori della pubblicazione possono ora approvare un post dalla relativa anteprima. </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Ora puoi creare un gruppo di tag o un tag con lo stesso nome di un gruppo di tag o di un tag precedentemente eliminato. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* È stato risolto un problema relativo ai collegamenti abbreviati a causa del quale i collegamenti alle pagine all’interno di un sito web venivano reindirizzati alla home page dell’azienda.
* È stato risolto un problema che causava la visualizzazione di contenuto non valido (post, commenti e risposte) nei feed soggetti a moderazione. I miglioramenti al codice aiuteranno il nostro sistema di raccolta a bloccare in modo più efficace il contenuto non valido che non corrisponde alla pagina.
