...
<table id="table_04854D12F4C241AE86F24C12C4F0FA28"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La funzionalità Gestione dei gruppi e degli utenti si trova ora in Enterprise Dashboard. Il nuovo percorso di navigazione è: </p> <p> <span class="uicontrol">Marketing Cloud</span> &gt; <span class="uicontrol">Strumenti</span> &gt; <span class="uicontrol">Launch Enterprise Dashboard (Avvio dashboard Enterprise)</span></p> <p> Inoltre, è disponibile l'assistenza per l'Enterprise e il Federated ID. Potete utilizzare gli Enterprise ID, i Federated ID così come l'Adobe ID nella stessa implementazione enterprise. Ad esempio, utilizzate gli Adobe ID per gli utenti che possono usare altri prodotti e servizi Adobe. Per gli utenti, utilizza gli Enterprise o Federated ID se desideri gestire i loro account. </p> <p>Consulta <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/user_mgmt_admin.html" format="https" scope="external"> Utenti e gruppi - Gestione identità </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* È stato risolto un problema che impediva il single sign-on tra [!DNL  Marketing Cloud] e [!DNL  Media Optimizer].

**Problemi noti**

* Un problema noto impedisce la condivisione di audience da suite di rapporti che non sono di proprietà dall&#39; [!DNL Analytics] account collegato. Stiamo cercando di risolvere il problema
...
* Usando lo strumento [!UICONTROL  Provide Feedback (Invia feedback) ] per inviare problemi della tipologia *` Bug`* inviate questi problemi direttamente all&#39;Assistenza clienti, creando un ticket. L&#39;Assistenza clienti ti contatterà in tempi brevi dopo l&#39;invio del problema rilevato.
...
* È stato risolto un problema relativo alle impostazioni di confronto dell&#39;intervallo di date per una dashboard che deve essere ripristinata manualmente. Si noti che questo problema è stato risolto solo per i segnalibri nuovi; quelli esistenti dovranno essere aperti e *` saved as`* di marketing.
...
* È stata risolta una discrepanza tra reporting e [!DNL Analytics] dati data warehouse aggiungendo il supporto per *` campaign instances`* la metrica di segmentazione al data warehouse.
...
* L&#39;API di reporting ora consente l&#39;uso di correlazioni. Gli elementi restituiti da ` Report.GetElements` ora contengono informazioni sui tipi di suddivisioni supportate per quell&#39;elemento. Ciò migliora la corrispondenza dei dati tra il generatore di report e reporting e analisi.

## [!DNL Social]

Data di rilascio: **17 aprile 2015**

Questo rilascio include le seguenti modifiche:
...
Il presente rilascio di [!DNL  Social] si focalizza su prestazione, scalabilità, usabilità e affidabilità migliorate. Più di 650 problemi back-end risolti e miglioramenti effettuati in queste aree. Le correzioni sotto riportate descrivono le risoluzioni per i principali problemi riportati dai clienti.
