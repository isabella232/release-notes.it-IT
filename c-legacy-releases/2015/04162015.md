...
* La funzione Applicazioni social network è diventata ufficialmente obsoleta dal rilascio di Adobe Social 15.4.1.0 (aprile 2015). Ciò include la rimozione di tutte le metriche, i dati e i metodi API relativi all&#39;applicazione. In caso di domande, contattate il vostro Social Account Manager. Per informazioni dettagliate, consulta l’articolo sulle [applicazioni Adobe Social obsolete](https://helpx.adobe.com/it/social/kb/social-applications---deprecation-fact.html).
