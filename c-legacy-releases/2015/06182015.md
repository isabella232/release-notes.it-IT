...
* Riorganizzazione e miglioramento delle guide seguenti:
   ...
   * [Guida per l&#39;utente di Adobe Mobile Services](  https://marketing.adobe.com/resources/help/it_IT/mobile/)
   * [Guida per l’amministratore di iOS SDK 4.x per soluzioni Marketing Cloud](https://marketing.adobe.com/resources/help/it_IT/mobile/ios/)
...
Analytics Premium fornisce le seguenti nuove funzioni in [Workbench dati 6.4](https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/):
...
* Modifiche apportate alla logica aziendale Orario visita/sito:
   ...
   * Utilizzo di  *` visit_start_time_gmt`* come ora di inizio di una visita. Adesso le visite iniziate prima dell&#39;intervallo di date di reporting non risulteranno compromesse.
...
* Stiamo migliorando la documentazione sull&#39;API con Swagger. Per i metodi nuovi o rivisti, consulta la sezione [Documentazione API di Audience Manager](https://bank.demdex.com/portal/swagger/index.html).
* È stata aggiunta una nuova documentazione sul servizio [ID visitatore di Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_visitor_id_versions.html). Alcune volte, durante la creazione o la modifica di un’origine dati, è necessario un ID visitatore.
...
Per maggiori informazioni, consulta le [note sulla versione di Adobe Social](https://marketing.adobe.com/resources/help/en_US/social/c_rel_notes.html).
