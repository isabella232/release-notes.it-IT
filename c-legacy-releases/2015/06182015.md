---
description: Data Workbench 6.4, Generatore di metriche calcolate, aggiornamenti all'analisi freeform, aumenti delle regole di elaborazione, nuove metriche video di base in Video Stream Analytics e altro.
keywords: note sulla versione
seo-description: Data Workbench 6.4, Generatore di metriche calcolate, aggiornamenti all'analisi freeform, aumenti delle regole di elaborazione, nuove metriche video di base in Video Stream Analytics e altro.
...
Data Workbench 6.4, Generatore di metriche calcolate, aggiornamenti all&#39;analisi freeform, aumenti delle regole di elaborazione, nuove metriche video di base in Video Stream Analytics e altro.
...
I clienti devono disporre [!DNL  Analytics—Mobile Apps] o [!DNL  Analytics Premium] per utilizzare le funzionalità seguenti:

* Messaggistica in-app
* Tracciamento della campagna di acquisizione
* Analisi dei punti di interesse

I clienti che dispongono di [!DNL  Analytics Standard] o di altri prodotti Analytics singoli (come ad esempio [!DNL  SiteCatalyst]) saranno ammessi all&#39;utilizzo della funzionalità corrente fino al rinnovo.
...
<table id="table_193CB58F22D14FE4AB4759418A00848B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol">Strumenti di amministrazione</span> &gt; <span class="uicontrol">Suite per report</span> &gt; <span class="uicontrol">Modifica</span> &gt; <span class="uicontrol">Video Management (Modifica video)</span> &gt; <span class="uicontrol">Video Reporting (Reporting video)</span> </p> <p>Se riattivate il tracciamento video nella pagina <span class="wintitle">Video Reporting (Reporting video)</span>, saranno disponibili nuove metriche video di base. </p> <p> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>L'analisi freeform vi consente di trascinare e rilasciare dimensioni, metriche e segmenti per creare tutti i report desiderati. Potete suddividere i dati in base a necessità specifiche, fornendo un quadro per la creazione di query con metriche, dimensioni, segmenti, linee temporali e altri valori di suddivisione dell'analisi pertinenti. </p> <p>Le ultime funzioni includono: </p> <p> 
     ...
     </ul> </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/freeform/index.html" format="https" scope="external"> L'analisi freeform</a> è attualmente in versione open beta supportata principalmente dal team della community di Analytics. Per le informazioni aggiornate e in caso di domande sull'analisi freeform, consultate il <a href="https://help-forums.adobe.com/content/adobeforums/en/analytics-forum/freeform-analysis.html" format="http" scope="external">forum sull'analisi freeform (beta)</a>. </p> </td> 
  </tr> 
  <tr> 
...
* È stato risolto il problema che causava l&#39;aumento di un&#39;istanza di un eVar se il valore dell&#39;eVar veniva eliminato o impostato su *` blank`*, mediante le regole di elaborazione.

### Correzioni di Ad Hoc Analysis {#fixes_ad_hoc}

* È stato risolto un problema relativo alle e-mail ( [!DNL  .xls] e [!DNL  .csv] allegati) di report che contenevano l&#39;ID suite di rapporti invece del nome della suite di rapporti nell&#39;e-mail. Adesso viene visualizzato il nome della suite dei report.
...
* L&#39;esportazione dei segmenti di Target non riusciva perché il campo *` mboxPC`* era mancante. Questo problema è stato adesso risolto.
* Richiesta dell&#39;ID formattata correttamente. L&#39;uso dell&#39;identificazione *` mbox3rdpartyId`* al posto degli PCID predefiniti causava il rifiuto da parte di [!UICONTROL Adobe Target] delle richieste generate tramite l&#39;integrazione di Target/Data Workbench (mediante il file [!DNL  ExportIntegration.exe]). La richiesta dell&#39;D viene adesso formattata correttamente e la velocità effettiva è corretta.
