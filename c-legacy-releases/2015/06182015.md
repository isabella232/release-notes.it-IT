...
* Tracciamento campagna di acquisizione
...
* La scadenza per il tracciamento delle campagne di acquisizione è cambiata da visita a visitatore per tutti i clienti. Questa modifica semplifica l&#39;attribuzione delle campagne per pubblicare l&#39;attività di download al visitatore per tutte le visite invece che solo per la prima visita.
* Sono state riorganizzate e migliorate le seguenti guide:

   * [Guida per l&#39;utente di Adobe Mobile Services](https://docs.adobe.com/content/help/it-IT/mobile-services/using/home.html)
   * [Guida per l&#39;amministratore di iOS SDK 4.x per soluzioni Marketing Cloud](https://docs.adobe.com/content/help/it-IT/mobile-services/ios/overview.html)
...
Il rilascio Video Stream Analytics (Heartbeat) del 18 giugno 2015 include le seguenti modifiche:
     ...
     <ul id="ul_F49FF181E93744F8BAD180B994073F20"> 
      ...
      <li id="li_8913320B99114DE881B5F4E8B3BD0D84"> <p> <b>Percorso video</b> </p> 
       <ul id="ul_CCC6EA9299644D48935146DDD988DE36"> 
        <li id="li_70DBC48AD34A4893B7FB2C92DA0F2E72"> <p>Si tratta di una variabile di soluzione. </p> </li> 
        <li id="li_5146C2C8E86F4DACB07A99E7939B360F"> <p>La profondità massima del percorso è tre. </p> </li> 
       </ul> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* Sono stati modificati i nomi delle variabili e degli eventi per riflettere meglio gli scopi dei componenti (video, contenuti, annunci). Il video ora include sia il contenuto principale che gli annunci.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La funzione delle metriche calcolate adesso consente l’utilizzo di metriche segmentate, calcoli più avanzati e la possibilità di organizzare e condividere le metriche. </p> <p>Potete creare delle nuove metriche da applicare al livello della cronologia senza aggiornare l’implementazione, condividere e perfezionare le metriche per eliminare il disordine ed effettuare delle analisi statistiche di base. Puoi confrontare i segmenti molto più facilmente. </p> <p>Potrete applicare queste nuove metriche dovunque in Reports e Analytics, Analysis Workspace, Report Builder e Ad Hoc Analysis. </p> <p> <a href="https://marketing.adobe.com/resources/help/it_IT/analytics/calcmetrics/" format="https" scope="external"> Altro... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">  Analysis Workspace - Analisi freeform </td> 
   <td colname="col2"> <p>L'analisi freeform consente di trascinare dimensioni, metriche e segmenti per creare qualsiasi rapporto desiderato. Puoi suddividere i dati in base alle tue esigenze specifiche, fornendo un quadro per creare query utilizzando metriche, dimensioni, segmenti, linee temporali e altri valori di suddivisione dell'analisi rilevanti. </p> <p>Le funzioni più recenti includono: </p> <p> 
     ...
     </ul> </p> <p> <a href="https://docs.adobe.com/content/help/it-IT/analytics/analyze/analysis-workspace/home.html" format="https" scope="external"> L’analisi freeform</a> è attualmente in versione open beta supportata principalmente dal team della community di Analytics. Per le informazioni aggiornate e in caso di domande sull'analisi freeform, consultate il <a href="https://help-forums.adobe.com/content/adobeforums/en/analytics-forum/freeform-analysis.html" format="http" scope="external">forum sull'analisi freeform (beta)</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse sovrascrittura SFTP </td> 
   <td colname="col2"> SFTP ora supporta la sovrascrittura sulla trasmissione. È consigliabile aggiornare il server SFTP a una versione che supporti la funzione di ridenominazione. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Aumento del limite delle regole di elaborazione </td> 
   <td colname="col2"> <p>Il numero di regole di elaborazione consentito è stato aumentato da 100 a 150. Inoltre, la dimensione consentita della regola di elaborazione XML è stata aumentata a 4 MB (da 65 KB). Questa modifica delle dimensioni impedisce la visualizzazione di un errore in caso di superamento del limite XML. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Strumenti di amministrazione </span> &gt; <span class="uicontrol"> Suite di rapporti </span> &gt; <span class="uicontrol"> Modifica impostazioni </span> &gt; <span class="uicontrol"> Generali </span> &gt; <span class="uicontrol"> Impostazioni sulla privacy </span> </p> <p> Questa funzione consente  clienti Adobe Analytics di rispettare l'intenzione dell'utente di interrompere l'elaborazione a scopo di profiling. Secondo quanto stabilito dalle leggi e dalle indicazioni normative, l’azione di blocco dei cookie da parte di un utente è equiparabile alla scelta dell’utente di non partecipare alle attività di profiling. Attivando questa funzione, i dati raccolti dai browser desktop e mobili in cui l'utente ha impostato il proprio browser per bloccare tutti i cookie saranno esclusi dai report di Analytics. Se Adobe non è in grado di riconoscere il browser Web, i dati verranno inclusi nei rapporti di Analytics. </p> <p> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/browser-cookie-settings.html" format="https" scope="external"> Altro... </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Analytics Premium offre le nuove funzioni aggiuntive seguenti nel rilascio [Data Workbench 6.4](https://docs.adobe.com/content/help/it-IT/data-workbench/using/release-notes/release-notes.html):
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> Nuova installazione di Workstation </td> 
  ...
  <tr> 
   <td colname="col1"> Esperienza di configurazione della workstation avanzata </td> 
   <td colname="col2"> Dopo l'installazione della workstation, l'area di lavoro <b>Configura connessioni al server</b> si aprirà con informazioni aggiuntive sull'installazione di un certificato e l'immissione delle informazioni sulla connessione del server nel file Insight.cfg. Potete inoltre visualizzare lo stato della connessione sui server e selezionare i profili. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Livello presentazione </td> 
   <td colname="col2"> Annotate e definite le visualizzazioni con una sovrapposizione di presentazione. Aggiungete note di testo, frecce, immagini e codifica dei colori per evidenziare e chiarire i dati e condividerli con altri utenti. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Nuova procedura guidata Dimension metriche </td> 
   <td colname="col2"> Utilizza una procedura guidata dettagliata per semplificare la creazione di dimensioni metriche. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Amministrazione utente dell'accesso dei membri del gruppo </td> 
   <td colname="col2"> Gli amministratori possono dare agli utenti della workstation la possibilità parziale di gestire il controllo degli accessi per i gruppi personalizzati. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Impedire modifiche ai profili </td> 
   <td colname="col2"> Impedisci la sovrascrittura dei profili da parte degli utenti che lavorano nei gestori di profili, Dimension, rapporti, aree di lavoro, metriche o filtri. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Nuovi aggiornamenti dell'interfaccia utente Workstation </td> 
  ...
  <tr> 
   <td colname="col1"> Informazioni di registrazione aggiornate </td> 
   <td colname="col2"> Data Workbench adesso utilizza un framework di registrazione "L4" esteso che offre la possibilità di configurare le registrazioni in base alle necessità. L'implementazione predefinita fornita con il pacchetto 6.4 fornisce informazioni fondamentali sull'elaborazione del software. La registrazione può essere estesa con informazioni aggiuntive per la risoluzione dei problemi relativi agli eventi del server e per aiutare ad analizzare i problemi sottostanti, incluse informazioni aggiuntive per il server, il client e il server di report associati. <p>Per ulteriore supporto nell'implementazione di ulteriori registrazioni L4, contattate il vostro account manager. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Nuovo file cfg per le opzioni di registrazione di ExportIntegration.exe </td> 
   <td colname="col2"> <p>Un nuovo file di configurazione httpLoggingEI.cfg (al percorso <span class="filepath">server\Admin\Export\httpLoggingEI.cfg</span>) consente di arrestare la registrazione INFO sul file HTTP.log durante le esportazioni delle integrazioni (le esportazioni CRS, TNT e MMP acquisiscono già la registrazione dettagliata in singoli file di registro delle esportazioni.) </p> <p>Un'impostazione true avvia la registrazione INFO (per il test e il reporting dettagliato) sul file HTTP.log, mentre una impostazione false interrompe la registrazione dettagliata. Per un'impostazione su false, al file HTTP.log verranno inviati solo messaggi di livello AVVISO/ERRORE. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Funzione di zoom per le visualizzazioni dei grafici </td> 
   <td colname="col2"> Utilizzate la funzione di zoom per visualizzare meglio le etichette delle metriche quando i valori raggiungono una maggiore disparità. Precedentemente l'etichetta scompariva con la modifica nel contrasto dei valori, ad esempio quando si impostava un valore di regressione della metrica più alto rispetto ai valori precedenti. Adesso potete effettuare lo zoom nella visualizzazione facendo clic su <b>&lt;Ctrl&gt;</b> e spostando la rotellina del mouse mentre passate il puntatore sul grafico. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Questi file eseguibili sono ora firmati digitalmente per garantire che i download del software non siano stati alterati o danneggiati. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Opzioni del formato della data </td> 
   <td colname="col2"> Potete modificare il formato della data in base alle impostazioni internazionali nel file Standard Time <i>Dimension.cfg</i> . Modificate il formato predefinito <i>MM/GG/AAAA</i> in formato <i>GG/MM/AAAA</i> o scegliete altre opzioni. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Visualizzazione file interrotta </td> 
   <td colname="col2"> La visualizzazione dei file (<span class="uicontrol">Amministratore</span> &gt; <span class="uicontrol">File</span>) per i profili di base non includerà le directory di grandi dimensioni (registri, esportazioni e ricerche rimossi) durante il reporting. In questo modo si aumenterà la velocità di visualizzazione del rapporto. Le directory più grandi ora hanno i propri rapporti individuali (File di amministrazione/esportazione, File di ricerca e File di registro). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Trasformazioni DeviceAtlas migliorate </td> 
   <td colname="col2"> Il file DeviceAtlas.bundle ora utilizza la cache in-memoria per migliorare notevolmente le prestazioni delle ricerche. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Aggiornamento della visualizzazione Chord </td> 
   <td colname="col2"> Miglioramento della visibilità quando si passa il puntatore su una sezione durante la visualizzazione della <b>Chord</b> . </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Trascinamento delle dimensioni dal Finder a una tabella di dettagli </td> 
...
* È stato risolto l&#39;errore di visualizzazione in [!UICONTROL Strumenti di amministrazione]. Quando un utente veniva eliminato, nella console veniva visualizzato che era stato eliminato dallo stesso utente.
...
* Il punteggio di propensione non veniva reimpostato quando si eseguivano nuovamente diversi input nella stessa area di lavoro. Ora si ripristina correttamente.
* È stato risolto un problema che causava la mancata disponibilità di dimensioni contabili alla prima apertura della matrice di correlazione.
* L’esportazione di segmenti Target non riusciva perché il campo  *`mboxPC`* era mancante. Questo è stato ora corretto.
* Richiesta ID formattata correttamente. Using the *`mbox3rdpartyId`* identification instead of default PCIDs caused [!UICONTROL Adobe Target] to reject requests generated via the Target/Data Workbench integration (using the [!DNL  ExportIntegration.exe]). La richiesta ID ora viene formattata correttamente e la velocità effettiva è corretta.
* È stata risolta una perdita di memoria del server di report durante l&#39;esportazione in Excel.
...
* Modifiche apportate alla logica aziendale Ora visita/Ora sito:

   * Use *`visit_start_time_gmt`* as the starting time of a visit. Ora le visite iniziate prima dell&#39;intervallo di date del rapporto non hanno alcun impatto negativo.
   ...
   * Gli hit delle origini dati transazionali (hit_source=7) non devono più avere una durata visita.
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La funzione <span class="wintitle">Controlli sull'esportazione dei dati</span> impedisce l'aggiunta di caratteristiche ai segmenti o l'invio di dati a una destinazione se questa azione viola la privacy dei dati o le policy di utilizzo dei dati. Consultate la <a href="https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/data-export-controls.html" format="https" scope="external">documentazione sulla funzione Controlli sull'esportazione dei dati</a> per ulteriori informazioni. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Stiamo migliorando la documentazione API con Swagger. See the [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) section for new and revised methods.
...
* È stato risolto un problema che impediva l&#39;aggiunta di codici di monitoraggio ai post dell&#39;album Facebook.
* È stato risolto un problema che a volte causava un errore nei post a causa di errori di timeout.
* È stato risolto un problema che impediva la visualizzazione degli assegnatari del flusso di lavoro di moderazione nei browser Internet Explorer 11.
* È stato risolto un problema che impediva agli utenti di creare regole di ascolto per WordPress contenenti un operatore OR.

See [Release Notes for Adobe Social](https://docs.adobe.com/content/help/it-IT/social/using/home.html) for more information.
