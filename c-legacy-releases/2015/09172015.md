...
Novità di Analytics: miglioramenti ad ad Analysis Workspace e Marca temporale opzionale. Gestione dei gruppi in Dynamic Tag Management. Messaggistica push per dispositivi mobili a segmenti Analytics, metodi di acquisizione e segnali di postback. Miglioramenti e correzioni generali delle soluzioni Marketing Cloud.
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Android SDK 4.x per soluzioni Marketing Cloud </p> <p>E </p> <p>iOS SDK 4.x per Soluzioni Marketing Cloud </p> </td> 
...
L&#39;ultima versione è totalmente compatibile con le forniture attuali di Marketing Cloud Visitor ID Service tramite DTM. Per consentire a tutti gli utenti di trarre vantaggio da questo aggiornamento gli account verranno automaticamente migrati nella nuova libreria di Marketing Cloud ID Service.

Dalla suddetta migrazione risulteranno funzionalità aggiunte per lo strumento di Marketing Cloud Visitor ID Service su DTM. Prima della pubblicazione si consiglia di eseguire un test dell&#39;aggiornamento nell&#39;ambiente in uso.
...
* [AppMeasurement e SDK Dispositivi mobili](../../c-legacy-releases/2015/09172015.md#appmeasurement_sdk)
...
* È stato risolto un errore che si verificava dopo la creazione un gruppo utenti in Reporting e analisi, selezionandolo come gruppo utenti predefinito. Il tentativo di ripristinare il gruppo predefinito a _None_ failed with an error message. (AN-108270)
* È stato risolto un problema che impediva il profilo visitatore e la marcagt; Report Attributi del cliente da mostrare nel menu. (AN-106265)
...
<table id="table_CE3C48DBA4A343B3B694ACAB96E11279"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/?f=addressable-audiences.html" format="https" scope="external"> Pubblico di riferimento </a> </p> </td> 
   <td colname="col2"> <p> <span class="wintitle"> In Pubblico di riferimento</span> viene visualizzata la sovrapposizione (tasso di corrispondenza) tra i segmenti e una destinazione per gli ultimi 60 giorni. Mostra i risultati con una visualizzazione dei dati e metriche numeriche. I dati di sovrapposizione vengono visualizzati nella sezione delle informazioni di base al momento dell'invio dei segmenti verso una destinazione. <span class="wintitle"> L'area Pubblico di riferimento</span> è disponibile automaticamente e restituisce dati solo per destinazioni tra server specifici. </p> <p> <b>Nota:</b> al momento del rilascio (29/09), il <span class="wintitle"> Pubblico di riferimento </span>: 
...
* È stata corretta un&#39;etichetta riportata in maniera errata sulla pagina [!UICONTROL Crea una regola Unisci profilo]. (AAM-20920)
...
Il presente rilascio di [!DNL  Social] si focalizza su prestazione, scalabilità, usabilità e affidabilità migliorate. Più di 75 problemi back-end risolti e miglioramenti effettuati in queste aree. Le correzioni sotto riportate descrivono le risoluzioni per i principali problemi riportati dai clienti.
...
[!DNL  Adobe Experience Manager] è un sistema di gestione dei contenuti web aziendali che consente all&#39;autore di gestire, sviluppare e pubblicare siti Web.
