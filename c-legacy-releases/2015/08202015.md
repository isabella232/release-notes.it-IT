...
* Aggiornato il Generatore di regole di classificazione con il pannello [Selezione di suite per report e variabili](https://marketing.adobe.com/resources/help/en_US/reference/?f=classification_rule_definitions). Con questo pannello è possibile aggiungere suite di rapporti e variabili a un set di regole esistente. In precedenza si specificavano la variabile e la suite di rapporti durante la creazione del set di regole. Questa modifica impedisce il verificarsi di problemi segnalati con le variabili di classificazione.
...
* È stato risolto un bug che impediva a [!UICONTROL Servizio ID visitatore] di impostare correttamente un cookie di dominio multiparte di livello più alto. Per esempio, per un dominio come ` my_company.co.uk`, in alcuni casi [!UICONTROL Servizio ID visitatore] impostava un cookie solo in ` co.uk`. (AN-104683)
   ...
   * È attivato un [periodo di tolleranza](https://marketing.adobe.com/resources/help/it_IT/mcvid/?f=mcvid_grace_period.html)*o* vengono utilizzati cookie di prima parte e gli utenti bloccano i cookie di terze parti.
...
* La nuova documentazione descrive come portare dati da un account Google Doubleclick Campaign Manager (DCM) in [!DNL  Audience Manager]. Consulta l’articolo su come [importare file DCM in Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/?f=t_dcmlogs.html).
* La nuova documentazione descrive come lavorare con gli [!UICONTROL strumenti di gestione in blocco]. Per ulteriori informazioni, consulta l’articolo sugli [strumenti per la gestione in blocco](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_bulk.html).
* È stata rivisto l’articolo sull’[integrazione del profilo di marketing principale](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_mmp.html) per aggiornare la variabile dei dati di contesto. Questa variabile deve terminare con un underscore. In precedenza terminava con un punto.

**Problemi noti**

I clienti di [!DNL  Analytics] devono impostare un codice di integrazione quando utilizzano il [profilo marketing principale](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_mmp.html) e passare gli ID dichiarati a [!DNL  Audience Manager] con il [Servizio ID visitatore](https://marketing.adobe.com/resources/help/it_IT/mcvid/?f=mcvid_service.html). Per informazioni dettagliate, consulta l’articolo su come [abilitare i clienti all’unione dei profili](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_profile_merge_enablement.html).
