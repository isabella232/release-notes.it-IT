...
Per assistenza, consulta [Informazioni su Adobe Marketing Cloud](https://marketing.adobe.com/resources/help/it_IT/mcloud/home.html).
...
|---|---|
| Data Warehouse | Aggiunta di supporto per le origini dati di riepilogo nei rapporti data warehouse. Ciò consente di effettuare un report sulle metriche come i dati del motore di ricerca (prima del clic) da Adobe Media Optimizer. |
...
Per le ultime informazioni, consulta [Note sulla versione di Target](https://marketing.adobe.com/resources/help/it_IT/target/target/r_release_notes.html).
...
Per le ultime informazioni, consulta [Note sulla versione Target]( https://marketing.adobe.com/resources/help/en_US/target/rn/).
