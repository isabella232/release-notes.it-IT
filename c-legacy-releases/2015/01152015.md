...
A partire dal 30 gennaio 2015, solo la versione corrente di Adobe [!DNL Analytics] Report Builder (5.0.50), il componente aggiuntivo Adobe [!DNL Analytics] per Excel, sarà in grado di connettersi ad Adobe [!DNL Analytics]; le versioni precedenti cesseranno la connessione. Questo cambiamento è il risultato di una serie di miglioramenti per la sicurezza che saranno effettuati entro quella data. Tutti gli utenti devono effettuare l&#39;aggiornamento alla versione 5.0.50 o successiva (rilasciata il 21 ottobre 2014) prima del 30 gennaio 2015. Se si decide di non effettuare l&#39;aggiornamento, dopo il 30 gennaio 2015 non sarà possibile effettuare l&#39;accesso al Generatore di report o recuperare dati mediante il Generatore di report fino a quando non sarà installata la versione più recente. Consultate [Aggiornamento del Generatore di report](https://marketing.adobe.com/resources/help/en_US/arb/?f=upgrade_arb) per verificare la versione in uso e per comprendere come effettuare l&#39;aggiornamento alla versione più recente.
...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/audience_library.html" format="https" scope="external">Marketing Cloud Audiences</a> (Audience Marketing Cloud): consente di creare, modificare e gestire audience con le stesse modalità dei segmenti. È possibile condividere audience da utilizzare in soluzioni quali Analytics, <span class="keyword">Target </span> e Gestione dell'audience. </p> </td> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/arb/release_notes_arb.html" format="http" scope="external"> Report Builder 5.0</a>: include gestione di nuovi segmenti, report percorsi, accesso a dashboard e segnalibri da Reports &amp; Analytics e altro ancora. </p> </td> 
      <td colname="col3"> <p> Maggio 2014 </p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/home/" format="https" scope="external"> Home dell'Aiuto</a>: il nuovo dominio dell'Aiuto è <a href="https://marketing.adobe.com/resources/help/en_US/home/" format="https" scope="external">https://marketing.adobe.com/resources/help/it_IT/home/ </a>. Aggiornare i segnalibri. (Il contenuto verrà migrato durante l'anno a seconda delle soluzioni, pertanto alcuni contenuti potrebbero venire mostrati sul dominio precedente.) </p> </td> 
...
<table id="table_7E7A3E9E45854F98AEAA53924EBA5FB4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Utilizzo</span> &gt; <span class="uicontrol">Funnel </span></p> <p> In Analytics, i report funnel consentono di identificare se i clienti abbandonano una campagna marketing o se deviano da un percorso di conversione definito durante l'interazione con il sito Web o una campagna su più canali. </p> <p> È possibile specificare passaggi funnel (qualsiasi variabile o metrica) e confronti funnel (anche qualsiasi variabile o metrica). Ciascun passaggio mostra la diminuzione e la conversione dal passaggio precedente. Il confronto consente di confrontare più filtri (segmenti) per passaggio. </p> <p>Per impostazione predefinita, il <span class="wintitle">report Funnel</span> è vuoto. Fai clic su <span class="uicontrol">Personalizza</span> per iniziare a usare le metriche e i filtri standard. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p> <span class="uicontrol">Utilizzo</span> &gt; <span class="uicontrol">Mantenimento </span></p> <p> Il <span class="term"> rapporto Coorti primo avvio </span> è ora chiamato <span class="term"> Mantenimento </span>. Questo report consente di riportare mantenimenti futuri. Può servire per riportare informazioni su altri eventi, come gruppi di condivisione, gruppi di compratori e gruppi di utenti di widget. Inoltre, si ha anche un maggior controllo sull'intervallo date. </p> <p>Ad esempio, supponiamo che si desideri rispondere alla domanda "I condivisori sociali continuano a condividere o smettono dopo una settimana?" Potete usare una metrica come Condivisori sociali mantenuti per n. giorni per analizzare come le nuove funzioni contribuiscano a mantenere gli utenti nel nuovo set di funzioni. </p> <p>Potete inoltre visualizzare una distribuzione su giorni per il mantenimento della funzione invece del mantenimento su base giornaliera. Ad esempio, per l'intervallo date selezionato, una distribuzione mostrerebbe che il 30% degli utenti hanno continuato per un giorno, il 25% per due giorni e il 15% degli utenti per tre giorni. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Risoluzione di un problema per il quale un segmento che usa l&#39;operatore *` Then`* mostrava compatibilità con Analisi ad hoc in Reporting e [!DNL Analytics] Generatore di segmenti. Tuttavia, durante l&#39;esecuzione di un report con il segmento in Ad Hoc Analysis, veniva rilevato un errore. Il segmento mostrava un altro errore durante il tentativo di salvataggio nello strumento Generatore di segmenti di Reports &amp; Analytics.
